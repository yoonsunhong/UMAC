...
<script type="text/javascript" src="/resources/js/page/order/store/orderStoreRegisterExcel.js?ver=20180322_002" charset="utf-8"></script>
	...
	<div id="iframeCnt">
		<div class="btn_area clear">
			...
			<div class="f_r">
				...
				<button type="button" id="btn_excel_fresh" name="btn_excel_fresh" class="btn btn_style2" style="display:none;" onclick="r2OrderExcelData();">엑셀 다운</button>
		...
		<form id="frmSearch" name="frmSearch">
			...
			<table class="tbl_st2">
				...
				<tbody>
					<tr> 
						<th scope="row"><em>필수입력항목</em>점포명</th>
						<td>
							<select id="STR_CODE" name="ww" class="wid2">
						...
						<td >
						    <select id="PUR_GB" name="PUR_GB" class="wid2" onChange="chgPurGb();"></select>
						</td>
						...
						<td>
							<select id="ROUTE_GB" name="ROUTE_GB" class="wid2">
								...
								<option value="R23" selected>R2 / R3</option>  
						    </select>
						</td>
					</tr>  
					<tr>
						...
						<td>
					 		<select id="REG_PATH" name="REG_PATH" class="wid2"></select>
						</td>
					   	<th scope="row">매입처</th>
						<td>
				    ...
				    <tr>
						...
						<td colspan = 9>
						    <select id="CFM_YN" name="CFM_YN" class="wid2">
								...
								<option value="N" selected>미처리</option> 
						    </select>
						</td>
					</tr> 
				</tbody>
		...
		<div class="tit_top clear">
			<h3 class="bul_arr f_l">엑셀발주&nbsp;&nbsp;&nbsp;* 점포에서 업로드한 생식은 "발주생성"이 되지 않습니다.</h3>	  
			<div class="f_r">
				...
				<button type="button" class="search_btn" onclick="btn_comm_store_order_search()"><img src="/resources/img/common/search_ico.png"></button>
