...
<script type="text/javascript" src="/resources/js/page/purch/mng/purchMng.js?ver=20180405_000" charset="utf-8"></script>
	...
	<div id="iframeCnt">
		...
		<div class="clear">
			<div class="f_l tit_top">
				<div class="clear">
					<h3 class="bul_arr f_l">매입전표    &nbsp;&nbsp; * "매입(입고)일"이 존재 해야 확정(체크박스) 가능합니다.</h3>
					<dlv class="f_r">
...
<!-- 						<button type="button" id="" name="" class="btn btn_style4" onclick="purchDel()">매입삭제</button> -->
		...
		<div>
			<div class="tit_top clear">
				<h3 class="bul_arr f_l">매입전표 상세 (매입확정)</h3>	 
				<div class="f_r">  
					 * 원가단가: 부가세포함 &nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" id="btn_save_amt" name="btn_save_amt" class="btn btn_style4" onclick="btnSaveAmt();">
						<font color=red> [ 매입금액수정  ] </font>
					</button>
