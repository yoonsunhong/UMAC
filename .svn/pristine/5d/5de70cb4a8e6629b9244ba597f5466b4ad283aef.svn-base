...
class ReportHandler{
	...
	private void getScriptFromsh3_fv1_sub3(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			...
			sheet30_J4=sheet30_H4+sheet30_I4;
	...
	private void getScriptFromsh3_fv1_sub2(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			...
			sheet30_J5=sheet30_H5+sheet30_I5;
	...
	private void getScriptFromsh3_fv1(boolean bIsPrint) throws Exception{
		...
		while(ven_day_state.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(!sheet30_C3.equals(ven_day_state_STR_NAME)){
				if(!bIsFirst){
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|56|supplyPurchStateMonthV1Print.style|회원매출상세내역현황", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet30_B1", 35, 0, 132, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_C1", 167, 0, 38, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_D1", 205, 0, 59, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_E1", 264, 0, 184, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_H1", 448, 0, 68, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_I1", 516, 0, 51, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_J1", 567, 0, 68, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_K1", 635, 0, 68, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_L1", 703, 0, 51, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_M1", 754, 0, 34, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_E2", 264, 20, 68, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet30_F2", 332, 20, 48, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet30_G2", 380, 20, 68, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet30_A3", 0, -1, 35, -1, "cell_style_5");
		setCellInfoMap_Internal("sheet30_B3", 35, -1, 132, -1, "cell_style_6");
		setCellInfoMap_Internal("sheet30_C3", 167, -1, 38, -1, "cell_style_7");
		setCellInfoMap_Internal("sheet30_D3", 205, 0, 59, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_E3", 264, 0, 68, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_F3", 332, 0, 48, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_G3", 380, 0, 68, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_H3", 448, 0, 68, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_I3", 516, 0, 51, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_J3", 567, 0, 68, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_K3", 635, 0, 68, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_L3", 703, 0, 51, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_M3", 754, 0, 34, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_A4", 0, 0, 205, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_D4", 205, 0, 59, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_E4", 264, 0, 68, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_F4", 332, 0, 48, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_G4", 380, 0, 68, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_H4", 448, 0, 68, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_I4", 516, 0, 51, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_J4", 567, 0, 68, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_K4", 635, 0, 68, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_L4", 703, 0, 51, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_M4", 754, 0, 34, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_A5", 0, 0, 205, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_D5", 205, 0, 59, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_E5", 264, 0, 68, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_F5", 332, 0, 48, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_G5", 380, 0, 68, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_H5", 448, 0, 68, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_I5", 516, 0, 51, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_J5", 567, 0, 68, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_K5", 635, 0, 68, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_L5", 703, 0, 51, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_M5", 754, 0, 34, 20, "cell_style_13");
	}
}
%>
