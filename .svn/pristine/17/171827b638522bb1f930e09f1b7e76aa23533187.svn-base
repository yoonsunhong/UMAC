...
<script type="text/javascript" src="/resources/js/page/member/delivery/memberDelivery.js?ver=20180406_000" charset="utf-8"></script>
</head>
<%
	Calendar mon = Calendar.getInstance();
	String beforeDate = new java.text.SimpleDateFormat("yyyy-MM-dd").format(mon.getTime());	
%>
 	...
 	<form id="frm" name="frm">
		<div id="iframeCnt">
			<div class="btn_area clear">
				...
				<button id="bookMarkIcon" class="fav fav_inactive"></button> 
				<div class="f_r">
			...
			<div id="top_search" class="search_area">
				<div class="last">
					...
					<input type="text" id="P_SALE_DT" name="P_SALE_DT" class="datepicker1" value="<%=beforeDate%>" readonly="readonly" />

					&nbsp;&nbsp;
					<label for=""><spring:message code="orderMth"/></label>
					<select id="P_CUST_NO_YN" name="P_CUST_NO_YN" class="wid2">
						<option value=""><spring:message code="all"/></option>
					</select>
				</div>
			</div>
			...
			<div class="col2 sub_cnt">
				<div class="tit_top clear">		 
					<h3 class="bul_arr f_l">회원구분별 매출실적</h3>
				</div>	
				<div class="sec_grid">
					<div class="content">
