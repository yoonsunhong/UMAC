...
public void jspInit() {
	...
	sql_inout.append("        , NVL(B.DIN_TAX2,0)-NVL(A.DIN_TAX2,0)-NVL(C.DIN_TAX2,0)+NVL(D.DIN_TAX2,0) AS DIN_TAX2 ");
	sql_inout.append("        , NVL(B.DIN_TAX1,0)-NVL(A.DIN_TAX1,0)-NVL(C.DIN_TAX1,0)+NVL(D.DIN_TAX1,0) AS DIN_TAX1 ");
	sql_inout.append("        , NVL(B.DIN_TAX1_VAT,0)-NVL(A.DIN_TAX1_VAT,0)-NVL(C.DIN_TAX1_VAT,0)+NVL(D.DIN_TAX1_VAT,0) AS DIN_TAX1_VAT ");
	sql_inout.append("        , NVL(B.DIN_TAX,0)-NVL(A.DIN_TAX,0)-NVL(C.DIN_TAX,0)+NVL(D.DIN_TAX,0) AS DIN_TAX ");
	...
	sql_inout.append("        ,       AA.DOUT_TAX1 ");
	sql_inout.append("        ,       AA.DOUT_TAX2 ");
	sql_inout.append("        ,       AA.DOUT_TAX ");
	sql_inout.append("        ,       AA.DOUT_TAX1_VAT ");
	sql_inout.append("        ,       AA.DIN_TAX1 ");
	sql_inout.append("        ,       AA.DIN_TAX2 ");
	sql_inout.append("        ,       AA.DIN_TAX ");
	sql_inout.append("        ,       AA.DIN_TAX1_VAT ");
	sql_inout.append("        FROM    CD_STORE CS ");
	sql_inout.append("        , ");
	sql_inout.append("        (SELECT ");
	sql_inout.append("                TB.DIN_STR_CODE ");
	sql_inout.append("        ,       TB.STR_CODE ");
	sql_inout.append("        ,       NVL(SUM(TB.DOUT_TAX1) - TRUNC(SUM(TB.DOUT_TAX1)/11),0)  AS DOUT_TAX1 ");
	sql_inout.append("        ,       NVL(SUM(TB.DOUT_TAX2),0)   AS DOUT_TAX2 ");
	sql_inout.append("        ,       NVL(SUM(TB.DOUT_TAX1),0)+NVL(SUM(TB.DOUT_TAX2),0) AS DOUT_TAX ");
	sql_inout.append("        ,       NVL(TRUNC(SUM(TB.DOUT_TAX1)/11),0)   AS DOUT_TAX1_VAT ");
	sql_inout.append("        ,       NVL(SUM(TB.DIN_TAX1) - TRUNC(SUM(TB.DIN_TAX1)/11),0)  AS DIN_TAX1 ");
	sql_inout.append("        ,       NVL(SUM(TB.DIN_TAX2),0)   AS DIN_TAX2 ");
	sql_inout.append("        ,       NVL(SUM(TB.DIN_TAX1),0)+NVL(SUM(TB.DIN_TAX2),0) AS DIN_TAX ");
	sql_inout.append("        ,       NVL(TRUNC(SUM(TB.DIN_TAX1)/11),0)   AS DIN_TAX1_VAT ");
	sql_inout.append("        FROM( ");
	sql_inout.append("            SELECT ");
	sql_inout.append("                    ID.* ");
	...
	sql_inout.append("                               (NVL(DOUT_WPRC,0)+NVL(DOUT_WVAT,0)) * DOUT_CFM_QTY ");
	sql_inout.append("                            END) AS DOUT_TAX1 ");
	sql_inout.append("                    ,       SUM(CASE    WHEN    TAX_GB='2'  THEN ");
	sql_inout.append("                               (NVL(DOUT_WPRC,0)+NVL(DOUT_WVAT,0)) * DOUT_CFM_QTY ");
	sql_inout.append("                            END) AS DOUT_TAX2 ");
	sql_inout.append("                    ,       SUM(CASE    WHEN    TAX_GB='1'  THEN ");
	sql_inout.append("                               (NVL(DIN_WPRC,0)+NVL(DIN_WVAT,0)) * DIN_CFM_QTY ");
	sql_inout.append("                            END) AS DIN_TAX1 ");
	sql_inout.append("                    ,       SUM(CASE    WHEN    TAX_GB='2'  THEN ");
	sql_inout.append("                               (NVL(DIN_WPRC,0)+NVL(DIN_WVAT,0)) * DIN_CFM_QTY ");
	sql_inout.append("                            END) AS DIN_TAX2 ");
...
class ReportHandler{
	...
	private double inout_DIN_TAX2;
	private double inout_DIN_TAX1;
	private long inout_DIN_TAX1_VAT;
	private double inout_DIN_TAX;
	...
	private void getScriptFromsh2_f1(boolean bIsPrint) throws Exception{
		...
		while(inout.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet20_C3 = (long)inout_DIN_TAX2;
			sheet20_D3 = (long)inout_DIN_TAX1;
			sheet20_E3 = inout_DIN_TAX1_VAT;
			sheet20_F3=sheet20_D3+sheet20_E3;
			sheet20_G3 = (long)inout_DIN_TAX;
	...
	private void setFieldVariableFrominout() throws Exception{
		...
		inout_DIN_TAX2 = inout.getDouble(3);
		inout_DIN_TAX1 = inout.getDouble(4);
		inout_DIN_TAX1_VAT = inout.getLong(5);
		inout_DIN_TAX = inout.getDouble(6);
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|61|inoutSumStorePrint.style|보고서 (2017/3/20 17:59:30)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_A3", 0, 0, 57, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet20_B3", 57, 0, 57, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet20_C3", 114, 0, 85, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_D3", 199, 0, 85, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_E3", 284, 0, 73, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_F3", 357, 0, 85, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_G3", 442, 0, 102, 20, "cell_style_4");
	}
}
%>
