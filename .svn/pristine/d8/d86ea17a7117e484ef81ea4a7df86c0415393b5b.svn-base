...
class ReportHandler{
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|84|영업정보_매입관리_협력업체_임대을_점별출력.style|회원매출상세내역현황", false);
	}
