...
<script type="text/javascript" src="/resources/js/page/wms/stock/wmsStockReal/wmsStockRealConfirm.js" charset="utf-8"></script>
<!-- 공통 팝업 -->
 ...
 <body id="in_frame">
				...
				<div class="search_area" id="top_search">
						<table>
							...
							<tr>
								...
								<th><label for=""><em>필수입력사항</em><spring:message code="inventorySurveyScheduleID"/></label> </th>
								<td>
									<select id="P_INV_INSP_SCHD_ID" name="P_INV_INSP_SCHD_ID" onchange="fnInspSchdIdChange()">
										<option value=""><spring:message code="select"/></option>
									</select>		
								</td>
								<th><label for=""><em>필수입력사항</em><spring:message code="inventorySurveyScheduleDate"/></label> 	</th>
								<td><input type="text" id="P_INV_INSP_DT" name="P_INV_INSP_DT" style="width:105px;" disabled></td>
								<th><label for=""><spring:message code="storeType"/></label> </th>
								<td><select id="P_MKT_GB" name="P_MKT_GB" style="width:70px;" ></select></td>
							</tr>		
							<tr>
							...
							<li class="tab2">
								...
								<ul style="visibility:visible">
									<div class="f_r" style="margin-top:-21px">
										...
										<!-- 권한에 따른 버튼 show/hide -->
										<button type="button" id="delRow" class="btn btn_style4" onclick="tab2_delete();"><spring:message code="delRow"/></button> 
										<button type="button" id="btnExcelDown" class="btn btn_style4" onclick="ExcelDownload2();"><spring:message code="btnExcelDown"/></button>
									</div>								
		...
		<div id="pop_wrap1">
			<header id="pop_head" class="clear">
				<p class="f_l" style="height:21px;line-height:21px;">※ <spring:message code="wmsStockRealMent1"/></p>
				<div class="f_r">
					<button type="button" id="pop1_save" class="btn btn_style4" onclick="pop1_save()"><spring:message code="btnSave"/></button>
					<button type="button" id="pop1_close" class="btn btn_style4" onclick="pop1_close()"><spring:message code="btnClose"/></button>
				</div>
			</header>
			<div class="search_area" id="POP_SEARCH" name="POP_SEARCH">
				<div>
					<label for="" class="pad_R28"><em>필수입력사항</em><spring:message code="storNm"/></label> 
					<select id="P_POP_STR_NAME" name="P_POP_STR_NAME" class="wid3" style="margin-right:0" onchange="fnPopStrChange()"></select>
					<input type="text" id="P_POP_STR_CODE" name="P_POP_STR_CODE" class="wid3" disabled>
					...
					<label for=""><em>필수입력사항</em>Location</label>					
					<select id="P_POP_ZONE_CODE" name="P_POP_ZONE_CODE" onchange="fnPopZoneSelect()" style="margin-right:0"></select>
					<select id="P_POP_RACK_CODE" name="P_POP_RACK_CODE" onchange="fnPopRackSelect()" style="margin-right:0"></select>
					<select id="P_POP_LINE_CODE" name="P_POP_LINE_CODE" onchange="fnPopLineSelect()"></select>					
				</div>
				<div class="last">
					<label for=""><em>필수입력사항</em><spring:message code="scanningCode"/></label>
					<input type="text" id="P_POP_SCAN_CODE" name="P_POP_SCAN_CODE" style="width:105px"  maxlength="13"/>
					<label for="" class="pad_L61"><em>필수입력사항</em><spring:message code="surveyQuantity"/></label>
			...
			<table class="tbl_st2">
				<tbody>
					<tr>
						...
						<td><input type="text" id="P_POP_VEN_NAME" name="P_POP_VEN_NAME" class="wid1" disabled></td>						
