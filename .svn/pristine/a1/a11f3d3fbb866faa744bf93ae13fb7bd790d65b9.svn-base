...
'<rMateGrid>\
	...
	<DataGrid id="dg1" sortableColumns="true" selectionMode="multipleRows" horizontalScrollPolicy="auto" lockedColumnCount="3" verticalAlign="middle" >\
			<groupedColumns>\
				...
				<DataGridColumn dataField="DOUT_SLIP_NO"  headerText="'+orderNumber+'" textAlign="center" width="100"/>\
				<DataGridColumn dataField="SLIP_NO" headerText="'+goodsReceiptNumber+'" textAlign="center" width="100"/>\
				<DataGridColumn dataField="PUR_GB" headerText="'+goodsReceiptType+'" textAlign="center" sortable="false"  width="80"/>\
				...
				<DataGridColumn dataField="VEN_NAME" headerText="'+venName+'" textAlign="left" sortable="false"  width="200"/>\
				<DataGridColumn dataField="ITM_CODE" headerText="'+itmCode+'" textAlign="center" sortable="false"/>\
				<DataGridColumn dataField="ITM_NAME" headerText="'+itmName+'" textAlign="left" sortable="false" width="200"/>\
				<DataGridColumn dataField="UNIT" headerText="'+unit+'" textAlign="center" sortable="false"/>\
				<DataGridColumn dataField="IPSU_QTY" headerText="'+ipsuQty+'" textAlign="right"  formatter="{numfmt}"  width="70"/>\
				<DataGridColumn dataField="PUR_WPRC" headerText="'+purchaseCost+'" textAlign="right" formatter="{numfmt}"/>\
				<DataGridColumn dataField="ORD_QTY" headerText="'+orderQuantity+'" textAlign="right"  formatter="{numfmt}"/>\
			    <DataGridColumn dataField="ORD_WAMT" headerText="'+orderAmount+'" textAlign="right" formatter="{numfmt}"/>\
			    <DataGridColumn dataField="DEC_QTY" headerText="'+quantityReceived+'" textAlign="right"   formatter="{numfmt}"/>\
				<DataGridColumn dataField="PUR_WAMT" headerText="'+totalPurchaseCost+'" textAlign="right" formatter="{numfmt}"/>\
				<DataGridColumn dataField="DELIVERY_RATE" headerText="'+quantityDeliveryRates+'(%)"  textAlign="right"  width="90"/>\
			</groupedColumns>\
			<dataProvider>\
				<SpanSummaryCollection source="{$gridData}">\
					<mergingFields>\
						<SpanMergingField name="PUR_DT"/>\
						<SpanMergingField name="DOUT_SLIP_NO"/>\
						<SpanMergingField name="SLIP_NO"/>\
						<SpanMergingField name="PUR_GB"/>\
						<SpanMergingField name="ROUTE_GB"/>\
...
function ExcelDownload() {
	...
	//엑셀호출
	$.download('/wmsInReportExcelDown.do',"P_PUR_SDAY="+P_PUR_SDAY
