...
public void jspInit() {
	...
	sql_ven_day_state.append("			NVL(SUM(A.PUR_WPRC_3),0) AS PUR_PAY_AMT ");
	...
	sql_ven_day_state.append("                    AND	  PH.PUR_CFM_DT BETWEEN  '201709' ||'01' AND  '201709'||'31' ");
	...
	sql_ven_day_state.append("                    ORDER BY A.STR_CODE, A.PUR_CFM_DT ");
...
class ReportHandler{
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|83|영업정보_매입관리_협력업체_직매입_점별출력.style|회원매출상세내역현황", false);
	}
