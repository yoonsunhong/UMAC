...
<script type="text/javascript" src="/resources/js/page/wms/auto/wmsAutoAssignCancel.js?ver=20170724_01" charset="utf-8"></script>
<!-- 공통 팝업 -->
...
$(document).ready(function(){
	...
	jQuery.ajax({
	    ...
	    success : function(data) {
	    	...
	    	if(data == ""){
	    		$("#btn_search").hide();
	    		$("#btn_assign_print").hide();
	    		$("#btn_assign_cancel").hide();
	    		return;
	    	}
 ...
 <body id="in_frame">
		<div id="iframeCnt">
			<div class="btn_area clear">
				...
				<div class="f_r">
					<!-- 권한에 따른 버튼 show/hide -->
					<button type="button" id="btn_assign_print"  class="btn btn_style2" >자동할당 출력</button>
					<button type="button" id="btn_assign_cancel" class="btn btn_style2">할당취소</button>
