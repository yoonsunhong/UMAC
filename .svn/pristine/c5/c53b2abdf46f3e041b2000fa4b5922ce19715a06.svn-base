...
<script type="text/javascript" src="/resources/js/page/posclosed/overandshorts/posClosedOverAndShorts.js?ver=20180409_009" charset="utf-8"></script>
</head>
	...
	jQuery.ajax({
	    ...
	    success : function(data) {
			...
			if(data[0].ORG_TYPE == "3") {
				...
				changeTopSelectStrCode($("#S_STR_CODE").val());
			} else {
				//
			}
	    },
		...
		<form name="frm" id="frm">
			...
			<div class="search_area" id="top_search">
				<div class="last">
					...
					<select id="S_STR_CODE" name="S_STR_CODE" disabled onchange="changeTopSelectStrCode(this.value)">
					...
					<label for=""><spring:message code="cashier"/></label>
