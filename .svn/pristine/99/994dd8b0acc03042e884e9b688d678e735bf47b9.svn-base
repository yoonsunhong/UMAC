...
<title><spring:message code="dateGoodsRcvPaySearch"/></title>
...
<script type="text/javascript" src="/resources/js/page/salesinfo/report/salesInfoReportRcvPayDate.js?ver=20180409_001" charset="utf-8"></script>
</head>
<%
	//전일구하기
		...
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				<div class="last">
					...
					<input type="text" id="P_INV_DT" name="P_INV_DT" class="datepicker1" value="<%=beforeDate%>" readonly="readonly">
					&nbsp;&nbsp;
