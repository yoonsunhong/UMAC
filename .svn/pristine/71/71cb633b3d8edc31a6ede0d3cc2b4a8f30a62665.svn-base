...
<script type="text/javascript" src="/resources/js/page/payment/ledgerSearch/paymentLedgerPurchaseSearch.js?ver=1.1" charset="utf-8"></script>	
...
$(document).ready(function(){
 ...
 <body id="in_frame">
		<div id="iframeCnt">
			...
			<div class="sec_grid">
				<div class="content">
					<h3 class="bul_arr"><spring:message code="purchLedgerSummary"/></h3>
