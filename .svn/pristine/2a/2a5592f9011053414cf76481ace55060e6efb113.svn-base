...
public class BusinessOrderDeliveryVO extends WisModelData{
	...
	private String FISH_YN;
	private String FISH_DT;
	...
	public String getFISH_YN() {
		return FISH_YN;
	}
	public void setFISH_YN(String fISH_YN) {
		FISH_YN = fISH_YN;
	}
	public String getFISH_DT() {
		return FISH_DT;
	}
	public void setFISH_DT(String fISH_DT) {
		FISH_DT = fISH_DT;
	}
