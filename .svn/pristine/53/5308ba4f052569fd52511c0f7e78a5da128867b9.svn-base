...
<script type="text/javascript" src="/resources/js/page/purch/mng/purchMarketPrice.js?ver=20180405_000" charset="utf-8"></script>
 ...
 <body id="in_frame">
		...
		<div id="iframeCnt">
			<div class="btn_area clear">
				...
				<div class="f_r">
					<!-- 권한에 따른 버튼 show/hide -->
					<button type="button" id="btn_excel" class="btn btn_style2" onclick="excelDown();"><spring:message code="btnExcelUploadSample"/></button>
					<button type="button" id="btn_excel_upload" class="btn btn_style2" onclick="excelImport();"><spring:message code="btnExcelUpload"/></button>
					<button type="button" id="btn_update" class="btn btn_style2" onclick="javascript:fnUpdate();"><spring:message code="btnSave"/></button>
					<button type="button" id="btn_delete" class="btn btn_style2" onclick="javascript:fnDelete();"><spring:message code="btnDel"/></button>
					...
					<div class="rgt_wid f_l mar_L10">
						<div class="clear">
							...
							<div class="pro_price f_r">
								...
								<label for=""><spring:message code="categoryNm"/></label>
								<select id="I_LRG_CODE" name="I_LRG_CODE" class="wid2"></select>
