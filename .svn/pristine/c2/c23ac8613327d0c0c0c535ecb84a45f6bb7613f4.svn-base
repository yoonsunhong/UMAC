...
<script type="text/javascript" src="/resources/js/page/business/notice/businessNotice.js?ver=20180406_000" charset="utf-8"></script>
</head>
...
<body id="in_frame"> 		
	...
	<div id="iframeCnt">
		<div class="btn_area clear">
			...
			<div class="f_r">
				<button type="button" id="btn_new" name="btn_new" class="btn btn_style2"><spring:message code="btnNew"/></button>
	...
	<div id="pop_wrap1">
		<header id="pop_head" class="clear">
			...
			<div class="f_r">
			    <button type="button" id="btn_pop_save" name="btn_pop_save" class="btn btn_style4"><spring:message code="btnSave"/></button>
				<button type="button" id="btn_pop_update" name="btn_pop_update" class="btn btn_style4"><spring:message code="updt"/></button>
				<button type="button" id="btn_pop_delete" name="btn_pop_delete" class="btn btn_style4"><spring:message code="btnDel"/></button>
			</div>
		</header>		
		
		<form id="pop_frm" name="pop_frm" enctype="multipart/form-data">
				...
				<table class="tbl_st2">
					<tbody>
						<tr>
							...
							<td>
								<select id="D_PRIORITY" name="D_PRIORITY" class="wid2"></select>
							</td>
						</tr>
						<tr>
							<th scope="row"><em>필수항목</em><label>공개</label></th>
							<td>
								<select id="D_OPEN_FLAG" name="D_OPEN_FLAG" class="wid2"></select>
							</td>
						</tr>
						<tr>
