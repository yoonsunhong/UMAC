...
'<rMateGrid>\
	...
	<DataGrid id="dg1" sortableColumns="true">\
		<columns>\
			...
			<DataGridColumn dataField="PUR_VAT"		headerText="' + taxGubun + '" 		textAlign="right" labelJsFunction="labelFunc" />\
			<DataGridColumn dataField="PUR_TOTAL"	headerText="' + purchTotal + '" 	textAlign="right" labelJsFunction="labelFunc" />\
			<DataGridColumn dataField="BOT_AMT"		headerText="' + botSum + '" 		textAlign="right" labelJsFunction="labelFunc" />\
			<DataGridColumn dataField="JANG_AMT"	headerText="' + jangAmt + '" 		textAlign="right" labelJsFunction="labelFunc" />\
		</columns>\
		<dataProvider>\
				...
				<mergingFields>\
			        <SpanMergingField name="STR_NAME">\
			            <SpanSummaryRow label="소계" labelDataField="STR_NAME" rowAttribute="{sumRowAttr_V}" cellAttribute="{sum1CellAttr}">\
			                ...
			                <SpanSummaryField dataField="PUR_VAT"		summaryOperation="SUM" />\
			                <SpanSummaryField dataField="PUR_TOTAL"		summaryOperation="SUM" />\
