...
class ReportHandler{
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|24|paymentRequestInfoPrint.style|보고서 (2017/3/20 15:26:3)", false);
	}
