...
<script type="text/javascript" src="/resources/js/page/salesmng/point/salesMngPoint.js?ver=20180410_000" charset="utf-8"></script>
</head>
		...
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				<div class="last">
					...
					<input type="text" name="P_SEARCH_START_DT" id="P_SEARCH_START_DT" class="datepicker1 datepicker"/> ~
					<input type="text" name="P_SEARCH_END_DT" id="P_SEARCH_END_DT" class="datepicker2 datepicker"/>
