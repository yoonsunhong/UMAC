...
<title><spring:message code="pointAccumulationStatus"/></title>
...
<script type="text/javascript" src="/resources/js/page/member/point/memberPointStatus.js?ver=20180410_000" charset="utf-8"></script>
</head>
 	...
 	<form name="frm" id="frm">		 	
		<div id="iframeCnt">
			<div class="btn_area clear">
				...
				<div class="f_r">
					<button type="button" class="btn btn_style2"  id="btn_excel_down" name="btn_excel_down" onclick="ExcelDownload()"><spring:message code="btnExcelDown"/></button>
					<%-- <button type="button" class="btn btn_style3"  id="btn_search" name="btn_search" onclick="btn_search(true)"><i class="fa fa-search"></i><spring:message code="btnSearch"/></button> --%>
			...
			<div class="search_area" id="top_search">
				...
				<div class="last">
					...
					<label for="">적립/사용</label>
					<select id="P_POINT_FLAG" name="P_POINT_FLAG" class="wid2">
						<option value=""><spring:message code="all"/></option>
			...
			<div class="col2 sub_cnt">
				<div class="clear">
					<h3 class="bul_arr f_l"><spring:message code="pointAccumulationStatus"/></h3>
				</div>	 		
				<div class="sec_grid">
					<div class="content">
