...
public void jspInit() {
	...
	sql_supply_sale.append("            SELECT  A.VEN_CODE ");
	...
	sql_supply_sale.append("                         * 100 / ");
	sql_supply_sale.append("                        (NVL(A.SALE_QTY,0) * NVL(A.SPRC,0) - A.DC_AMT - A.MBR_DC_AMT) ");
	sql_supply_sale.append("                     ,2)) AS PROPIT_RT ");
	sql_supply_sale.append(" ");
	sql_supply_sale.append("            FROM ");
	sql_supply_sale.append("            (SELECT CPS.VEN_CODE ");
	...
	sql_supply_sale.append("            FROM ");
	sql_supply_sale.append("                    SL_SALE_HDR SSH ");
	...
	sql_supply_sale.append("            AND     CPS.VEN_CODE    = CS.VEN_CODE ");
	...
	sql_supply_sale.append("            AND     CPS.VEN_CODE     = NVL('^P_VEN_CODE^',CS.VEN_CODE) ");
	sql_supply_sale.append("            GROUP BY        CPS.VEN_CODE ");
	sql_supply_sale.append("                    ,       CS.VEN_NAME ");
	sql_supply_sale.append("                    ,       SSI.SCAN_CODE ");
	sql_supply_sale.append("                    ,       CPC.ITM_NAME ");
	...
	sql_supply_sale.append("            ORDER BY A.VEN_CODE,A.SCAN_CODE ");
...
class ReportHandler{
	...
	private void setFieldVariableFromsupply_sale() throws Exception{
		supply_sale_VEN_CODE = GetB(supply_sale.getString(1));
		supply_sale_VEN_NAME = GetB(supply_sale.getString(2));
		supply_sale_SCAN_CODE = GetB(supply_sale.getString(3));
		supply_sale_ITM_NAME = GetB(supply_sale.getString(4));
		supply_sale_SALE_QTY = supply_sale.getLong(5);
		supply_sale_SPRC = supply_sale.getLong(6);
		supply_sale_WPRC = supply_sale.getLong(7);
		supply_sale_BOT_AMT = supply_sale.getLong(8);
		supply_sale_DC_AMT = supply_sale.getLong(9);
		supply_sale_MBR_DC_AMT = supply_sale.getLong(10);
		supply_sale_SALE_SPRC = supply_sale.getLong(11);
		supply_sale_SALE_WPRC = GetB(supply_sale.getString(12));
		supply_sale_SALE_SAMT = supply_sale.getLong(13);
		supply_sale_PROPIT_AMT = supply_sale.getLong(14);
		supply_sale_PROPIT_RT = supply_sale.getDouble(15);
	}
