...
<title><spring:message code="selngAcmsltSearch"/></title>
...
<script type="text/javascript" src="/resources/js/page/member/report/memberSalesCategory.js?ver=20180410_000" charset="utf-8"></script> 
</head>
...
<%-- 					</c:if>				         	 --%>
			...
			<div class="search_area" id="top_search">
				<div>
					...
					<input type="hidden" id="P_DTL_LRG_CODE" name="P_DTL_LRG_CODE" class="search_txt">
					<select id="P_LRG_CODE" name="P_LRG_CODE" class="wid2" >
						<option value=""><spring:message code="select"/></option>   
					</select>
					
					<label for=""><spring:message code="btnSearchDate"/></label>					
					<input type="text" id="P_SALE_SD" name=P_SALE_SD class="datepicker1 datepicker" value="" readonly="readonly"> 
					~
					 <input type="text" id="P_SALE_ED" name="P_SALE_ED" class="datepicker2 datepicker" value="" readonly="readonly">	
				</div>
				<div class="last">
