...
'<rMateGrid>\
	...
	<DataGrid id="dg1" sortableColumns="true" selectionMode="multipleRows"   verticalAlign="middle" showDataTips="true" >\
			<groupedColumns>\
				<DataGridColumn dataField="DIN_STR_CODE" headerText="'+storCode+'" textAlign="center" sortable="false" width="100" visible="false"/>\
				<DataGridColumn dataField="DIN_STR_NAME" headerText="'+storNm+'" textAlign="center" width="100"/>\
				<DataGridColumn dataField="DOUT_DT"  headerText="'+deliveryDate+'" textAlign="center" width="100" />\
			 	<DataGridColumn dataField="VEN_CODE" headerText="'+venCode+'" textAlign="center" width="100" visible="false"/>\
				<DataGridColumn dataField="VEN_NAME" headerText="'+venName+'" textAlign="left" sortable="false"/>\
				<DataGridColumn dataField="ITM_CODE" headerText="'+itmCode+'" textAlign="center" sortable="false" width="100"/>\
				...
				<DataGridColumn dataField="ITM_FORM" headerText="'+itmGb+'" textAlign="center" sortable="false" width="80" />\
				<DataGridColumn dataField="IPSU_QTY"  headerText="'+ipsuQty+'"  textAlign="right" sortable="false" formatter="{numfmt}" width="70"  />\
				<DataGridColumn dataField="DOUT_QTY" headerText="'+orderQuantity+'" textAlign="right"  formatter="{numfmt}" width="80" />\
			    <DataGridColumn dataField="DOUT_CFM_QTY" headerText="'+logisticsShipmentQuantity+'" textAlign="right"   formatter="{numfmt}" width="80" />\
				<DataGridColumn dataField="MISS_QTY" headerText="'+nonPaymentOutflowQuantity+'"  textAlign="right"  formatter="{numfmt}" width="100" />\
			</groupedColumns>\
			<dataProvider>\
				<SpanSummaryCollection source="{$gridData}">\
					<mergingFields>\
						<SpanMergingField name="DIN_STR_CODE"/>\
...
function fn_comm_supply_callback(dataRow){
	...
	$('#P_VEN_CODE' ).val(dataRow.VEN_CODE);		// 협력업체명
...
function ExcelDownload() {
	...
	//엑셀호출
	$.download('/wmsOutMissExcelDown.do',"P_DOUT_SDT="+P_DOUT_SDT 
