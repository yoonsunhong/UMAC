...
import retail.wms.stock.wmsStockLocation.service.WmsStockLocationVO;
...
@Service("WmsStockLocationService")
public class WmsStockLocationServiceImpl  implements WmsStockLocationService {

	@Autowired
	private WmsStockLocationDao wmsStockLocationDao;
	 
	
	private static final Logger LOGGER = LoggerFactory.getLogger(WmsStockLocationServiceImpl.class);
	...
	public void getWmsStockLocationList(Map<String, Object> param)throws Exception {
		wmsStockLocationDao.getWmsStockLocationList(param);
	}
	...
	@Override
	@Transactional
	public Map<String, Object> wmsStockLocationExcelDown(Map<String, Object> paramMap) throws Exception {
		...
		wmsStockLocationDao.wmsStockLocationExcelDown(paramMap);		
		
		
		List<WmsStockLocationVO> RETURN_CUR = (List<WmsStockLocationVO>) paramMap.get("CUR");
