...
public void jspInit() {
	...
	sql_EMATE_TOTAL_AMT.append("SELECT NUM_TO_HANGUL(NVL(SUM(CASE WHEN CED.TAX_GB = '1' THEN (CED.EMATE_SPRC * CED.ORD_QTY) - TRUNC((CED.EMATE_SPRC * CED.ORD_QTY) / 11, 0) ");
...
class ReportHandler{
	...
	private void getScriptFromsh_vb(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			nAutoHeight_sh_vb[16]=nAutoHeight_sh_vb[15]+nAutoHeight_sh_vb[16]+20;
	...
	private void writeScriptsh_vb( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_E17"), nYCurPos+mapTop.get("sheet10_E17"), mapWidth.get("sheet10_E17"), mapHeight.get("sheet10_E17"), "", "sheet10_E17", mapStyle.get("sheet10_E17"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_F17"), nYCurPos+mapTop.get("sheet10_F17"), mapWidth.get("sheet10_F17"), mapHeight.get("sheet10_F17"), "", "sheet10_F17", mapStyle.get("sheet10_F17"));
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|22|estimatePrint.style|보고서 (2017/3/9 13:52:2)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_C17", 118, nAutoHeight_sh_vb[15], 62, nAutoHeight_sh_vb[16]-nAutoHeight_sh_vb[15], "cell_style_36");
		setCellInfoMap_Internal("sheet10_D17", 180, nAutoHeight_sh_vb[15], 47, nAutoHeight_sh_vb[16]-nAutoHeight_sh_vb[15], "cell_style_37");
		setCellInfoMap_Internal("sheet10_E17", 227, nAutoHeight_sh_vb[15], 41, nAutoHeight_sh_vb[16]-nAutoHeight_sh_vb[15], "cell_style_38");
		setCellInfoMap_Internal("sheet10_F17", 268, nAutoHeight_sh_vb[15], 54, nAutoHeight_sh_vb[16]-nAutoHeight_sh_vb[15], "cell_style_38");
		...
		setCellInfoMap_Internal("sheet20_F1", 352, 0, 48, 20, "cell_style_43");
		...
		setCellInfoMap_Internal("sheet20_F2", 352, 0, 48, 20, "cell_style_48");
		setCellInfoMap_Internal("sheet20_G2", 400, 0, 48, 20, "cell_style_48");
		setCellInfoMap_Internal("sheet20_H2", 448, 0, 48, 20, "cell_style_48");
		setCellInfoMap_Internal("sheet20_I2", 496, 0, 48, 20, "cell_style_49");
		setCellInfoMap_Internal("sheet20_A3", 0, 0, 400, 20, "cell_style_50");
		setCellInfoMap_Internal("sheet20_G3", 400, 0, 48, 20, "cell_style_51");
		setCellInfoMap_Internal("sheet20_H3", 448, 0, 48, 20, "cell_style_51");
		setCellInfoMap_Internal("sheet20_I3", 496, 0, 48, 20, "cell_style_52");
		setCellInfoMap_Internal("sheet20_A4", 0, 0, 211, 1, "cell_style_53");
		setCellInfoMap_Internal("sheet20_B4", 211, 0, 31, 1, "cell_style_54");
		setCellInfoMap_Internal("sheet20_C4", 242, 0, 48, 1, "cell_style_54");
		setCellInfoMap_Internal("sheet20_D4", 290, 0, 31, 1, "cell_style_54");
		setCellInfoMap_Internal("sheet20_E4", 321, 0, 31, 1, "cell_style_54");
		setCellInfoMap_Internal("sheet20_F4", 352, 0, 48, 1, "cell_style_55");
		setCellInfoMap_Internal("sheet20_G4", 400, 0, 48, 1, "cell_style_55");
		setCellInfoMap_Internal("sheet20_H4", 448, 0, 48, 1, "cell_style_55");
		setCellInfoMap_Internal("sheet20_I4", 496, 0, 48, 1, "cell_style_56");
		setCellInfoMap_Internal("sheet20_A5", 0, 1, 544, 20, "cell_style_57");
		setCellInfoMap_Internal("sheet20_A6", 0, 21, 544, 20, "cell_style_58");
	}
}
%>
