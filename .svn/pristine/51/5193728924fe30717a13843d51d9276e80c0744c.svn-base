...
/**
 * 
 * @Class Name : MemberGradeServiceImpl.java
...
public class MemberGradeServiceImpl implements MemberGradeService {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(MemberGradeServiceImpl.class);

	@Override
	public Map<String, Object> getMemberGradeDetail(Map<String, Object> param) throws Exception {
		return memberGradeDao.getMemberGradeDetail(param);
	}
	
	@Override
	public Map<String, Object> updateMemberGrade(Map<String, Object> param) throws Exception {
		return memberGradeDao.updateMemberGrade(param);
	}
