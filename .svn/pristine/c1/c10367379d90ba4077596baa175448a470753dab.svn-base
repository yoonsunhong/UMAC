	...
	jQuery.ajax({ 
		...
		success:function(data){
			...
			for(var i=0; i < data.list2.length; i++){
				...
				htmlRows += '<tr>';
				htmlRows += '	<th scope="row">' + data.list2[i].STR_NAME + '</th>';
				htmlRows += '	<td>' + moneyComma(String(data.list2[i].SALE_QTY)) + '</td>';
				htmlRows += '	<td>' + moneyComma(String(data.list2[i].SALE_AMT)) + '</td>';
				htmlRows += '	<td>' + moneyComma(String(data.list2[i].BOT_AMT)) + '</td>';
				htmlRows += '	<td>' + moneyComma(String(data.list2[i].DA_SDA)) + '</td>';
				htmlRows += '	<td>' + moneyComma(String(data.list2[i].MBR_DC_AMT)) + '</td>';
				htmlRows += '	<td>' + moneyComma(String(data.list2[i].SA_DA_SDA_MDA)) + '</td>';
				htmlRows += '	<td>' + moneyComma(String(data.list2[i].ITM_CNT)) + '</td>';
				htmlRows += '	<td>' + moneyComma(String(data.list2[i].CUST_AMT)) + '</td>';
				htmlRows += '</tr>';
