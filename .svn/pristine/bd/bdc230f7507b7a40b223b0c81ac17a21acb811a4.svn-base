...
<script type="text/javascript" src="/resources/js/page/inoutcenter/mng/inoutcenterSumMng.js?ver=20180326_000"  charset="utf-8"></script>
 ...
 <body id="in_frame">
	...
	<div id="iframeCnt">
		<div class="btn_area clear">
			...
			<div class="f_r">
				<!-- 권한에 따른 버튼 show/hide -->
				<button type="button" id="btn_print" class="btn btn_style2" onclick="btn_print()">총합계출력</button>
				<!-- <button type="button" id="btn_print2" class="btn btn_style2" onclick="btn_print2()">내부거래출력</button> -->
				<button type="button" id="btn_print3" class="btn btn_style2" onclick="btn_print3()">내부거래출력</button>
			</div>
		</div>
