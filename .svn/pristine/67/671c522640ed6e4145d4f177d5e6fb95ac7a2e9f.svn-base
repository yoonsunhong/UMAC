...
<script type="text/javascript" src="/resources/js/page/wms/in/wmsInNonPayment/wmsInNonPayment.js?ver=234" charset="utf-8"></script>
<!-- 공통 팝업 -->
		...
		<div id="iframeCnt">
			...
			<div class="search_area"    id="top_search">
				...
				<div class="last">
					...
					<select  id="P_PUR_GB" name="P_PUR_GB"  style="width: 60px"></select>					
				</div>
			</div>
			<!-- //조회폼 영역 -->
			
			<div class="col2 sub_cnt" id="dataForm" name="dataForm">
				<h3 class="bul_arr"><spring:message code="statusOfNonPayment"/></h3>
				<div class="sec_grid">
					<div class="content">
