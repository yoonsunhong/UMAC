...
<script type="text/javascript" src="/resources/js/page/purch/supply/supplyPurchState.js?ver=20180326_001" charset="utf-8"></script>
<!-- 공통 팝업 -->
 	...
 	<form name="frm" id="frm">
		<div id="iframeCnt">
			<div class="btn_area clear">
				...
				<div class="f_r">
					<button type="button" id="btn_print3" class="btn btn_style2">점별출력</button>
			...
			<!-- 조회폼 영역 -->
				<div id="top_search" class="search_area">
					<div class="last">		
						...
						<input type="text" id="P_SALE_DT" name="P_SALE_DT" class="datepicker" /> ~ <input type="text" name="P_SALE_DT_E" id="P_SALE_DT_E" class="datepicker" />
