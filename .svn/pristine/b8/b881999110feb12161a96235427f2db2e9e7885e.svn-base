...
<title><spring:message code="eventGoodsLogSearch"/></title>
...
<script type="text/javascript" src="/resources/js/page/salesinfo/report/salesInfoReportEGL.js?ver=20180406_000" charset="utf-8"></script>
</head>
		...
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				<div>
					...
					<select id="P_STR_CODE" name="P_STR_CODE" class="wid2 P_STR_CODE" >
...
<!-- 					&nbsp;&nbsp; -->
					...
					<input type="text" id="P_EVT_NAME_V" name="P_EVT_NAME_V" class="search_txt" style="width:170px;">  
...
<!-- 					&nbsp;&nbsp; -->
					...
					<input type="text" id="P_VEN_NAME" name="P_VEN_NAME" class="search_txt" onblur="clearVenCode()" /> <button type="button" class="search_btn"  id="P_VEN_NAME_SEARCH" name="P_VEN_NAME_SEARCH">searchIcon</button>					
				</div>
				<div class="last">
					...
					<select id="P_CLS_CODE" name="P_CLS_CODE" class="wid2" onchange="chgCate3()" style="margin-right:157px;">
						<option value=""><spring:message code="select"/></option>   
					</select>
					
					<label for="">상품명</label>
					<input type="text" id="P_SEARCH_ITM_NAME" name="P_SEARCH_ITM_NAME" class="search_txt" style="width:170px;margin-right:61px;">  
			...
			<div class="col2 sub_cnt">
				<div class="clear">
					<h3 class="bul_arr f_l"><spring:message code="eventGoodsLogSearch"/></h3>
				</div>	 		
				<div class="sec_grid">
					<div class="content">
