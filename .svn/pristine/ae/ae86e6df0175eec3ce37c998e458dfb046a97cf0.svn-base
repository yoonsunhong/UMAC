...
<script type="text/javascript" src="/resources/js/page/business/exchangemaster/businessExchangeMaster.js?ver=20180406_000" charset="utf-8"></script>
<!-- 공통팝업호출 -->
...
$(document).ready(function(){
 ...
 <body id="in_frame">
		<div id="iframeCnt">
			...
			<div class="clear">
				<div class="f_l lft_wid">
					<h3 class="bul_arr tit_top">점포명</h3>		
					<div class="sec_grid">
						<div class="content">
				...
				<div class="f_r rgt_wid">
					<h3 class="bul_arr tit_top"><spring:message code="evtDetail"/></h3>
					<table class="tbl_st2" id="form1" name="form1">
						...
						<tbody>
							<tr>
								...
								<td>
									<select id="B_EVT_FLAG" name="B_EVT_FLAG" class="wid2"></select>
								</td>
								<%-- <th scope="row"><label><spring:message code="storeName"/></label></th>
								<td>
									<select id="B_STR_CODE" name="B_STR_CODE" class="wid2"></select>
								</td> --%>
								<th scope="row"><em>필수입력항목</em><label><spring:message code="evtType"/></label></th>
								<td>
									<select id="B_EVT_TYPE" name="B_EVT_TYPE" class="wid2"></select>
									<input type="hidden" id="B_CARD_FLAG" name="B_CARD_FLAG" >
								</td>
							...
							<tr> 
								...
								<td colspan="7">				
									<input type="hidden" id="P_CARD_LIST" name="P_CARD_LIST" maxlength="" disabled>
									<button type="button" id="btnCardList" class="btn btn_style4" onclick="btnCardList()">카드등록 정보 조회</button>
								</td> 
							</tr>						
							<tr> 
