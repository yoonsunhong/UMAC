...
<script type="text/javascript" src="/resources/js/page/order/store/orderStoreRegisterExcel.js"" charset="utf-8"></script>
...
<!-- 				<button type="button" id="btn_clear"   name="btn_clear"   class="btn btn_style2"  onclick="btn_report('sample.do')">REPORT TEST</button> -->
		    	...
		    	<button type="button" id="btn_clear"   name="btn_clear"   class="btn btn_style2"  onclick="btn_del()">삭제</button>
		    	<button type="button" id="btn_clear"   name="btn_clear"   class="btn btn_style2"  onclick="btn_qty_save()">저장</button>
<!-- 		    	 <button type="button" id="btn_save"    name="btn_save"    class="btn btn_style2"  onclick="btn_save();">엑셀 저장(2)</button> -->
...
<!-- 				<tr id="BUYER_CONTENTS" style="display: none;"> -->
...
:-ms-input-placeholder { /* Internet Explorer 10-11 */
 ...
 -->
					...
					<button type="button" class="search_btn"     onclick="btn_comm_store_search()"><img src="/resources/img/common/search_ico.png"></button>
					...
					<button type="button"  class="btn btn_style4"  onclick="btn_itm_add()">저장</button>
