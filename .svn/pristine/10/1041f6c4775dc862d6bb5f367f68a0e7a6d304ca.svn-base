	...
	'<rMateGrid>\
		...
		<DataGrid id="dg1" sortableColumns="true">\
			<groupedColumns>\
				...
				<DataGridColumn dataField="SALE_SPRC_DATE" 	 		headerText="'+calText17+selngAcmslt+'"  	textAlign="right" formatter="{numfmt}"/>\
				<DataGridColumnGroup headerText="'+monthAcmtl+'">\
					<DataGridColumn dataField="GOAL_AMT_M" 	 			headerText="'+goalAmount+'"  		textAlign="right" formatter="{numfmt}"/>\
					<DataGridColumn dataField="SALE_SPRC_MONTH" 	 	headerText="'+selngAcmslt+'"  	textAlign="right" formatter="{numfmt}"/>\
					<DataGridColumn headerText="'+achivPer+'"  			textAlign="right" labelJsFunction="perFunction1"/>\
				</DataGridColumnGroup>\
				<DataGridColumnGroup headerText="'+yearAcmtl+'">\
					<DataGridColumn dataField="GOAL_AMT_Y" 	 			headerText="'+goalAmount+'"  		textAlign="right" formatter="{numfmt}"/>\
					<DataGridColumn dataField="SALE_SPRC_YEAR" 	 		headerText="'+selngAcmslt+'"  	textAlign="right" formatter="{numfmt}"/>\
					<DataGridColumn headerText="'+achivPer+'"  			textAlign="right" labelJsFunction="perFunction2"/>\
				</DataGridColumnGroup>\
					...
					<GroupingField name="TOTAL_NAME">\
					    <summaries>\
					        <SummaryRow summaryPlacement="group">\
								<SummaryField dataField="SALE_SPRC_DATE" 	summaryOperation="SUM" label="SALE_SPRC_DATE" />\
								<SummaryField dataField="GOAL_AMT_M" 		summaryOperation="SUM" label="GOAL_AMT_M" />\
								<SummaryField dataField="SALE_SPRC_MONTH" 	summaryOperation="SUM" label="SALE_SPRC_MONTH" />\
								<SummaryField dataField="GOAL_AMT_Y" 		summaryOperation="SUM" label="GOAL_AMT_Y" />\
								<SummaryField dataField="SALE_SPRC_YEAR" 	summaryOperation="SUM" label="SALE_SPRC_YEAR" />\
					        </SummaryRow>\
					    </summaries>\
					</GroupingField>\
...
function getGridData() {
	...
	jQuery.ajax({ 
	    url:"/salesInfoReportYieldList.do",
	    type:"POST",
		datatype:"json",
		//async:false,
		data: params,
...
function getGridData2(num1,num2) {
	jQuery.ajax({ 
		url:"/salesInfoReportYieldDetailList.do",
		type:"POST",
		datatype:"json",
		//async:false,
