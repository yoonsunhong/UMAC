...
/**
 * 
 * @Class Name : BusinessExchangePrintDAO.java
 ...
 */
@Repository("BusinessExchangePrintDao")
public class BusinessExchangePrintDao extends EgovAbstractDAO {
	
	public Map<String, Object> businessExchangePrintList(Map<String, Object> params) throws Exception {
		select("businessExchangePrint.businessExchangePrintList", params);
		return params;
	}
	
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> businessExchangePrintListExcel(Map<String, Object> params) throws Exception {
		return (List<Map<String, Object>>) list("businessExchangePrint.businessExchangePrintListExcel", params);
	}
	
	public Map<String, Object> BusinessExchangePrintPopupList(Map<String, Object> param) throws Exception {		
		list("businessExchangePrint.BusinessExchangePrintPopupList", param);
		return param;	
	}
