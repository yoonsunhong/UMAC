...
<title><spring:message code="slSaleMenuName"/></title>
...
<script type="text/javascript" src="/resources/js/page/salesinfo/sales/salesPerformanceView.js?ver=20180314_0031" charset="utf-8"></script>
</head>
...
<body id="in_frame">
	<div id="iframeCnt">
		...
		<form name="search_frm" id="search_frm">
			<div class="search_area" id="top_search">
				<div>
					...
					<label for=""><spring:message code="slSaleStdPeriod" /></label><!-- 기준기간 -->
					<input type="text" id="S_STD_STR_DT" name="S_STD_STR_DT" class="datepicker">
					~
					<input type="text" id="S_STD_END_DT" name="S_STD_END_DT" class="datepicker">
					<label for=""><spring:message code="slSaleCtrPeriod" /></label><!-- 대비기간 -->
					<input type="text" id="S_CTR_STR_DT" name="S_CTR_STR_DT" class="datepicker">
					~
					<input type="text" id="S_CTR_END_DT" name="S_CTR_END_DT" class="datepicker">
				</div>
			</div>
		</form>
		<!-- //조회폼 영역 -->
		...
		<div class="col2 sub_cnt">
			<div class="clear">
				<h3 class="bul_arr f_l"><spring:message code="slSaleTitle" /></h3><!-- 상품분류별매출현황 -->
			</div>
			<div class="sec_grid">
				<div class="content">
