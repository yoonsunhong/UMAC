...
public void jspInit() {
	...
	sql_ven_day_state.append(",       A.SALE_AMT  - (A.PAY_AMT_TAX1 + A.PAY_AMT_TAX2 + PAY_AMT_TAX1_VAT) AS BENEPIT_AMT ");
	sql_ven_day_state.append(",       CASE WHEN A.SALE_AMT <> 0 ");
	sql_ven_day_state.append("             THEN ROUND((A.SALE_AMT  - (A.PAY_AMT_TAX1 + A.PAY_AMT_TAX2 + PAY_AMT_TAX1_VAT)) /A.SALE_AMT *100,2) ");
	...
	sql_ven_day_state.append("    AND     SD.SALE_DT BETWEEN  '^P_SALE_DT^' ||'01' AND  '^P_SALE_DT^'||'31' ");
...
class ReportHandler{
	...
	private void getScriptFromV1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//데이터 변수 할당
			sheet10_A1="협력업체/일자별 매입 집계표[임대을]";
		}    //end if(bIsFirst)
	...
	private void getScriptFromsh3_fv1_sub2(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			//데이터 변수 할당
			sheet30_A4="합계";
			sheet30_C4=(long)SUM(sheet30_C3, sheet30_C4);
	...
	private void getScriptFromsh3_fv1(boolean bIsPrint) throws Exception{
		...
		while(ven_day_state.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet30_C3 = (long)ven_day_state_PAY_AMT_TAX2;
			sheet30_D3 = (long)ven_day_state_PAY_AMT_TAX1;
			sheet30_E3 = (long)ven_day_state_PAY_AMT_TAX1_VAT;
			sheet30_F3 = (long)ven_day_state_PAY_AMT_TAX;
			sheet30_G3 = ven_day_state_SALE_AMT_2_SUM;
			sheet30_H3 = ven_day_state_SALE_AMT_1_SUM;
			sheet30_I3 = ven_day_state_SALE_AMT_VAT_1_SUM;
			sheet30_J3 = ven_day_state_SALE_AMT_TOTAL_SUM;
			sheet30_K3 = ven_day_state_BENEPIT_AMT;
			sheet30_L3 = ven_day_state_BENEPIT_RATE;
	...
	private void writeScriptsh3_fv1_sub2( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet30_C4"), nYCurPos+mapTop.get("sheet30_C4"), mapWidth.get("sheet30_C4"), mapHeight.get("sheet30_C4"), String.valueOf(sheet30_C4), "sheet30_C4", mapStyle.get("sheet30_C4"));
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|56|test.style|회원매출상세내역현황", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet30_A1", 0, 0, 47, 40, "cell_style_2");
		setCellInfoMap_Internal("sheet30_B1", 47, 0, 132, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_C1", 179, 0, 59, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_D1", 238, 0, 67, 40, "cell_style_4");
		setCellInfoMap_Internal("sheet30_E1", 305, 0, 50, 40, "cell_style_2");
		setCellInfoMap_Internal("sheet30_F1", 355, 0, 67, 40, "cell_style_2");
		setCellInfoMap_Internal("sheet30_G1", 422, 0, 68, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_H1", 490, 0, 69, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_I1", 559, 0, 69, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_J1", 628, 0, 65, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_K1", 693, 0, 53, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_L1", 746, 0, 34, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_A3", 0, -1, 47, -1, "cell_style_5");
		setCellInfoMap_Internal("sheet30_B3", 47, -1, 132, -1, "cell_style_6");
		setCellInfoMap_Internal("sheet30_C3", 179, 0, 59, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet30_D3", 238, 0, 67, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet30_E3", 305, 0, 50, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet30_F3", 355, 0, 67, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet30_G3", 422, 0, 68, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet30_H3", 490, 0, 69, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet30_I3", 559, 0, 69, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet30_J3", 628, 0, 65, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet30_K3", 693, 0, 53, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet30_L3", 746, 0, 34, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_A4", 0, 0, 179, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_C4", 179, 0, 59, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_D4", 238, 0, 67, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_E4", 305, 0, 50, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_F4", 355, 0, 67, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_G4", 422, 0, 68, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_H4", 490, 0, 69, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_I4", 559, 0, 69, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_J4", 628, 0, 65, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_K4", 693, 0, 53, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_L4", 746, 0, 34, 20, "cell_style_10");
	}
}
%>
