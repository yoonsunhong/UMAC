...
function itemClickHandler1(event){
	...
	if(dataRow1["CORP_CODE"] != undefined || dataRow1["STR_CODE"] != undefined || dataRow1["INV_DT"] != undefined){
		getGridData2(dataRow1["CORP_CODE"],dataRow1["STR_CODE"],dataRow1["INV_DT"],dataRow1["CLS_CODE"],dataRow1["MID_CODE"],dataRow1["LRG_CODE"]);
	};
}
	...
	'<rMateGrid>\
		...
		<DataGrid id="dg1" sortableColumns="true" horizontalScrollPolicy="auto" lockedColumnCount="1">\
			<groupedColumns>\
				...
				<DataGridColumn dataField="PUR_SAMT"		headerText="'+purchaseSprc+'"		textAlign="right"		formatter="{numfmt}"/>\
					...
					<GroupingField name="TOTAL_NAME">\
					    <summaries>\
					        <SummaryRow summaryPlacement="group">\
								...
								<SummaryField dataField="PUR_WAMT" 	summaryOperation="SUM" label="PUR_WAMT" />\
								<SummaryField dataField="PUR_SAMT" 	summaryOperation="SUM" label="PUR_SAMT" />\
...
function getGridData() {
	...
	jQuery.ajax({ 
	    url:"/salesInfoReportRcvPayDateList.do",
	    type:"POST",
		datatype:"json",
		//async:false,
		data: params,
...
function getGridData2(num1,num2,num3,num4,num5,num6) {
	jQuery.ajax({ 
		url:"/salesInfoReportRcvPayDateDetailList.do",
		type:"POST",
		datatype:"json",
		//async:false,
		data: {'P_CORP_CODE':num1,'P_STR_CODE':num2,'P_INV_DT':num3,'P_CLS_CODE':num4,'P_MID_CODE':num5,'P_LRG_CODE':num6},
...
function excelExport(){    
	...
	dataGrid1.exportFileName = dateGoodsRcvPaySearch+"_"+date+".xlsx";
