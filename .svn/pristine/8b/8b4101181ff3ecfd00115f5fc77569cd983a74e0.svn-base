...
public class ProductBoxDao extends EgovAbstractDAO {
	...
	public List<Map<String, Object>> productBoxalready_ch(Map<String, Object> params) throws Exception {
		 
		return (List<Map<String, Object>>) list("productBox.productBoxalready_ch", params);
