...
public class StockRealExcelVO {
	...
	private String  MISS_QTY;
	private String  SCAN_CODE;
	private String  LRG_CODE_NAME;
	private String  UNIT;
	private String  WPRC;
	private String  SPRC;
	...
	public String getLRG_CODE_NAME() {
		return LRG_CODE_NAME;
	}
	public void setLRG_CODE_NAME(String lRG_CODE_NAME) {
		LRG_CODE_NAME = lRG_CODE_NAME;
	}
	...
	public String getMISS_QTY() {
		return MISS_QTY;
	}
	public void setMISS_QTY(String mISS_QTY) {
		MISS_QTY = mISS_QTY;
	}
