 ...
 */
package retail.posmaster.member.web;
...
/**
 * 
 * @Class Name : PosMasterMemberController.java
 ...
 */
@Controller
public class PosMasterMemberController {

	@Autowired
	private PosMasterMemberService posMasterMemberService;
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/posMasterMember.do", method = RequestMethod.GET)
	public ModelAndView posMasterMember(@RequestParam Map<String, Object> param, HttpServletResponse response ) throws Exception {
		
		ModelAndView mav = new  ModelAndView();
		
		mav.setViewName("retail/posmaster/member/posMasterMember");
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/posMasterMemberList.do", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> posMasterMemberList(@RequestParam Map<String, Object> param, HttpServletResponse response ) throws Exception {
		...
		try {
			...
			param = posMasterMemberService.getPosMasterMember(param);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/updatePosMasterMember.do", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updatePosMasterMember(@RequestParam Map<String, Object> param, HttpServletResponse response, HttpSession session) throws Exception {
		...
		try {
			...
			log.debug("param :: " + param.toString());
			param = posMasterMemberService.updatePosMasterMember(param);
