...
import retail.stock.stockReal.service.StockRealVO;
...
@Controller
public class StockRealController {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/stockReal.do", method = RequestMethod.GET)
	public ModelAndView stockReal(HttpServletRequest request, HttpServletResponse response )throws Exception { 
		ModelAndView mav = new  ModelAndView("retail/stock/stockReal/stockReal"); 
		return   mav; 
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/stockRealConfirm.do", method = RequestMethod.GET)
	public ModelAndView stockRealConfirm(HttpServletRequest request, HttpServletResponse response )throws Exception { 
		ModelAndView mav = new  ModelAndView("retail/stock/stockReal/stockRealConfirm"); 
		return   mav; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/getSelectStoreCode.do", method=RequestMethod.POST)
	public void getSelectStoreCode( HttpServletRequest request,HttpServletResponse response)throws Exception {
		...
		//점포리스트박스 조회
		stockRealService.getSelectStoreCode(paramMap);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/getInvInspSchdIdList.do", method=RequestMethod.POST)
	public void getInvInspSchdIdList( HttpServletRequest request,HttpServletResponse response)throws Exception {
		...
		//점포에 예정된 재고조사 일정 ID 리스트 조회
		stockRealService.getInvInspSchdIdList(paramMap);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/getInvInspDt.do", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> getInvInspDt(@RequestParam Map<String, Object> param, HttpServletRequest request, HttpServletResponse response ) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/getProductDtlInfo.do", method = RequestMethod.POST)
	@ResponseBody
	public void getProductDtlInfo(@RequestParam Map<String, Object> param, HttpServletRequest request, HttpServletResponse response ) throws Exception {
		...
		stockRealService.getProductDtlInfo(param);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/stockGridExcelUpload.do", method = RequestMethod.POST)
	@ResponseBody	
	public Map<String, Object> stockGridExcelUpload(MultipartHttpServletRequest request, HttpServletResponse response)throws Exception{
        ...
        for(Map<String, String> article: excelContent){
        	...
        	Element P_CORP_CODE = new Element("P_CORP_CODE");
  		    ...
  		    ////3DEPT설정 (엘리먼트에 값 맵핑)
  		  	...
  		  	P_MKT_GB.setText(article.get("D"));							//매장구분
  		  	P_INV_QTY.setText(article.get("C"));							//조사수량
  		  	P_IEMP_NO.setText(IEMP_NO);									//등록ID
  		  	P_STR_CODE.setText(article.get("A"));							//점포코드
  		  	P_SCAN_CODE.setText(article.get("B"));						//스캔코드
  		  	if(article.get("E") == null || article.get("E").equals("")){
  		  		P_SPRC.setText("0");						//단가
  		  	}else{
  		  		P_SPRC.setText(article.get("E"));						//단가
  		  	}
...
//  		  	System.out.println(article.get("E")); //단가
        }
		 ...
		 * 5.거래구분이 직매입만 (GRE_GB : 1 인것만 )
		 */
		stockRealService.stockGridExcelUpload(result);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/saveStockRealData.do", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> saveStockRealData(@RequestParam Map<String, Object> param ,HttpServletRequest request, HttpServletResponse response )throws Exception { 
		...
		//실사재고 그리드1데이터 저장
		stockRealService.saveStockRealData(param);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/getStockRealData.do", method = RequestMethod.POST)
	@ResponseBody
	public void getStockRealData(@RequestParam Map<String, Object> param ,HttpServletRequest request, HttpServletResponse response )throws Exception { 
		...
		//실사재고 조회
		stockRealService.getStockRealData(param);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/getStockRealDataCheckList.do", method = RequestMethod.POST)
	@ResponseBody
	public void getStockRealDataCheckList(@RequestParam Map<String, Object> param ,HttpServletRequest request, HttpServletResponse response )throws Exception { 
		...
		//실사재고 조회(확정) - 탭2
		stockRealService.getStockRealDataCheckList(param);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/updateStockRealData.do", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateStockRealData(@RequestParam Map<String, Object> param ,HttpServletRequest request, HttpServletResponse response )throws Exception { 
		...
		//실사재고 그리드2 데이터 수정/삭제
		stockRealService.updateStockRealData(param);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/submitStockRealData.do", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> submitStockRealData(@RequestParam Map<String, Object> param ,HttpServletRequest request, HttpServletResponse response )throws Exception { 
		...
		//실사재고 그리드2 데이터 확정
		stockRealService.submitStockRealData(param);
	...
	@RequestMapping(value="/stockRealPreview.do", method=RequestMethod.POST)
	public void stockRealPreview(@RequestParam Map<String, Object> param, HttpServletResponse response, HttpServletRequest request) throws Exception {
		try{
			param.put("P_CORP_CODE"    			, CommonUtil.getEnv(request.getSession()).getCORP_CODE() ) ;
			param.put("P_UEMP_NO" 	    		, CommonUtil.getEnv(request.getSession()).getUserId()) ;
			param.put("P_INV_INSP_SCHD_ID" 	, ((String) param.get("P_INV_INSP_SCHD_ID")).replaceAll("-", "") ) ;
			...
			log.debug("===========================================================================");
			log.debug("stockReal.stockRealPreview param :: " + param.toString());
			List<Map<String, Object>> resultList = stockRealService.stockRealPreview(param);
