...
//		paramMap.put("P_CD_CL", request.getParameter("CD_CL"));
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/getAuthButtonList.do",  method = RequestMethod.POST)
	public void  getAuthButtonList( @RequestParam Map<String, Object> param , HttpServletRequest request, HttpServletResponse response ) throws Exception { 
		...
		paramMap.put("P_URL"     , request.getParameter("URL")  ) ; 
		paramMap.put("CUR"			, CUR); 
		
		System.out.println(paramMap.get("P_CORP_CODE"));
		System.out.println(paramMap.get("P_USER_ID"));
		System.out.println(paramMap.get("P_STR_CODE"));
		System.out.println(paramMap.get("P_URL"));
 	   
		commService.getAuthButtonList(paramMap);
