...
public class EgovStringUtil {
    ...
    /**
     * 객체가 null인지 확인하고 null인 경우 원하는 문자로 바꾸는 메서드
     * @param object 원본 객체
     * @return resultVal 문자열
     */
    public static String isNullToString(Object object, String converted) {
        String string = "";
    ...
    /**
     * 객체가 null인지 확인하고 null인 경우 원하는 정수로 바꾸는 메서드
     * @param object 원본 객체
     * @return resultVal 문자열
     */
    public static int isNullToString(Object object, int converted) {
        
        int integer;
        
        if (object != null) {
        	integer = Integer.parseInt(object.toString().trim());
        }
        else {
        	integer = converted;
        }
