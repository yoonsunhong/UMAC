...
public class MemberDeliveryController {
	...
	@RequestMapping(value="/memberDeliveryDtlList.do", method=RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> memberDeliveryDtlList(@RequestParam Map<String, Object> param, HttpServletResponse response, HttpServletRequest request) throws Exception{
		Map<String, Object> result = new HashMap<String, Object>();
		...
		try{
			...
			param = memberDeliveryService.memberDeliveryDtlList(param);
			//log.debug("result : " + param.toString());
