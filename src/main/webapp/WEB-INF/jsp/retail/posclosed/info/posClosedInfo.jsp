...
<script type="text/javascript" src="/resources/js/page/posclosed/info/posClosedInfo.js?ver=20180409_000" charset="utf-8"></script>
</head>
		...
		<form name="frm" id="frm">
			...
			<div class="search_area" id="top_search">
				<div class="last">
					...
					<select id="S_STR_CODE" name="S_STR_CODE" disabled >
