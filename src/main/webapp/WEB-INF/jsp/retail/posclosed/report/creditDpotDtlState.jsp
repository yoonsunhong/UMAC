...
<script type="text/javascript" src="/resources/js/page/posclosed/report/creditDpotDtlState.js?ver=20180409_000" charset="utf-8"></script>
<!-- 공통 팝업 -->
			...
			<!-- 조회폼 영역 -->
				<div class="search_area" id="top_search">
					<div class="last">		
						...
						<input type="text"  id="P_BUSI_SD" name="P_BUSI_SD" class="datepicker" >
						~
						<input type="text"  id="P_BUSI_ED" name="P_BUSI_ED" class="datepicker" >
						...
						<label for="" class="">입금구분</label>
						<select id="P_DPOT_FLAG" name="P_DPOT_FLAG" class="wid2">
							<option value=""><spring:message code="all"/></option>
						</select>
					</div>	
			</div>
