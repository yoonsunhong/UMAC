...
<title><spring:message code="payMnSelngStatus"/></title>	   
...
<script type="text/javascript" src="/resources/js/page/salesinfo/report/salesInfoReportPayment.js?ver=20180309_001" charset="utf-8"></script>
</head>
		...
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				<div class="last">
					...
					<input type="text" id="P_STR_DT" name="P_STR_DT" class="datepicker1" value="<c:out value="${today2}"/>" readonly="readonly"> ~ 
			...
			<div class="col2 sub_cnt">
				<div class="clear">
					<h3 class="bul_arr f_l"><spring:message code="storePaymentMn"/></h3>
				</div>	 		
				<div class="sec_grid">
					<div class="content">
			...
			<div class="col2 sub_cnt">
				<div class="tit_top clear">		 
					<h3 class="bul_arr f_l"><spring:message code="datePaymentMn"/></h3>
				</div>	
				<div class="sec_grid">
					<div class="content">
