...
<script type="text/javascript" src="/resources/js/page/salesinfo/report/salesInfoReportTerm.js?ver=20180314_001" charset="utf-8"></script>
		...
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				<div class="last">					
					...
					<input type="text" id="P_STR_DT_TYPE1" name="P_STR_DT_TYPE1" class="datepicker1" value="<c:out value="${today2}"/>" readonly="readonly"> ~ 
					<input type="text" id="P_END_DT_TYPE1" name="P_END_DT_TYPE1" class="datepicker2" value="<c:out value="${today}"/>" readonly="readonly"> 
					
					<label for=""><spring:message code="provisDate"/></label>
					<input type="text" id="P_STR_DT_TYPE2" name="P_STR_DT_TYPE2" class="datepicker3" value="<c:out value="${today2}"/>" readonly="readonly"> ~ 
					<input type="text" id="P_END_DT_TYPE2" name="P_END_DT_TYPE2" class="datepicker4" value="<c:out value="${today}"/>" readonly="readonly">					
				</div>
			</div>
			<!-- //조회폼 영역 -->
			...
			<div class="col2 sub_cnt">
				<div class="clear">
					<h3 class="bul_arr f_l"><spring:message code="selngAcmslt"/></h3>
				</div>	 		
				<div class="sec_grid">
					<div class="content">
			...
			<div class="col2 sub_cnt">
				<div class="tit_top clear">		 
					<h3 class="bul_arr f_l"><spring:message code="goodsClAcmSlt"/></h3>
