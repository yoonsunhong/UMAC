...
<script type="text/javascript" src="/resources/js/page/purch/mng/purchStoreChitStatus.js?ver=20180405_000" charset="utf-8"></script>
</head>
 	...
 	<form name="frm" id="frm"> 		
		<div id="iframeCnt">
			<div class="btn_area clear">
				...
				<div class="f_r"> *  입고일자 기준(PUR_CFM_DT) , 2차 미확정 전표 포함.
