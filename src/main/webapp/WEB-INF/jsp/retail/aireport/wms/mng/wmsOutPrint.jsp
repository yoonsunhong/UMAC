...
class ReportHandler{
	...
	private void getScriptFromfv1(boolean bIsPrint) throws Exception{
		...
		while(pickinglistDTL.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			if(!sheet20_A2.equals(pickinglistDTL_SCAN_CODE)){
				if(!bIsFirst){
			...
			if(!sheet20_B2.equals(pickinglistDTL_ITM_NAME)){
				if(!bIsFirst){
			...
			if(!sheet20_C2.equals(pickinglistDTL_UNIT)){
				if(!bIsFirst){
			...
			if(sheet20_D2!=pickinglistDTL_W_PUR_QTY){
				if(!bIsFirst){
					sheet20_D2_Buf = String.valueOf(sheet20_D2);
					sheet20_D2_Flag=true;
				}
				sheet20_D2=pickinglistDTL_W_PUR_QTY;
			}
			if(!sheet20_E2.equals(pickinglistDTL_W_LINE_CODE)){
				if(!bIsFirst){
					sheet20_E2_Buf = sheet20_E2;
					sheet20_E2_Flag=true;
				}
				sheet20_E2=pickinglistDTL_W_LINE_CODE;
			}
			sheet20_F2 = pickinglistDTL_IPSU_QTY;
			sheet20_G2 = pickinglistDTL_DOUT_QTY;
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_A1", 0, 0, 77, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_B1", 77, 0, 234, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_C1", 311, 0, 37, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_D1", 348, 0, 50, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_E1", 398, 0, 55, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_F1", 453, 0, 30, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_G1", 483, 0, 50, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_A2", 0, -1, 77, -1, "cell_style_5");
		setCellInfoMap_Internal("sheet20_B2", 77, -1, 234, -1, "cell_style_6");
		setCellInfoMap_Internal("sheet20_C2", 311, -1, 37, -1, "cell_style_5");
		setCellInfoMap_Internal("sheet20_D2", 348, -1, 50, -1, "cell_style_7");
		setCellInfoMap_Internal("sheet20_E2", 398, -1, 55, -1, "cell_style_8");
		setCellInfoMap_Internal("sheet20_F2", 453, 0, 30, 18, "cell_style_9");
		setCellInfoMap_Internal("sheet20_G2", 483, 0, 50, 18, "cell_style_9");
		setCellInfoMap_Internal("sheet20_A3", 0, 0, 483, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet20_G3", 483, 0, 50, 20, "cell_style_11");
	}
}
%>
