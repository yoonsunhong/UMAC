...
public void jspInit() {
	...
	sql_SALE_LIST.append("      , SUBSTR(PUR_DT,0,4)||'-'|| ");
	sql_SALE_LIST.append("        SUBSTR(PUR_DT,5,2)||'-'|| ");
	sql_SALE_LIST.append("        SUBSTR(PUR_DT,7,2) AS PUR_DT ");
	sql_SALE_LIST.append("      , SUBSTR(PUR_CFM_DT,0,4)||'-'|| ");
	sql_SALE_LIST.append("        SUBSTR(PUR_CFM_DT,5,2)||'-'|| ");
	sql_SALE_LIST.append("        SUBSTR(PUR_CFM_DT,7,2)    AS PUR_CFM_DT ");
	...
	sql_SALE_LIST.append("        GROUP BY PUH.CORP_CODE, PUH.VEN_CODE, CPS.SCAN_CODE, PUD.ITM_CODE, PUH.PUR_DT,PUH.PUR_CFM_DT,CPC.ITM_NAME,CS.VEN_NAME,PUH.PUR_GB ");
	sql_SALE_LIST.append("     ) ");
	sql_SALE_LIST.append("ORDER BY CORP_CODE, VEN_CODE, SCAN_CODE,PUR_DT ");
...
class ReportHandler{
	...
	private void getScriptFromfv1(boolean bIsPrint) throws Exception{
		...
		while(SALE_LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(!SALE_LIST_SCAN_CODE.equals(sheet30_C2)){    //fv_sub 밴드 조건문
				bIsTrue_fv_sub=true;
			}else{
			...
			//데이터 변수 할당
			if(!sheet30_A2.equals(SALE_LIST_VEN_CODE)){
				if(!bIsFirst){
					sheet30_A2_Buf = sheet30_A2;
					sheet30_A2_Flag=true;
				}
				sheet30_A2=SALE_LIST_VEN_CODE;
			}
			if(!sheet30_B2.equals(SALE_LIST_VEN_NAME)){
				if(!bIsFirst){
					sheet30_B2_Buf = sheet30_B2;
					sheet30_B2_Flag=true;
				}
				sheet30_B2=SALE_LIST_VEN_NAME;
			}
			if(!sheet30_C2.equals(SALE_LIST_SCAN_CODE) || sheet30_B2_Flag){
				if(!bIsFirst){
					sheet30_C2_Buf = sheet30_C2;
					sheet30_C2_Flag=true;
				}
				sheet30_C2=SALE_LIST_SCAN_CODE;
			}
			if(!sheet30_D2.equals(SALE_LIST_ITM_NAME)){
				if(!bIsFirst){
					sheet30_D2_Buf = sheet30_D2;
					sheet30_D2_Flag=true;
				}
				sheet30_D2=SALE_LIST_ITM_NAME;
			}
			sheet30_E2 = SALE_LIST_PUR_DT;
			sheet30_F2 = SALE_LIST_PUR_CFM_DT;
			sheet30_G2 = SALE_LIST_UNIT;
			sheet30_H2 = SALE_LIST_PUR_GB_NM;
			sheet30_I2 = SALE_LIST_ORD_FLAG_NM;
			sheet30_J2 = SALE_LIST_TAX_GB_NM;
			sheet30_K2 = SALE_LIST_DEC_QTY;
			sheet30_L2 = SALE_LIST_PUR_SPRC;
			sheet30_M2 = SALE_LIST_PUR_TSAMT;
	...
	private void setFieldVariableFromSALE_LIST() throws Exception{
		...
		SALE_LIST_VEN_CODE = GetB(SALE_LIST.getString(2));
		SALE_LIST_VEN_NAME = GetB(SALE_LIST.getString(3));
		SALE_LIST_SCAN_CODE = GetB(SALE_LIST.getString(4));
		SALE_LIST_ITM_CODE = GetB(SALE_LIST.getString(5));
		SALE_LIST_ITM_NAME = GetB(SALE_LIST.getString(6));
		SALE_LIST_PUR_DT = GetB(SALE_LIST.getString(7));
		SALE_LIST_PUR_CFM_DT = GetB(SALE_LIST.getString(8));
		SALE_LIST_UNIT = GetB(SALE_LIST.getString(9));
		SALE_LIST_PUR_GB = GetB(SALE_LIST.getString(10));
		SALE_LIST_PUR_GB_NM = GetB(SALE_LIST.getString(11));
		SALE_LIST_ORD_FLAG = GetB(SALE_LIST.getString(12));
		SALE_LIST_ORD_FLAG_NM = GetB(SALE_LIST.getString(13));
		SALE_LIST_TAX_GB = GetB(SALE_LIST.getString(14));
		SALE_LIST_TAX_GB_NM = GetB(SALE_LIST.getString(15));
		SALE_LIST_PUR_WAMT = SALE_LIST.getLong(16);
		SALE_LIST_PUR_SPRC = SALE_LIST.getLong(17);
		SALE_LIST_DEC_QTY = SALE_LIST.getLong(18);
		SALE_LIST_PUR_TWAMT = SALE_LIST.getLong(19);
		SALE_LIST_PUR_TSAMT = SALE_LIST.getLong(20);
		SALE_LIST_EXPECTED_PROFIT = SALE_LIST.getLong(21);
		SALE_LIST_PROFIT_RATE = GetB(SALE_LIST.getString(22));
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|47|salePriceStateByItemPrint.style|회원매출상세내역현황", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet30_A1", 0, 0, 42, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_B1", 42, 0, 89, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_C1", 131, 0, 69, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_D1", 200, 0, 228, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet30_E1", 428, 0, 53, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet30_F1", 481, 0, 53, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_G1", 534, 0, 37, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_H1", 571, 0, 30, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_I1", 601, 0, 30, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_J1", 631, 0, 30, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_K1", 661, 0, 33, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_L1", 694, 0, 47, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_M1", 741, 0, 47, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_A2", 0, -1, 42, -1, "cell_style_7");
		setCellInfoMap_Internal("sheet30_B2", 42, -1, 89, -1, "cell_style_8");
		setCellInfoMap_Internal("sheet30_C2", 131, -1, 69, -1, "cell_style_7");
		setCellInfoMap_Internal("sheet30_D2", 200, -1, 228, -1, "cell_style_9");
		setCellInfoMap_Internal("sheet30_E2", 428, 0, 53, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet30_F2", 481, 0, 53, 15, "cell_style_10");
		setCellInfoMap_Internal("sheet30_G2", 534, 0, 37, 15, "cell_style_11");
		setCellInfoMap_Internal("sheet30_H2", 571, 0, 30, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet30_I2", 601, 0, 30, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet30_J2", 631, 0, 30, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet30_K2", 661, 0, 33, 15, "cell_style_12");
		setCellInfoMap_Internal("sheet30_L2", 694, 0, 47, 15, "cell_style_12");
		setCellInfoMap_Internal("sheet30_M2", 741, 0, 47, 15, "cell_style_12");
		setCellInfoMap_Internal("sheet30_A3", 0, 0, 42, 15, "cell_style_13");
		setCellInfoMap_Internal("sheet30_B3", 42, 0, 89, 15, "cell_style_14");
		setCellInfoMap_Internal("sheet30_C3", 131, 0, 610, 15, "cell_style_15");
		setCellInfoMap_Internal("sheet30_M3", 741, 0, 47, 15, "cell_style_16");
		setCellInfoMap_Internal("sheet30_A4", 0, 0, 741, 20, "cell_style_17");
		setCellInfoMap_Internal("sheet30_M4", 741, 0, 47, 20, "cell_style_18");
	}
}
%>
