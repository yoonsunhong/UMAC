...
public void jspInit() {
	...
	sql_payment_reqeust.append("                 SELECT    ROW_NUMBER() OVER (ORDER BY  PPL.VEN_CODE, PPL.STR_CODE, PPL.PAY_SEQ) as rn ");
	sql_payment_reqeust.append("	   ,PPL.VEN_CODE ");
	sql_payment_reqeust.append("                 ,          CS.VEN_NAME ");
	sql_payment_reqeust.append("                 ,          PPL.STR_CODE ");
	sql_payment_reqeust.append("                 ,          STR.STR_NAME ");
	sql_payment_reqeust.append("                 ,          PPL.STR_DT ");
	sql_payment_reqeust.append("                 ,          PPL.END_DT ");
	sql_payment_reqeust.append("                 ,          PPL.STR_DT || '~' || PPL.END_DT AS DT ");
	sql_payment_reqeust.append("                 ,          PPL.PAY_CON ");
	sql_payment_reqeust.append("                 ,          PPL.PAY_SEQ ");
	sql_payment_reqeust.append("                 ,          PPL.BEF_HOLD_AMT ");
	sql_payment_reqeust.append("	   ,          CASE WHEN PPL.GRE_GB = '1' THEN PPL.PUR_AMT ELSE PPL.SALE_AMT END AS PUR_AMT ");
	sql_payment_reqeust.append("                 ,          (PPL.BEF_HOLD_AMT + PPL.PUR_AMT) AS TOT_PUR_AMT ");
	sql_payment_reqeust.append("                 ,          PPL.JANG_AMT ");
	sql_payment_reqeust.append("                 ,          PPL.DUCT_AMT ");
	sql_payment_reqeust.append("                 ,          PPL.PAY_TGT_AMT ");
	sql_payment_reqeust.append("                 ,          (PPL.JANG_AMT + PPL.DUCT_AMT) AS TOT_DUCT_AMT ");
	sql_payment_reqeust.append("                 ,          PPL.HOLD_AMT ");
	sql_payment_reqeust.append("                 ,          PPL.RELE_AMT ");
	sql_payment_reqeust.append("                 ,          PPL.PAY_NET_AMT ");
	sql_payment_reqeust.append("                 ,          PPL.PAY_ABLE ");
...
class ReportHandler{
	...
	String sheet20_N3 = "";
	long sheet20_A4 = 0L;
	String sheet20_B4_Buf;
	int sheet20_B4_YPos;
	boolean sheet20_B4_Flag;
	String sheet20_B4 = "";
	String sheet20_C4_Buf;
	int sheet20_C4_YPos;
	boolean sheet20_C4_Flag;
	String sheet20_C4 = "";
	String sheet20_D4 = "";
	String sheet20_E4 = "";
	String sheet20_F4 = "";
	...
	private String payment_reqeust_STR_CODE;
	private String payment_reqeust_STR_NAME;
	private String payment_reqeust_STR_DT;
	private String payment_reqeust_END_DT;
	private String payment_reqeust_DT;
	private String payment_reqeust_PAY_CON;
	private String payment_reqeust_PAY_SEQ;
	private long payment_reqeust_BEF_HOLD_AMT;
	private long payment_reqeust_PUR_AMT;
	private long payment_reqeust_TOT_PUR_AMT;
	private long payment_reqeust_JANG_AMT;
	private long payment_reqeust_DUCT_AMT;
	private long payment_reqeust_PAY_TGT_AMT;
	private long payment_reqeust_TOT_DUCT_AMT;
	private long payment_reqeust_HOLD_AMT;
	private long payment_reqeust_RELE_AMT;
	private long payment_reqeust_PAY_NET_AMT;
	private long payment_reqeust_PAY_ABLE;
	...
	private void executeSheet20( ) throws Exception{
		...
		getScriptFromVoidBand205(true, true);    //Void 밴드 호출
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromVoidBand205(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=21;    //밴드 출력 높이
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	private void getScriptFromfv_s1(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			//데이터 변수 할당
			sheet20_A5="소계";
			sheet20_G5=(long)SUM(sheet20_G4, sheet20_G5);
			sheet20_H5=(long)SUM(sheet20_H4, sheet20_H5);
			sheet20_I5=(long)SUM(sheet20_I4, sheet20_I5);
			sheet20_J5=(long)SUM(sheet20_J4, sheet20_J5);
			sheet20_K5=(long)SUM(sheet20_K4, sheet20_K5);
			sheet20_L5=(long)SUM(sheet20_L4, sheet20_L5);
			sheet20_M5=(long)SUM(sheet20_M4, sheet20_M5);
			sheet20_N5=(long)SUM(sheet20_N4, sheet20_N5);
			sheet20_O5=(long)SUM(sheet20_O4, sheet20_O5);
			sheet20_P5=(long)SUM(sheet20_P4, sheet20_P5);
		}   //end if(!bIsLast)
	}
	...
	private void getScriptFromfv1_sum(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			//데이터 변수 할당
			sheet20_A6="합계";
			sheet20_G6=(long)SUM(sheet20_G4, sheet20_G6);
			sheet20_H6=(long)SUM(sheet20_H4, sheet20_H6);
			sheet20_I6=(long)SUM(sheet20_I4, sheet20_I6);
			sheet20_J6=(long)SUM(sheet20_J4, sheet20_J6);
			sheet20_K6=(long)SUM(sheet20_K4, sheet20_K6);
			sheet20_L6=(long)SUM(sheet20_L4, sheet20_L6);
			sheet20_M6=(long)SUM(sheet20_M4, sheet20_M6);
			sheet20_N6=(long)SUM(sheet20_N4, sheet20_N6);
			sheet20_O6=(long)SUM(sheet20_O4, sheet20_O6);
			sheet20_P6=(long)SUM(sheet20_P4, sheet20_P6);
		}   //end if(!bIsLast)
	}
	...
	private void getScriptFromfv1(boolean bIsPrint) throws Exception{
		...
		boolean bIsTrue_fv_s1=false;   //fv_s1 조건 밴드 플래그 선언
		boolean bIsTrue_fv1_sum=false;   //fv1_sum 조건 밴드 플래그 선언

		//데이터 변수 초기화
		sheet20_A4=0L;
		sheet20_B4_Buf=null;
		sheet20_B4_Flag=true;
		sheet20_B4="";
		sheet20_C4_Buf=null;
		sheet20_C4_Flag=true;
		sheet20_C4="";
		sheet20_D4="";
		sheet20_E4="";
		sheet20_F4="";
		...
		while(payment_reqeust.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(!payment_reqeust_VEN_CODE.equals(sheet20_B4)){    //fv_s1 밴드 조건문
				bIsTrue_fv_s1=true;
			}else{
				bIsTrue_fv_s1=false;
			}
			...
			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
				//조건 플래그 초기화
				bIsTrue_fv_s1=false;    //fv_s1 조건 밴드 플래그 초기화
				bIsTrue_fv1_sum=false;    //fv1_sum 조건 밴드 플래그 초기화
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet20_A4 = payment_reqeust_RN;
			if(!sheet20_B4.equals(payment_reqeust_VEN_CODE)){
				if(!bIsFirst){
					sheet20_B4_Buf = sheet20_B4;
					sheet20_B4_Flag=true;
				}
				sheet20_B4=payment_reqeust_VEN_CODE;
			}
			if(!sheet20_C4.equals(payment_reqeust_VEN_NAME)){
				if(!bIsFirst){
					sheet20_C4_Buf = sheet20_C4;
					sheet20_C4_Flag=true;
				}
				sheet20_C4=payment_reqeust_VEN_NAME;
			}
			sheet20_D4 = payment_reqeust_DT;
			sheet20_E4 = payment_reqeust_STR_NAME;
			sheet20_F4 = payment_reqeust_PAY_SEQ;
			sheet20_G4 = payment_reqeust_BEF_HOLD_AMT;
			sheet20_H4 = payment_reqeust_PUR_AMT;
			sheet20_I4 = payment_reqeust_TOT_PUR_AMT;
			sheet20_J4 = payment_reqeust_JANG_AMT;
			sheet20_K4 = payment_reqeust_DUCT_AMT;
			sheet20_L4 = payment_reqeust_PAY_TGT_AMT;
			sheet20_M4 = payment_reqeust_HOLD_AMT;
			sheet20_N4 = payment_reqeust_RELE_AMT;
			sheet20_O4 = payment_reqeust_PAY_NET_AMT;
			sheet20_P4 = payment_reqeust_PAY_ABLE;
			...
			getScriptFromfv_s1(bIsFirst, false, bIsTrue_fv_s1, true);   //fv_s1 조건 밴드 호출
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				if(sheet20_B4_Flag){
					sheet20_B4_YPos=nYCurPos;
					sheet20_B4_Buf=null;
					sheet20_B4_Flag=false;
				}
				if(sheet20_C4_Flag){
					sheet20_C4_YPos=nYCurPos;
					sheet20_C4_Buf=null;
					sheet20_C4_Flag=false;
				}
		...
		if(bIsFirst){   //while 루프가 실행되지 않은 경우
			...
			getScriptFromfv_s1(bIsFirst, true, true, true);   //fv_s1 조건 밴드 호출
	...
	private void pageSkipVirtualMergefv1(  ) throws Exception{
		...
		if(bEnabledVirtualMerge_fv1){
			if(sheet20_B4_Buf==null){
				sheet20_B4_Buf = sheet20_B4;
			}else{
				sheet20_B4_Buf=null;
			}
			sheet20_B4_Flag=true;
			if(sheet20_C4_Buf==null){
				sheet20_C4_Buf = sheet20_C4;
			}else{
				sheet20_C4_Buf=null;
			}
	...
	private void writeScriptv2( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_P2"), nYCurPos+mapTop.get("sheet20_P2"), mapWidth.get("sheet20_P2"), mapHeight.get("sheet20_P2"), sheet20_P2, "sheet20_P2", mapStyle.get("sheet20_P2"));
	}

	//----VoidBand205 스크립트 문 출력 함수----
	private void writeScriptVoidBand205( ) throws Exception{
		//스크립트문 생성
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_L3"), nYCurPos+mapTop.get("sheet20_L3"), mapWidth.get("sheet20_L3"), mapHeight.get("sheet20_L3"), sheet20_L3, "sheet20_L3", mapStyle.get("sheet20_L3"));
	...
	//----fv_s1 스크립트 문 출력 함수----
	private void writeScriptfv_s1( ) throws Exception{
		//스크립트문 생성
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_I5"), nYCurPos+mapTop.get("sheet20_I5"), mapWidth.get("sheet20_I5"), mapHeight.get("sheet20_I5"), String.valueOf(sheet20_I5), "sheet20_I5", mapStyle.get("sheet20_I5"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_L5"), nYCurPos+mapTop.get("sheet20_L5"), mapWidth.get("sheet20_L5"), mapHeight.get("sheet20_L5"), String.valueOf(sheet20_L5), "sheet20_L5", mapStyle.get("sheet20_L5"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_M5"), nYCurPos+mapTop.get("sheet20_M5"), mapWidth.get("sheet20_M5"), mapHeight.get("sheet20_M5"), String.valueOf(sheet20_M5), "sheet20_M5", mapStyle.get("sheet20_M5"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_N5"), nYCurPos+mapTop.get("sheet20_N5"), mapWidth.get("sheet20_N5"), mapHeight.get("sheet20_N5"), String.valueOf(sheet20_N5), "sheet20_N5", mapStyle.get("sheet20_N5"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_O5"), nYCurPos+mapTop.get("sheet20_O5"), mapWidth.get("sheet20_O5"), mapHeight.get("sheet20_O5"), String.valueOf(sheet20_O5), "sheet20_O5", mapStyle.get("sheet20_O5"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_P5"), nYCurPos+mapTop.get("sheet20_P5"), mapWidth.get("sheet20_P5"), mapHeight.get("sheet20_P5"), String.valueOf(sheet20_P5), "sheet20_P5", mapStyle.get("sheet20_P5"));
	}
	...
	private void writeScriptfv1_sum( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_H6"), nYCurPos+mapTop.get("sheet20_H6"), mapWidth.get("sheet20_H6"), mapHeight.get("sheet20_H6"), String.valueOf(sheet20_H6), "sheet20_H6", mapStyle.get("sheet20_H6"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_I6"), nYCurPos+mapTop.get("sheet20_I6"), mapWidth.get("sheet20_I6"), mapHeight.get("sheet20_I6"), String.valueOf(sheet20_I6), "sheet20_I6", mapStyle.get("sheet20_I6"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_J6"), nYCurPos+mapTop.get("sheet20_J6"), mapWidth.get("sheet20_J6"), mapHeight.get("sheet20_J6"), String.valueOf(sheet20_J6), "sheet20_J6", mapStyle.get("sheet20_J6"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_K6"), nYCurPos+mapTop.get("sheet20_K6"), mapWidth.get("sheet20_K6"), mapHeight.get("sheet20_K6"), String.valueOf(sheet20_K6), "sheet20_K6", mapStyle.get("sheet20_K6"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_L6"), nYCurPos+mapTop.get("sheet20_L6"), mapWidth.get("sheet20_L6"), mapHeight.get("sheet20_L6"), String.valueOf(sheet20_L6), "sheet20_L6", mapStyle.get("sheet20_L6"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_M6"), nYCurPos+mapTop.get("sheet20_M6"), mapWidth.get("sheet20_M6"), mapHeight.get("sheet20_M6"), String.valueOf(sheet20_M6), "sheet20_M6", mapStyle.get("sheet20_M6"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_N6"), nYCurPos+mapTop.get("sheet20_N6"), mapWidth.get("sheet20_N6"), mapHeight.get("sheet20_N6"), String.valueOf(sheet20_N6), "sheet20_N6", mapStyle.get("sheet20_N6"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_O6"), nYCurPos+mapTop.get("sheet20_O6"), mapWidth.get("sheet20_O6"), mapHeight.get("sheet20_O6"), String.valueOf(sheet20_O6), "sheet20_O6", mapStyle.get("sheet20_O6"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_P6"), nYCurPos+mapTop.get("sheet20_P6"), mapWidth.get("sheet20_P6"), mapHeight.get("sheet20_P6"), String.valueOf(sheet20_P6), "sheet20_P6", mapStyle.get("sheet20_P6"));
	}
	...
	private void writeScriptfv1(  ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_D4"), nYCurPos+mapTop.get("sheet20_D4"), mapWidth.get("sheet20_D4"), mapHeight.get("sheet20_D4"), sheet20_D4, "sheet20_D4", mapStyle.get("sheet20_D4"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_E4"), nYCurPos+mapTop.get("sheet20_E4"), mapWidth.get("sheet20_E4"), mapHeight.get("sheet20_E4"), sheet20_E4, "sheet20_E4", mapStyle.get("sheet20_E4"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_F4"), nYCurPos+mapTop.get("sheet20_F4"), mapWidth.get("sheet20_F4"), mapHeight.get("sheet20_F4"), sheet20_F4, "sheet20_F4", mapStyle.get("sheet20_F4"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_M4"), nYCurPos+mapTop.get("sheet20_M4"), mapWidth.get("sheet20_M4"), mapHeight.get("sheet20_M4"), String.valueOf(sheet20_M4), "sheet20_M4", mapStyle.get("sheet20_M4"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_N4"), nYCurPos+mapTop.get("sheet20_N4"), mapWidth.get("sheet20_N4"), mapHeight.get("sheet20_N4"), String.valueOf(sheet20_N4), "sheet20_N4", mapStyle.get("sheet20_N4"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_O4"), nYCurPos+mapTop.get("sheet20_O4"), mapWidth.get("sheet20_O4"), mapHeight.get("sheet20_O4"), String.valueOf(sheet20_O4), "sheet20_O4", mapStyle.get("sheet20_O4"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_P4"), nYCurPos+mapTop.get("sheet20_P4"), mapWidth.get("sheet20_P4"), mapHeight.get("sheet20_P4"), String.valueOf(sheet20_P4), "sheet20_P4", mapStyle.get("sheet20_P4"));
	}
	...
	private void writeScriptVirtualMergefv1(  ) throws Exception{
		//가상병합 스크립트문 생성
		if(sheet20_B4_Buf != null){
			objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_B4"), sheet20_B4_YPos, mapWidth.get("sheet20_B4"), nYCurPos-sheet20_B4_YPos, sheet20_B4_Buf, "sheet20_B4", mapStyle.get("sheet20_B4"));
		}
		if(sheet20_C4_Buf != null){
			objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_C4"), sheet20_C4_YPos, mapWidth.get("sheet20_C4"), nYCurPos-sheet20_C4_YPos, sheet20_C4_Buf, "sheet20_C4", mapStyle.get("sheet20_C4"));
		}
	}
	...
	private void setFieldVariableFrompayment_reqeust() throws Exception{
		...
		payment_reqeust_STR_CODE = GetB(payment_reqeust.getString(4));
		payment_reqeust_STR_NAME = GetB(payment_reqeust.getString(5));
		payment_reqeust_STR_DT = GetB(payment_reqeust.getString(6));
		payment_reqeust_END_DT = GetB(payment_reqeust.getString(7));
		payment_reqeust_DT = GetB(payment_reqeust.getString(8));
		payment_reqeust_PAY_CON = GetB(payment_reqeust.getString(9));
		payment_reqeust_PAY_SEQ = GetB(payment_reqeust.getString(10));
		payment_reqeust_BEF_HOLD_AMT = payment_reqeust.getLong(11);
		payment_reqeust_PUR_AMT = payment_reqeust.getLong(12);
		payment_reqeust_TOT_PUR_AMT = payment_reqeust.getLong(13);
		payment_reqeust_JANG_AMT = payment_reqeust.getLong(14);
		payment_reqeust_DUCT_AMT = payment_reqeust.getLong(15);
		payment_reqeust_PAY_TGT_AMT = payment_reqeust.getLong(16);
		payment_reqeust_TOT_DUCT_AMT = payment_reqeust.getLong(17);
		payment_reqeust_HOLD_AMT = payment_reqeust.getLong(18);
		payment_reqeust_RELE_AMT = payment_reqeust.getLong(19);
		payment_reqeust_PAY_NET_AMT = payment_reqeust.getLong(20);
		payment_reqeust_PAY_ABLE = payment_reqeust.getLong(21);
		payment_reqeust_REP_NAME = GetB(payment_reqeust.getString(22));
		payment_reqeust_BANK_ACOWN = GetB(payment_reqeust.getString(23));
		payment_reqeust_BANK_CODE = GetB(payment_reqeust.getString(24));
		payment_reqeust_BANK_ACC_NO = GetB(payment_reqeust.getString(25));
	}
	...
	private void setFieldInitFrompayment_reqeust(){
		...
		payment_reqeust_STR_CODE = "";
		payment_reqeust_STR_NAME = "";
		payment_reqeust_STR_DT = "";
		payment_reqeust_END_DT = "";
		payment_reqeust_DT = "";
		payment_reqeust_PAY_CON = "";
		payment_reqeust_PAY_SEQ = "";
		payment_reqeust_BEF_HOLD_AMT = 0L;
		payment_reqeust_PUR_AMT = 0L;
		payment_reqeust_TOT_PUR_AMT = 0L;
		payment_reqeust_JANG_AMT = 0L;
		payment_reqeust_DUCT_AMT = 0L;
		payment_reqeust_PAY_TGT_AMT = 0L;
		payment_reqeust_TOT_DUCT_AMT = 0L;
		payment_reqeust_HOLD_AMT = 0L;
		payment_reqeust_RELE_AMT = 0L;
		payment_reqeust_PAY_NET_AMT = 0L;
		payment_reqeust_PAY_ABLE = 0L;
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|23|paymentRequestInfoPrint.style|보고서 (2017/3/20 15:26:3)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_A2", 0, 0, 18, 42, "cell_style_8");
		setCellInfoMap_Internal("sheet20_B2", 18, 0, 36, 42, "cell_style_9");
		setCellInfoMap_Internal("sheet20_C2", 54, 0, 83, 42, "cell_style_9");
		setCellInfoMap_Internal("sheet20_D2", 137, 0, 75, 42, "cell_style_9");
		setCellInfoMap_Internal("sheet20_E2", 212, 0, 45, 42, "cell_style_9");
		setCellInfoMap_Internal("sheet20_F2", 257, 0, 21, 42, "cell_style_9");
		setCellInfoMap_Internal("sheet20_G2", 278, 0, 153, 21, "cell_style_9");
		setCellInfoMap_Internal("sheet20_J2", 431, 0, 255, 21, "cell_style_9");
		setCellInfoMap_Internal("sheet20_O2", 686, 0, 51, 42, "cell_style_9");
		setCellInfoMap_Internal("sheet20_P2", 737, 0, 51, 42, "cell_style_10");
		setCellInfoMap_Internal("sheet20_G3", 278, 0, 51, 21, "cell_style_11");
		setCellInfoMap_Internal("sheet20_H3", 329, 0, 51, 21, "cell_style_12");
		setCellInfoMap_Internal("sheet20_I3", 380, 0, 51, 21, "cell_style_12");
		setCellInfoMap_Internal("sheet20_J3", 431, 0, 51, 21, "cell_style_11");
		setCellInfoMap_Internal("sheet20_K3", 482, 0, 51, 21, "cell_style_11");
		setCellInfoMap_Internal("sheet20_L3", 533, 0, 51, 21, "cell_style_11");
		setCellInfoMap_Internal("sheet20_M3", 584, 0, 51, 21, "cell_style_11");
		setCellInfoMap_Internal("sheet20_N3", 635, 0, 51, 21, "cell_style_11");
		setCellInfoMap_Internal("sheet20_A4", 0, 0, 18, 17, "cell_style_13");
		setCellInfoMap_Internal("sheet20_B4", 18, -1, 36, -1, "cell_style_14");
		setCellInfoMap_Internal("sheet20_C4", 54, -1, 83, -1, "cell_style_15");
		setCellInfoMap_Internal("sheet20_D4", 137, 0, 75, 17, "cell_style_16");
		setCellInfoMap_Internal("sheet20_E4", 212, 0, 45, 17, "cell_style_16");
		setCellInfoMap_Internal("sheet20_F4", 257, 0, 21, 17, "cell_style_14");
		setCellInfoMap_Internal("sheet20_G4", 278, 0, 51, 17, "cell_style_17");
		setCellInfoMap_Internal("sheet20_H4", 329, 0, 51, 17, "cell_style_17");
		setCellInfoMap_Internal("sheet20_I4", 380, 0, 51, 17, "cell_style_17");
		setCellInfoMap_Internal("sheet20_J4", 431, 0, 51, 17, "cell_style_17");
		setCellInfoMap_Internal("sheet20_K4", 482, 0, 51, 17, "cell_style_17");
		setCellInfoMap_Internal("sheet20_L4", 533, 0, 51, 17, "cell_style_17");
		setCellInfoMap_Internal("sheet20_M4", 584, 0, 51, 17, "cell_style_17");
		setCellInfoMap_Internal("sheet20_N4", 635, 0, 51, 17, "cell_style_17");
		setCellInfoMap_Internal("sheet20_O4", 686, 0, 51, 17, "cell_style_17");
		setCellInfoMap_Internal("sheet20_P4", 737, 0, 51, 17, "cell_style_18");
		setCellInfoMap_Internal("sheet20_A5", 0, 0, 278, 17, "cell_style_19");
		setCellInfoMap_Internal("sheet20_G5", 278, 0, 51, 17, "cell_style_20");
		setCellInfoMap_Internal("sheet20_H5", 329, 0, 51, 17, "cell_style_20");
		setCellInfoMap_Internal("sheet20_I5", 380, 0, 51, 17, "cell_style_20");
		setCellInfoMap_Internal("sheet20_J5", 431, 0, 51, 17, "cell_style_20");
		setCellInfoMap_Internal("sheet20_K5", 482, 0, 51, 17, "cell_style_20");
		setCellInfoMap_Internal("sheet20_L5", 533, 0, 51, 17, "cell_style_20");
		setCellInfoMap_Internal("sheet20_M5", 584, 0, 51, 17, "cell_style_20");
		setCellInfoMap_Internal("sheet20_N5", 635, 0, 51, 17, "cell_style_20");
		setCellInfoMap_Internal("sheet20_O5", 686, 0, 51, 17, "cell_style_20");
		setCellInfoMap_Internal("sheet20_P5", 737, 0, 51, 17, "cell_style_21");
		setCellInfoMap_Internal("sheet20_A6", 0, 0, 278, 20, "cell_style_22");
		setCellInfoMap_Internal("sheet20_G6", 278, 0, 51, 20, "cell_style_23");
		setCellInfoMap_Internal("sheet20_H6", 329, 0, 51, 20, "cell_style_23");
		setCellInfoMap_Internal("sheet20_I6", 380, 0, 51, 20, "cell_style_23");
		setCellInfoMap_Internal("sheet20_J6", 431, 0, 51, 20, "cell_style_23");
		setCellInfoMap_Internal("sheet20_K6", 482, 0, 51, 20, "cell_style_23");
		setCellInfoMap_Internal("sheet20_L6", 533, 0, 51, 20, "cell_style_23");
		setCellInfoMap_Internal("sheet20_M6", 584, 0, 51, 20, "cell_style_23");
		setCellInfoMap_Internal("sheet20_N6", 635, 0, 51, 20, "cell_style_23");
		setCellInfoMap_Internal("sheet20_O6", 686, 0, 51, 20, "cell_style_23");
		setCellInfoMap_Internal("sheet20_P6", 737, 0, 51, 20, "cell_style_24");
	}
}
%>
