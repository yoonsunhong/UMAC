...
public void jspInit() {
	...
	sql_TITLE.append(",	'매입기간 : ' || SUBSTR('^P_SALE_DT^',0,4) ||'-'|| SUBSTR('^P_SALE_DT^',5,2) AS SALE_DT ");
	...
	sql_ven_day_state.append(", AA.PUR_DT ");
	...
	sql_ven_day_state.append(", PUR_DT ");
	...
	sql_ven_day_state.append(", CASE WHEN PPH.PUR_GB = '2' THEN TRUNC(PPD.PUR_WPRC + PUR_WVAT ) * (-1) ELSE ROUND(PPD.PUR_WPRC + PUR_WVAT ,2) END AS PUR_WAMT ");
	...
	sql_ven_day_state.append("- TRUNC(PPD.DEC_QTY * -1 * (PPD.PUR_WPRC + PPD.PUR_WVAT)/11) ");
	...
	sql_ven_day_state.append("ELSE DECODE(PPD.TAX_GB, '1', TRUNC(PPD.DEC_QTY * -1 * (PPD.PUR_WPRC + PPD.PUR_WVAT)/11) ");
	sql_ven_day_state.append(", ROUND(PPD.DEC_QTY * -1 * PPD.PUR_WVAT, 1) ) ");
	sql_ven_day_state.append("END AS PUR_WVAT2 ");
	sql_ven_day_state.append(", CASE WHEN PPH.PUR_GB = '1' THEN ");
	sql_ven_day_state.append("DECODE(PPD.TAX_GB, '1', ROUND(PPD.DEC_QTY * (PPD.PUR_WPRC + PPD.PUR_WVAT),2) ");
	sql_ven_day_state.append(", TRUNC(PPD.DEC_QTY * PPD.PUR_WPRC)) ");
	sql_ven_day_state.append("ELSE DECODE(PPD.TAX_GB, '1', TRUNC(PPD.DEC_QTY * -1 * (PPD.PUR_WPRC + PPD.PUR_WVAT)) ");
	sql_ven_day_state.append(", TRUNC(PPD.DEC_QTY * -1 * PPD.PUR_WPRC)) ");
	sql_ven_day_state.append("END AS PUR_WAMT2 ");
	sql_ven_day_state.append(", ROUND(PPD.PUR_SPRC) AS PUR_SPRC ");
	sql_ven_day_state.append(", CASE WHEN PPH.PUR_GB = '2' THEN TRUNC(PPD.PUR_SAMT) * (-1) ELSE ROUND(PPD.PUR_SAMT,2) END AS PUR_SAMT ");
	sql_ven_day_state.append(", PPH.ROUTE_GB ");
	sql_ven_day_state.append(", ROUND(PPD.BOT_SPRC) AS BOT_SPRC ");
	sql_ven_day_state.append(", CASE WHEN PPH.PUR_GB = '2' THEN TRUNC(PPD.BOT_SPRC * PPD.DEC_QTY) * (-1) ELSE ROUND(PPD.BOT_SPRC * PPD.DEC_QTY,2) END AS BOT_SUM ");
	...
	sql_ven_day_state.append("AND PPH.PUR_CFM_DT BETWEEN '^P_SALE_DT^'||'01' and  '^P_SALE_DT^'||'31' ");
	...
	sql_ven_day_state.append("AND PPH.PUR_GB = NVL( '^P_CANC_FLAG^', PPH.PUR_GB) ");
	...
	sql_ven_day_state.append(", STR_NAME ");
	sql_ven_day_state.append(", TAX_GB ");
	sql_ven_day_state.append(", PUR_DT ) AA ");
	sql_ven_day_state.append("GROUP BY AA.VEN_NAME ");
	sql_ven_day_state.append(", AA.VEN_CODE ");
	sql_ven_day_state.append(", AA.STR_NAME ");
	sql_ven_day_state.append(", AA.PUR_DT) AAA ");
	sql_ven_day_state.append("ORDER BY AAA.VEN_CODE, AAA.PUR_DT ");
...
class ReportHandler{
	...
	String sheet30_B3 = "";
	String sheet30_C3_Buf;
	int sheet30_C3_YPos;
	boolean sheet30_C3_Flag;
	String sheet30_C3 = "";
	String sheet30_D3 = "";
	long sheet30_E3 = 0L;
	long sheet30_F3 = 0L;
	...
	private String ven_day_state_PUR_DT;
	...
	private void getScriptFromV1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//데이터 변수 할당
			sheet10_A1="협력업체/일자별 매입 집계표[직매입]";
		}    //end if(bIsFirst)
	...
	private void getScriptFromsh3_fv1_sub3(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			//데이터 변수 할당
			sheet30_A4="협력업체별 소계";
			sheet30_E4=(long)SUM(sheet30_E3, sheet30_E4);
			...
			sheet30_K4=sheet30_I4+sheet30_J4;
			sheet30_L4=(long)SUM(sheet30_L3, sheet30_L4);
			sheet30_M4=(long)SUM(sheet30_M3, sheet30_M4);
		}   //end if(!bIsLast)
	}
	...
	private void getScriptFromsh3_fv1_sub2(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			//데이터 변수 할당
			sheet30_A5="합계";
			sheet30_E5=(long)SUM(sheet30_E3, sheet30_E5);
			sheet30_F5=(long)SUM(sheet30_F3, sheet30_F5);
			sheet30_G5=(long)SUM(sheet30_G3, sheet30_G5);
			sheet30_H5=(long)SUM(sheet30_H3, sheet30_H5);
			sheet30_I5=(long)SUM(sheet30_I3, sheet30_I5);
			sheet30_J5=(long)SUM(sheet30_J3, sheet30_J5);
			sheet30_K5=sheet30_I5+sheet30_J5;
			sheet30_L5=(long)SUM(sheet30_L3, sheet30_L5);
			sheet30_M5=(long)SUM(sheet30_M3, sheet30_M5);
		}   //end if(!bIsLast)
	}
	...
	private void getScriptFromsh3_fv1(boolean bIsPrint) throws Exception{
		...
		while(ven_day_state.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(!(ven_day_state_VEN_NAME.equals(sheet30_B3)
			)){    //sh3_fv1_sub3 밴드 조건문
			...
			//데이터 변수 할당
			if(!sheet30_A3.equals(ven_day_state_VEN_CODE)){
				if(!bIsFirst){
					sheet30_A3_Buf = sheet30_A3;
					sheet30_A3_Flag=true;
				}
				sheet30_A3=ven_day_state_VEN_CODE;
			}
			if(!sheet30_B3.equals(ven_day_state_VEN_NAME) || sheet30_A3_Flag){
				if(!bIsFirst){
					sheet30_B3_Buf = sheet30_B3;
					sheet30_B3_Flag=true;
				}
				sheet30_B3=ven_day_state_VEN_NAME;
			}
			if(!sheet30_C3.equals(ven_day_state_STR_NAME) || sheet30_A3_Flag){
				if(!bIsFirst){
					sheet30_C3_Buf = sheet30_C3;
					sheet30_C3_Flag=true;
				}
				sheet30_C3=ven_day_state_STR_NAME;
			}
			sheet30_D3 = ven_day_state_PUR_DT;
			sheet30_E3 = ven_day_state_PUR_WPRC2_TAX2;
			sheet30_F3 = ven_day_state_PUR_WPRC2_TAX1;
			sheet30_G3 = ven_day_state_PUR_WVAT2_TAX1;
			sheet30_H3=sheet30_F3+sheet30_G3;
			sheet30_I3 = ven_day_state_PUR_WPRC2_WVAT_TAX;
			sheet30_J3 = ven_day_state_BOT_SUM;
			sheet30_K3 = ven_day_state_PUR_WPRC2_WVAT_TAX_BOT;
			sheet30_L3 = ven_day_state_PUR_SAMT;
			sheet30_M3 = ven_day_state_BENEPIT_AMT;
			sheet30_N3 = ven_day_state_BENEPIT_RATE;
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				if(sheet30_C3_Flag){
					sheet30_C3_YPos=nYCurPos;
					sheet30_C3_Buf=null;
					sheet30_C3_Flag=false;
				}
	...
	private void writeScriptsh3_fv1_sub3( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet30_N4"), nYCurPos+mapTop.get("sheet30_N4"), mapWidth.get("sheet30_N4"), mapHeight.get("sheet30_N4"), "", "sheet30_N4", mapStyle.get("sheet30_N4"));
	}
	...
	private void writeScriptsh3_fv1_sub2( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet30_N5"), nYCurPos+mapTop.get("sheet30_N5"), mapWidth.get("sheet30_N5"), mapHeight.get("sheet30_N5"), "", "sheet30_N5", mapStyle.get("sheet30_N5"));
	}
	...
	private void writeScriptVirtualMergesh3_fv1(  ) throws Exception{
		...
		if(sheet30_C3_Buf != null){
			objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet30_C3"), sheet30_C3_YPos, mapWidth.get("sheet30_C3"), nYCurPos-sheet30_C3_YPos, sheet30_C3_Buf, "sheet30_C3", mapStyle.get("sheet30_C3"));
		}
	}
	...
	private void setFieldVariableFromven_day_state() throws Exception{
		...
		ven_day_state_PUR_DT = GetB(ven_day_state.getString(4));
		ven_day_state_PUR_WPRC2_TAX1 = ven_day_state.getLong(5);
		ven_day_state_PUR_WPRC2_TAX2 = ven_day_state.getLong(6);
		ven_day_state_PUR_WVAT2_TAX1 = ven_day_state.getLong(7);
		ven_day_state_PUR_SAMT = ven_day_state.getLong(8);
		ven_day_state_BOT_SUM = ven_day_state.getLong(9);
		ven_day_state_PUR_WPRC2_TAX = ven_day_state.getLong(10);
		ven_day_state_PUR_WPRC2_WVAT_TAX = ven_day_state.getLong(11);
		ven_day_state_PUR_WPRC2_WVAT_TAX_BOT = ven_day_state.getLong(12);
		ven_day_state_BENEPIT_AMT = ven_day_state.getLong(13);
		ven_day_state_BENEPIT_RATE = ven_day_state.getDouble(14);
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|55|supplyPurchStateDayV1Print.style|회원매출상세내역현황", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_A2", 0, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_C2", 115, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_E2", 222, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_G2", 328, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet30_A1", 0, 0, 31, 40, "cell_style_2");
		setCellInfoMap_Internal("sheet30_B1", 31, 0, 110, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_C1", 141, 0, 37, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_D1", 178, 0, 63, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_E1", 241, 0, 62, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_F1", 303, 0, 169, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_I1", 472, 0, 65, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_J1", 537, 0, 39, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_K1", 576, 0, 65, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_L1", 641, 0, 65, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_M1", 706, 0, 47, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_N1", 753, 0, 34, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_F2", 303, 20, 61, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet30_G2", 364, 20, 47, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet30_H2", 411, 20, 61, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet30_A3", 0, -1, 31, -1, "cell_style_5");
		setCellInfoMap_Internal("sheet30_B3", 31, -1, 110, -1, "cell_style_6");
		setCellInfoMap_Internal("sheet30_C3", 141, -1, 37, -1, "cell_style_7");
		setCellInfoMap_Internal("sheet30_D3", 178, 0, 63, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet30_E3", 241, 0, 62, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_F3", 303, 0, 61, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_G3", 364, 0, 47, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_H3", 411, 0, 61, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_I3", 472, 0, 65, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_J3", 537, 0, 39, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_K3", 576, 0, 65, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_L3", 641, 0, 65, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_M3", 706, 0, 47, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_N3", 753, 0, 34, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_A4", 0, 0, 241, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_E4", 241, 0, 62, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_F4", 303, 0, 61, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_G4", 364, 0, 47, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_H4", 411, 0, 61, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_I4", 472, 0, 65, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_J4", 537, 0, 39, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_K4", 576, 0, 65, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_L4", 641, 0, 65, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_M4", 706, 0, 47, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_N4", 753, 0, 34, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_A5", 0, 0, 241, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_E5", 241, 0, 62, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_F5", 303, 0, 61, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_G5", 364, 0, 47, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_H5", 411, 0, 61, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_I5", 472, 0, 65, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_J5", 537, 0, 39, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_K5", 576, 0, 65, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_L5", 641, 0, 65, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_M5", 706, 0, 47, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet30_N5", 753, 0, 34, 20, "cell_style_13");
	}
}
%>
