...
public void jspInit() {
	...
	sql_credit.append("        ,       SUBSTR(RCP_DT,0,4)||'-'|| ");
	sql_credit.append("	  SUBSTR(RCP_DT,5,2)||'-'|| ");
	sql_credit.append("	  SUBSTR(RCP_DT,7,2) AS RCP_DT_ ");
	...
	sql_credit.append("        AND     CLSD.RCP_DT         =   '^P_SALE_DT^' ");
...
class ReportHandler{
	...
	private void getScriptFromsh1_f1(boolean bIsPrint) throws Exception{
		...
		while(credit.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(!credit_CUST_NO.equals(sheet20_B3)){    //sh1_f1_sub 밴드 조건문
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|53|daySalesSettlementCreditPrint.style|회원매출상세내역현황", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_C2", 76, 0, 110, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_D2", 186, 0, 52, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_E2", 238, 0, 46, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_F2", 284, 0, 54, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_G2", 338, 0, 110, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_H2", 448, 0, 46, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_I2", 494, 0, 78, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_A3", 0, -1, 38, -1, "cell_style_6");
		setCellInfoMap_Internal("sheet20_B3", 38, -1, 38, -1, "cell_style_7");
		setCellInfoMap_Internal("sheet20_C3", 76, -1, 110, -1, "cell_style_8");
		setCellInfoMap_Internal("sheet20_D3", 186, 0, 52, 18, "cell_style_9");
		setCellInfoMap_Internal("sheet20_E3", 238, 0, 46, 18, "cell_style_9");
		setCellInfoMap_Internal("sheet20_F3", 284, 0, 54, 18, "cell_style_10");
		setCellInfoMap_Internal("sheet20_G3", 338, 0, 110, 18, "cell_style_8");
		setCellInfoMap_Internal("sheet20_H3", 448, 0, 46, 18, "cell_style_9");
		setCellInfoMap_Internal("sheet20_I3", 494, 0, 78, 18, "cell_style_9");
		setCellInfoMap_Internal("sheet20_A4", 0, 0, 284, 19, "cell_style_11");
		setCellInfoMap_Internal("sheet20_F4", 284, 0, 54, 19, "cell_style_12");
		setCellInfoMap_Internal("sheet20_G4", 338, 0, 234, 19, "cell_style_13");
		setCellInfoMap_Internal("sheet20_A5", 0, 0, 284, 18, "cell_style_14");
		setCellInfoMap_Internal("sheet20_F5", 284, 0, 54, 18, "cell_style_15");
		setCellInfoMap_Internal("sheet20_G5", 338, 0, 234, 18, "cell_style_16");
	}
}
%>
