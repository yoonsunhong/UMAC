...
class ReportHandler{
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|61|영업정보_매입관리_대출입전표_총합계_점포별2.style|보고서 (2017/3/20 17:59:30)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_C1", 114, 0, 85, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet20_D1", 199, 0, 243, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet20_G1", 442, 0, 102, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet20_D2", 199, 20, 85, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet20_E2", 284, 20, 73, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet20_F2", 357, 20, 85, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet20_A3", 0, 0, 57, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet20_B3", 57, 0, 57, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet20_C3", 114, 0, 85, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet20_D3", 199, 0, 85, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet20_E3", 284, 0, 73, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet20_F3", 357, 0, 85, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet20_G3", 442, 0, 102, 20, "cell_style_6");
	}
}
%>
