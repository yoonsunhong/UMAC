...
public void jspInit() {
	...
	sql_ven_day_state.append("                    AND	  PH.PUR_CFM_DT BETWEEN  '^P_SALE_DT^' AND '^P_SALE_DT_E^' ");
	...
	sql_ven_day_state.append("	      AND    PH.VEN_CODE  = NVL('^P_VEN_CODE^', PH.VEN_CODE) ");
...
class ReportHandler{
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|89|영업정보_매입관리_협력업체_전체_점별출력.style|회원매출상세내역현황", false);
	}
