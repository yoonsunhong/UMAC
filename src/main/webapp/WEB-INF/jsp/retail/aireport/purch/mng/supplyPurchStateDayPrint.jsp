...
public void jspInit() {
	...
	sql_ven_day_state.append(",       A.PAY_AMT_TAX1 + A.PAY_AMT_TAX2  + PAY_AMT_TAX1_VAT   AS PAY_AMT_TAX ");
	sql_ven_day_state.append(",	(A.SALE_AMT_1 + SALE_AMT_2 - A.SALE_AMT_VAT_1) - (PAY_AMT_TAX1 + PAY_AMT_TAX2) AS BENEPIT_AMT ");
	sql_ven_day_state.append(",       CASE WHEN A.SALE_AMT <> 0 ");
	sql_ven_day_state.append("             THEN ROUND((((A.SALE_AMT_1 + SALE_AMT_2 - A.SALE_AMT_VAT_1) - (PAY_AMT_TAX1 + PAY_AMT_TAX2)) / (A.SALE_AMT_1 + SALE_AMT_2 - A.SALE_AMT_VAT_1)) *100,2) ");
	...
	sql_ven_day_state.append("    AND	 SD.SALE_DT BETWEEN  '^P_SALE_DT^' AND '^P_SALE_DT_E^' ");
	...
	sql_ven_day_state.append("    ORDER   BY  SD.VEN_CODE,SD.STR_CODE,SD.SALE_DT ) A ");
...
class ReportHandler{
	...
	private String ven_day_state_SALE_DT;
	private String ven_day_state_VEN_CODE;
	private String ven_day_state_STR_CODE;
	private double ven_day_state_PAY_AMT_TAX1;
	private double ven_day_state_PAY_AMT_TAX1_VAT;
	private double ven_day_state_PAY_AMT_TAX2;
	private double ven_day_state_SALE_AMT;
	private double ven_day_state_SALE_AMT_1;
	private double ven_day_state_SALE_AMT_VAT_1;
	private double ven_day_state_SALE_AMT_2;
	private double ven_day_state_PAY_AMT_TAX_WPRC;
	private long ven_day_state_PAY_AMT_TAX;
	private long ven_day_state_BENEPIT_AMT;
	private double ven_day_state_BENEPIT_RATE;
	private String ven_day_state_SALE_DT_;
	private String ven_day_state_VEN_NAME;
	private String ven_day_state_STR_NAME;
	private long ven_day_state_SALE_AMT_1_SUM;
	private double ven_day_state_SALE_AMT_VAT_1_SUM;
	private double ven_day_state_SALE_AMT_2_SUM;
	...
	private void getScriptFromV1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//데이터 변수 할당
			sheet10_A1="협력업체/일자별 매입 집계표[특정매입]";
		}    //end if(bIsFirst)
	...
	private void getScriptFromsh3_fv1(boolean bIsPrint) throws Exception{
		...
		while(ven_day_state.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet30_C3 = ven_day_state_SALE_DT;
			sheet30_D3 = (long)ven_day_state_PAY_AMT_TAX2;
			sheet30_E3 = ven_day_state_PAY_AMT_TAX1;
			sheet30_F3 = ven_day_state_PAY_AMT_TAX1_VAT;
			sheet30_G3 = ven_day_state_PAY_AMT_TAX;
			sheet30_H3 = ven_day_state_SALE_AMT_2_SUM;
			sheet30_I3 = ven_day_state_SALE_AMT_1_SUM;
			sheet30_J3 = ven_day_state_SALE_AMT_VAT_1_SUM;
	...
	private void setFieldVariableFromven_day_state() throws Exception{
		ven_day_state_SALE_DT = GetB(ven_day_state.getString(1));
		ven_day_state_VEN_CODE = GetB(ven_day_state.getString(2));
		ven_day_state_STR_CODE = GetB(ven_day_state.getString(3));
		ven_day_state_PAY_AMT_TAX1 = ven_day_state.getDouble(4);
		ven_day_state_PAY_AMT_TAX1_VAT = ven_day_state.getDouble(5);
		ven_day_state_PAY_AMT_TAX2 = ven_day_state.getDouble(6);
		ven_day_state_SALE_AMT = ven_day_state.getDouble(7);
		ven_day_state_SALE_AMT_1 = ven_day_state.getDouble(8);
		ven_day_state_SALE_AMT_VAT_1 = ven_day_state.getDouble(9);
		ven_day_state_SALE_AMT_2 = ven_day_state.getDouble(10);
		ven_day_state_PAY_AMT_TAX_WPRC = ven_day_state.getDouble(11);
		ven_day_state_PAY_AMT_TAX = ven_day_state.getLong(12);
		ven_day_state_BENEPIT_AMT = ven_day_state.getLong(13);
		ven_day_state_BENEPIT_RATE = ven_day_state.getDouble(14);
		ven_day_state_SALE_DT_ = GetB(ven_day_state.getString(15));
		ven_day_state_VEN_NAME = GetB(ven_day_state.getString(16));
		ven_day_state_STR_NAME = GetB(ven_day_state.getString(17));
		ven_day_state_SALE_AMT_1_SUM = ven_day_state.getLong(18);
		ven_day_state_SALE_AMT_VAT_1_SUM = ven_day_state.getDouble(19);
		ven_day_state_SALE_AMT_2_SUM = ven_day_state.getDouble(20);
		ven_day_state_SALE_AMT_TOTAL_SUM = ven_day_state.getLong(21);
	}

	//ResultSet ven_day_state 객체의 필드 값 초기화 함수
	private void setFieldInitFromven_day_state(){
		ven_day_state_SALE_DT = "";
		ven_day_state_VEN_CODE = "";
		ven_day_state_STR_CODE = "";
		ven_day_state_PAY_AMT_TAX1 = 0;
		ven_day_state_PAY_AMT_TAX1_VAT = 0;
		ven_day_state_PAY_AMT_TAX2 = 0;
		ven_day_state_SALE_AMT = 0;
		ven_day_state_SALE_AMT_1 = 0;
		ven_day_state_SALE_AMT_VAT_1 = 0;
		ven_day_state_SALE_AMT_2 = 0;
		ven_day_state_PAY_AMT_TAX_WPRC = 0;
		ven_day_state_PAY_AMT_TAX = 0L;
		ven_day_state_BENEPIT_AMT = 0L;
		ven_day_state_BENEPIT_RATE = 0;
		ven_day_state_SALE_DT_ = "";
		ven_day_state_VEN_NAME = "";
		ven_day_state_STR_NAME = "";
		ven_day_state_SALE_AMT_1_SUM = 0L;
		ven_day_state_SALE_AMT_VAT_1_SUM = 0;
		ven_day_state_SALE_AMT_2_SUM = 0;
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|61|supplyPurchStateDayPrint.style|회원매출상세내역현황", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_A2", 0, 7, 186, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_C2", 226, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_E2", 333, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_G2", 439, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet30_A1", 0, 0, 46, 40, "cell_style_2");
		setCellInfoMap_Internal("sheet30_B1", 46, 0, 115, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_C1", 161, 0, 57, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_D1", 218, 0, 61, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_E1", 279, 0, 60, 40, "cell_style_4");
		setCellInfoMap_Internal("sheet30_F1", 339, 0, 51, 40, "cell_style_2");
		setCellInfoMap_Internal("sheet30_G1", 390, 0, 64, 40, "cell_style_2");
		setCellInfoMap_Internal("sheet30_H1", 454, 0, 62, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_I1", 516, 0, 66, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_J1", 582, 0, 51, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_K1", 633, 0, 66, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_L1", 699, 0, 52, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_M1", 751, 0, 34, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_A3", 0, -1, 46, -1, "cell_style_5");
		setCellInfoMap_Internal("sheet30_B3", 46, -1, 115, -1, "cell_style_6");
		setCellInfoMap_Internal("sheet30_C3", 161, 0, 57, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet30_D3", 218, 0, 61, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_E3", 279, 0, 60, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_F3", 339, 0, 51, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_G3", 390, 0, 64, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_H3", 454, 0, 62, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_I3", 516, 0, 66, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_J3", 582, 0, 51, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_K3", 633, 0, 66, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_L3", 699, 0, 52, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_M3", 751, 0, 34, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_A4", 0, 0, 218, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_D4", 218, 0, 61, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_E4", 279, 0, 60, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_F4", 339, 0, 51, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_G4", 390, 0, 64, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_H4", 454, 0, 62, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_I4", 516, 0, 66, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_J4", 582, 0, 51, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_K4", 633, 0, 66, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_L4", 699, 0, 52, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_M4", 751, 0, 34, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_A5", 0, 0, 218, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_D5", 218, 0, 61, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_E5", 279, 0, 60, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_F5", 339, 0, 51, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_G5", 390, 0, 64, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_H5", 454, 0, 62, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_I5", 516, 0, 66, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_J5", 582, 0, 51, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_K5", 633, 0, 66, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_L5", 699, 0, 52, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_M5", 751, 0, 34, 20, "cell_style_10");
	}
}
%>
