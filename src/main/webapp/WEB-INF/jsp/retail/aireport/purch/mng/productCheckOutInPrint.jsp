...
public void jspInit() {
	...
	sql_punch.append("                    ,       NVL(TO_CHAR(TO_DATE(HDR.DOUT_CFM_DT, 'YYYYMMDD'), 'YYYY-MM-DD'), '-') AS DOUT_CFM_DT ");
	sql_punch.append("                    ,       NVL(TO_CHAR(TO_DATE(HDR.DIN_CFM_DT, 'YYYYMMDD'), 'YYYY-MM-DD'), '-') AS DIN_CFM_DT ");
	sql_punch.append("                    ,	TO_CHAR(SYSDATE,'YYYY-MM-DD HH:Mi') AS T ");
	sql_punch.append("                    FROM    PO_INOUT_HDR  HDR ");
	...
	sql_punch_list.append("        SELECT  ROW_NUMBER() OVER(ORDER BY SEQ) AS RN ");
	sql_punch_list.append("        ,       PID.SEQ ");
	sql_punch_list.append("        ,       PID.LINK_CODE AS SCAN_CODE ");
	sql_punch_list.append("        ,       PID.ITM_CODE ");
	sql_punch_list.append("        ,       PC.ITM_NAME ");
	sql_punch_list.append("        ,       PC.DP_PRC_UNIT ");
	sql_punch_list.append("        ,       PC.UNIT ");
	sql_punch_list.append("        ,       PID.STR_CODE ");
	sql_punch_list.append("        ,       PID.TAX_GB ");
	sql_punch_list.append("        ,        FN_GET_COMMON_CODE_NM('TAX_GB', PID.TAX_GB, PID.CORP_CODE) AS TAX_GB_NM ");
	sql_punch_list.append("        ,       PID.DOUT_CFM_QTY ");
	sql_punch_list.append("        ,       PID.DOUT_WPRC ");
	sql_punch_list.append("        ,       PID.DOUT_WVAT ");
	sql_punch_list.append("        ,       PID.DOUT_SPRC ");
	sql_punch_list.append("        ,       PID.DIN_CFM_QTY ");
	sql_punch_list.append("        ,       PID.DIN_SPRC ");
	sql_punch_list.append("        ,       PID.BOT_SPRC ");
	sql_punch_list.append("        FROM    PO_INOUT_DTL        PID ");
	sql_punch_list.append("        ,       CD_PRODUCT_STORE    PS ");
	sql_punch_list.append("        ,       CD_PRODUCT_CMN      PC ");
	sql_punch_list.append("        WHERE   PID.CORP_CODE   = PS.CORP_CODE ");
	sql_punch_list.append("        AND     PID.STR_CODE    = PS.STR_CODE ");
	sql_punch_list.append("        AND     PID.ITM_CODE    = PS.ITM_CODE ");
	sql_punch_list.append("        AND     PID.LINK_CODE   = PS.SCAN_CODE ");
	sql_punch_list.append("        AND     PS.CORP_CODE    = PC.CORP_CODE ");
	sql_punch_list.append("        AND     PS.ITM_CODE     = PC.ITM_CODE ");
	sql_punch_list.append("        AND     PS.SCAN_CODE    = PC.SCAN_CODE ");
	sql_punch_list.append("        AND     PID.CORP_CODE   = '^P_CORP_CODE^' ");
	sql_punch_list.append("        AND     PID.STR_CODE    = '^P_STR_CODE^' ");
	sql_punch_list.append("        AND     PID.SLIP_NO     = '^P_SLIP_NO^' ");
	sql_punch_list.append("        AND     PID.DOUT_DT     = REPLACE('^P_PUR_DT^', '-', '') ");
...
class ReportHandler{
	...
	private long punch_list_DOUT_CFM_QTY;
	private double punch_list_DOUT_WPRC;
	private long punch_list_DOUT_WVAT;
	private long punch_list_DOUT_SPRC;
	private long punch_list_DIN_CFM_QTY;
	private long punch_list_DIN_SPRC;
	...
	private void getScriptFromv2(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			sheet20_D2="대출확정";
			sheet20_E2 = punch_DOUT_CFM_DT;
			sheet20_G2="대\n입\n점";
			sheet20_H2="등록번호";
			sheet20_I2 = punch_DIN_BUSI_NO;
			sheet20_J2="대입확정";
			sheet20_K2 = punch_DIN_CFM_DT;
			sheet20_B3="상호";
			...
			nAutoHeight_v2[4]=0;
			nAutoHeight_v2[5]=0;
			nAutoHeight_v2[1]=getPrintHeight(sheet20_C2, charWidth, 10, 101, 16, nAutoHeight_v2[1], 4, 4, "cell_style_3");
			nAutoHeight_v2[1]=getPrintHeight(sheet20_I2, charWidth, 10, 101, 16, nAutoHeight_v2[1], 4, 4, "cell_style_3");
			nAutoHeight_v2[2]=getPrintHeight(sheet20_C3, charWidth, 10, 101, 16, nAutoHeight_v2[2], 4, 4, "cell_style_8");
			nAutoHeight_v2[2]=getPrintHeight(sheet20_E3, charWidth, 10, 101, 16, nAutoHeight_v2[2], 4, 4, "cell_style_9");
			nAutoHeight_v2[2]=getPrintHeight(sheet20_I3, charWidth, 10, 101, 16, nAutoHeight_v2[2], 4, 4, "cell_style_8");
			nAutoHeight_v2[2]=getPrintHeight(sheet20_K3, charWidth, 10, 101, 16, nAutoHeight_v2[2], 4, 4, "cell_style_9");
			nAutoHeight_v2[3]=getPrintHeight(sheet20_C4, charWidth, 10, 274, 16, nAutoHeight_v2[3], 4, 4, "cell_style_11");
			nAutoHeight_v2[3]=getPrintHeight(sheet20_I4, charWidth, 10, 274, 16, nAutoHeight_v2[3], 4, 4, "cell_style_11");
			nAutoHeight_v2[4]=getPrintHeight(sheet20_C5, charWidth, 10, 274, 16, nAutoHeight_v2[4], 4, 4, "cell_style_11");
			nAutoHeight_v2[4]=getPrintHeight(sheet20_I5, charWidth, 10, 274, 16, nAutoHeight_v2[4], 4, 4, "cell_style_11");
			nAutoHeight_v2[5]=getPrintHeight(sheet20_C6, charWidth, 10, 274, 16, nAutoHeight_v2[5], 4, 4, "cell_style_13");
			nAutoHeight_v2[5]=getPrintHeight(sheet20_I6, charWidth, 10, 274, 16, nAutoHeight_v2[5], 4, 4, "cell_style_13");
	...
	private void getScriptFromfv_1(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			...
			sheet30_H4=(long)SUM(sheet30_H3, sheet30_H4);
			sheet30_I4=(long)SUM(sheet30_I3, sheet30_I4);
			sheet30_J4=(long)SUM(sheet30_J3, sheet30_J4);
			sheet30_K4=(long)SUM(sheet30_K3, sheet30_K4);
			sheet30_L4=(long)SUM(sheet30_L3, sheet30_L4);
		}   //end if(!bIsLast)
	}
	...
	private void getScriptFromfv(boolean bIsPrint) throws Exception{
		...
		while(punch_list.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet30_B3 = punch_list_SCAN_CODE;
			sheet30_C3 = punch_list_ITM_NAME;
			sheet30_D3 = punch_list_DP_PRC_UNIT;
			sheet30_E3 = punch_list_UNIT;
			sheet30_F3 = punch_list_TAX_GB_NM;
			sheet30_G3 = punch_list_DOUT_CFM_QTY;
			sheet30_H3 = punch_list_DIN_CFM_QTY;
			sheet30_I3 = punch_list_DOUT_SPRC;
			sheet30_J3=sheet30_G3*sheet30_I3;
			sheet30_K3 = punch_list_DIN_SPRC;
			sheet30_L3=sheet30_H3*sheet30_K3;
	...
	private void setFieldVariableFrompunch() throws Exception{
		...
		punch_DOUT_CFM_YN = GetB(punch.getString(6));
		punch_INV_FLAG = GetB(punch.getString(7));
		punch_REMARK = GetB(punch.getString(8));
		punch_IEMP_NO = GetB(punch.getString(9));
		punch_IDATE = GetB(punch.getString(10));
		punch_UEMP_NO = GetB(punch.getString(11));
		punch_UDATE = GetB(punch.getString(12));
		punch_STR_ADDR = GetB(punch.getString(13));
		punch_STR_BUSI_NO = GetB(punch.getString(14));
		punch_STR_REP_NAME = GetB(punch.getString(15));
		punch_STR_NAME = GetB(punch.getString(16));
		punch_STR_UPJONG = GetB(punch.getString(17));
		punch_STR_UPTAE = GetB(punch.getString(18));
		punch_DIN_ADDR = GetB(punch.getString(19));
		punch_DIN_BUSI_NO = GetB(punch.getString(20));
		punch_DIN_REP_NAME = GetB(punch.getString(21));
		punch_DIN_STR_NAME = GetB(punch.getString(22));
		punch_DIN_UPJONG = GetB(punch.getString(23));
		punch_DIN_UPTAE = GetB(punch.getString(24));
		punch_DOUT_CFM_DT = GetB(punch.getString(25));
		punch_DIN_CFM_DT = GetB(punch.getString(26));
		punch_T = GetB(punch.getString(27));
	}
	...
	private void setFieldVariableFrompunch_list() throws Exception{
		...
		punch_list_SEQ = punch_list.getLong(2);
		punch_list_SCAN_CODE = GetB(punch_list.getString(3));
		punch_list_ITM_CODE = GetB(punch_list.getString(4));
		punch_list_ITM_NAME = GetB(punch_list.getString(5));
		punch_list_DP_PRC_UNIT = GetB(punch_list.getString(6));
		punch_list_UNIT = GetB(punch_list.getString(7));
		punch_list_STR_CODE = GetB(punch_list.getString(8));
		punch_list_TAX_GB = GetB(punch_list.getString(9));
		punch_list_TAX_GB_NM = GetB(punch_list.getString(10));
		punch_list_DOUT_CFM_QTY = punch_list.getLong(11);
		punch_list_DOUT_WPRC = punch_list.getDouble(12);
		punch_list_DOUT_WVAT = punch_list.getLong(13);
		punch_list_DOUT_SPRC = punch_list.getLong(14);
		punch_list_DIN_CFM_QTY = punch_list.getLong(15);
		punch_list_DIN_SPRC = punch_list.getLong(16);
	...
	private void setFieldInitFrompunch_list(){
		...
		punch_list_DOUT_CFM_QTY = 0L;
		punch_list_DOUT_WPRC = 0;
		punch_list_DOUT_WVAT = 0L;
		punch_list_DOUT_SPRC = 0L;
		punch_list_DIN_CFM_QTY = 0L;
		punch_list_DIN_SPRC = 0L;
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|76|productCheckOutInPrint.style|보고서 (2017/3/20 17:59:30)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_C2", 91, nAutoHeight_v2[0], 105, nAutoHeight_v2[1]-nAutoHeight_v2[0], "cell_style_3");
		setCellInfoMap_Internal("sheet20_D2", 196, nAutoHeight_v2[0], 68, nAutoHeight_v2[1]-nAutoHeight_v2[0], "cell_style_2");
		setCellInfoMap_Internal("sheet20_E2", 264, nAutoHeight_v2[0], 105, nAutoHeight_v2[1]-nAutoHeight_v2[0], "cell_style_4");
		setCellInfoMap_Internal("sheet20_G2", 415, nAutoHeight_v2[0], 32, nAutoHeight_v2[5]-nAutoHeight_v2[0], "cell_style_5");
		setCellInfoMap_Internal("sheet20_H2", 447, nAutoHeight_v2[0], 63, nAutoHeight_v2[1]-nAutoHeight_v2[0], "cell_style_6");
		setCellInfoMap_Internal("sheet20_I2", 510, nAutoHeight_v2[0], 105, nAutoHeight_v2[1]-nAutoHeight_v2[0], "cell_style_3");
		setCellInfoMap_Internal("sheet20_J2", 615, nAutoHeight_v2[0], 68, nAutoHeight_v2[1]-nAutoHeight_v2[0], "cell_style_2");
		setCellInfoMap_Internal("sheet20_K2", 683, nAutoHeight_v2[0], 105, nAutoHeight_v2[1]-nAutoHeight_v2[0], "cell_style_4");
		setCellInfoMap_Internal("sheet20_B3", 28, nAutoHeight_v2[1], 63, nAutoHeight_v2[2]-nAutoHeight_v2[1], "cell_style_7");
		setCellInfoMap_Internal("sheet20_C3", 91, nAutoHeight_v2[1], 105, nAutoHeight_v2[2]-nAutoHeight_v2[1], "cell_style_8");
		setCellInfoMap_Internal("sheet20_D3", 196, nAutoHeight_v2[1], 68, nAutoHeight_v2[2]-nAutoHeight_v2[1], "cell_style_7");
		setCellInfoMap_Internal("sheet20_E3", 264, nAutoHeight_v2[1], 105, nAutoHeight_v2[2]-nAutoHeight_v2[1], "cell_style_9");
		setCellInfoMap_Internal("sheet20_H3", 447, nAutoHeight_v2[1], 63, nAutoHeight_v2[2]-nAutoHeight_v2[1], "cell_style_10");
		setCellInfoMap_Internal("sheet20_I3", 510, nAutoHeight_v2[1], 105, nAutoHeight_v2[2]-nAutoHeight_v2[1], "cell_style_8");
		setCellInfoMap_Internal("sheet20_J3", 615, nAutoHeight_v2[1], 68, nAutoHeight_v2[2]-nAutoHeight_v2[1], "cell_style_7");
		setCellInfoMap_Internal("sheet20_K3", 683, nAutoHeight_v2[1], 105, nAutoHeight_v2[2]-nAutoHeight_v2[1], "cell_style_9");
		setCellInfoMap_Internal("sheet20_B4", 28, nAutoHeight_v2[2], 63, nAutoHeight_v2[3]-nAutoHeight_v2[2], "cell_style_7");
		setCellInfoMap_Internal("sheet20_C4", 91, nAutoHeight_v2[2], 278, nAutoHeight_v2[3]-nAutoHeight_v2[2], "cell_style_11");
		setCellInfoMap_Internal("sheet20_H4", 447, nAutoHeight_v2[2], 63, nAutoHeight_v2[3]-nAutoHeight_v2[2], "cell_style_10");
		setCellInfoMap_Internal("sheet20_I4", 510, nAutoHeight_v2[2], 278, nAutoHeight_v2[3]-nAutoHeight_v2[2], "cell_style_11");
		setCellInfoMap_Internal("sheet20_B5", 28, nAutoHeight_v2[3], 63, nAutoHeight_v2[4]-nAutoHeight_v2[3], "cell_style_7");
		setCellInfoMap_Internal("sheet20_C5", 91, nAutoHeight_v2[3], 278, nAutoHeight_v2[4]-nAutoHeight_v2[3], "cell_style_11");
		setCellInfoMap_Internal("sheet20_H5", 447, nAutoHeight_v2[3], 63, nAutoHeight_v2[4]-nAutoHeight_v2[3], "cell_style_10");
		setCellInfoMap_Internal("sheet20_I5", 510, nAutoHeight_v2[3], 278, nAutoHeight_v2[4]-nAutoHeight_v2[3], "cell_style_11");
		setCellInfoMap_Internal("sheet20_B6", 28, nAutoHeight_v2[4], 63, nAutoHeight_v2[5]-nAutoHeight_v2[4], "cell_style_12");
		setCellInfoMap_Internal("sheet20_C6", 91, nAutoHeight_v2[4], 278, nAutoHeight_v2[5]-nAutoHeight_v2[4], "cell_style_13");
		setCellInfoMap_Internal("sheet20_H6", 447, nAutoHeight_v2[4], 63, nAutoHeight_v2[5]-nAutoHeight_v2[4], "cell_style_14");
		setCellInfoMap_Internal("sheet20_I6", 510, nAutoHeight_v2[4], 278, nAutoHeight_v2[5]-nAutoHeight_v2[4], "cell_style_13");
		setCellInfoMap_Internal("sheet30_A2", 0, 7, 15, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet30_B2", 15, 7, 91, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_C2", 106, 7, 219, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_D2", 325, 7, 54, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_E2", 379, 7, 54, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_F2", 433, 7, 31, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_G2", 464, 7, 31, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_H2", 495, 7, 31, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_I2", 526, 7, 56, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_J2", 582, 7, 75, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_K2", 657, 7, 56, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_L2", 713, 7, 75, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet30_A3", 0, 0, 15, 15, "cell_style_16");
		setCellInfoMap_Internal("sheet30_B3", 15, 0, 91, 15, "cell_style_17");
		setCellInfoMap_Internal("sheet30_C3", 106, 0, 219, 15, "cell_style_18");
		setCellInfoMap_Internal("sheet30_D3", 325, 0, 54, 15, "cell_style_19");
		setCellInfoMap_Internal("sheet30_E3", 379, 0, 54, 15, "cell_style_17");
		setCellInfoMap_Internal("sheet30_F3", 433, 0, 31, 15, "cell_style_17");
		setCellInfoMap_Internal("sheet30_G3", 464, 0, 31, 15, "cell_style_20");
		setCellInfoMap_Internal("sheet30_H3", 495, 0, 31, 15, "cell_style_20");
		setCellInfoMap_Internal("sheet30_I3", 526, 0, 56, 15, "cell_style_20");
		setCellInfoMap_Internal("sheet30_J3", 582, 0, 75, 15, "cell_style_20");
		setCellInfoMap_Internal("sheet30_K3", 657, 0, 56, 15, "cell_style_20");
		setCellInfoMap_Internal("sheet30_L3", 713, 0, 75, 15, "cell_style_21");
		setCellInfoMap_Internal("sheet30_A4", 0, 0, 464, 18, "cell_style_22");
		setCellInfoMap_Internal("sheet30_G4", 464, 0, 31, 18, "cell_style_23");
		setCellInfoMap_Internal("sheet30_H4", 495, 0, 31, 18, "cell_style_23");
		setCellInfoMap_Internal("sheet30_I4", 526, 0, 56, 18, "cell_style_23");
		setCellInfoMap_Internal("sheet30_J4", 582, 0, 75, 18, "cell_style_23");
		setCellInfoMap_Internal("sheet30_K4", 657, 0, 56, 18, "cell_style_23");
		setCellInfoMap_Internal("sheet30_L4", 713, 0, 75, 18, "cell_style_24");
	}
}
%>
