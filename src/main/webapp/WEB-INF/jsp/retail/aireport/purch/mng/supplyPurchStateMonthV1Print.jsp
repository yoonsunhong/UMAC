...
public void jspInit() {
	...
	sql_TITLE.append(",	SUBSTR('^P_SALE_DT^',0,4) ||'-'|| SUBSTR('^P_SALE_DT^',5,2) AS SALE_DT_ ");
	...
	sql_ven_day_state.append("                ,       AA.STR_CODE ");
	...
	sql_ven_day_state.append("                ,       STR_CODE ");
	...
	sql_ven_day_state.append("		    ,       PPH.STR_CODE ");
	...
	sql_ven_day_state.append("		    AND     PPH.PUR_CFM_DT BETWEEN REPLACE(SUBSTR('^P_SALE_DT^',0,6), '-')||'01' AND REPLACE(SUBSTR('^P_SALE_DT^',0,6), '-')||'31' ");
	...
	sql_ven_day_state.append("                ,           AA.VEN_CODE ");
	sql_ven_day_state.append("                ,           AA.STR_NAME ");
	sql_ven_day_state.append("                ,           AA.STR_CODE) AAA ");
	sql_ven_day_state.append("                ORDER BY    AAA.VEN_CODE, AAA.STR_CODE ");
...
class ReportHandler{
	...
	private void getScriptFromsh3_fv1_sub3(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			//데이터 변수 할당
			sheet30_A4="협력업체별 소계";
			sheet30_D4=(long)SUM(sheet30_D3, sheet30_D4);
	...
	private void getScriptFromsh3_fv1_sub2(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			//데이터 변수 할당
			sheet30_A5="합계";
			sheet30_D5=(long)SUM(sheet30_D3, sheet30_D5);
	...
	private void getScriptFromsh3_fv1(boolean bIsPrint) throws Exception{
		...
		while(ven_day_state.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(!sheet30_B3.equals(ven_day_state_VEN_NAME)){
				if(!bIsFirst){
			...
			if(!sheet30_C3.equals(ven_day_state_STR_NAME) || sheet30_B3_Flag){
				if(!bIsFirst){
			...
			sheet30_D3 = ven_day_state_PUR_WPRC2_TAX2;
			sheet30_E3 = ven_day_state_PUR_WPRC2_TAX1;
			sheet30_F3 = ven_day_state_PUR_WVAT2_TAX1;
			sheet30_G3=sheet30_E3+sheet30_F3;
			sheet30_H3 = ven_day_state_PUR_WPRC2_WVAT_TAX;
			sheet30_I3 = ven_day_state_BOT_SUM;
			sheet30_J3 = ven_day_state_PUR_WPRC2_WVAT_TAX_BOT;
			sheet30_K3 = ven_day_state_PUR_SAMT;
			sheet30_L3 = ven_day_state_BENEPIT_AMT;
			sheet30_M3 = ven_day_state_BENEPIT_RATE;
	...
	private void writeScriptsh3_fv1_sub2( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet30_M5"), nYCurPos+mapTop.get("sheet30_M5"), mapWidth.get("sheet30_M5"), mapHeight.get("sheet30_M5"), "", "sheet30_M5", mapStyle.get("sheet30_M5"));
	}
	...
	private void setFieldVariableFromTITLE() throws Exception{
		...
		TITLE_SALE_DT_ = GetB(TITLE.getString(6));
	}
	...
	private void setFieldVariableFromven_day_state() throws Exception{
		...
		ven_day_state_STR_CODE = GetB(ven_day_state.getString(4));
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|61|영업정보_매입관리_협력업체_월별_직매입.style|회원매출상세내역현황", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_A2", 0, 7, 86, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_C2", 126, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_E2", 233, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_G2", 339, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet30_A1", 0, 0, 35, 40, "cell_style_2");
		setCellInfoMap_Internal("sheet30_B1", 35, 0, 97, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_C1", 132, 0, 38, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_D1", 170, 0, 63, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_E1", 233, 0, 196, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_H1", 429, 0, 71, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_I1", 500, 0, 48, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_J1", 548, 0, 72, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_K1", 620, 0, 71, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_L1", 691, 0, 57, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_M1", 748, 0, 35, 40, "cell_style_3");
		setCellInfoMap_Internal("sheet30_E2", 233, 20, 68, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet30_F2", 301, 20, 59, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet30_G2", 360, 20, 69, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet30_A3", 0, -1, 35, -1, "cell_style_5");
		setCellInfoMap_Internal("sheet30_B3", 35, -1, 97, -1, "cell_style_6");
		setCellInfoMap_Internal("sheet30_C3", 132, -1, 38, -1, "cell_style_7");
		setCellInfoMap_Internal("sheet30_D3", 170, 0, 63, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_E3", 233, 0, 68, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_F3", 301, 0, 59, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_G3", 360, 0, 69, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_H3", 429, 0, 71, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_I3", 500, 0, 48, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_J3", 548, 0, 72, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_K3", 620, 0, 71, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_L3", 691, 0, 57, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_M3", 748, 0, 35, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_A4", 0, 0, 170, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_D4", 170, 0, 63, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_E4", 233, 0, 68, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_F4", 301, 0, 59, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_G4", 360, 0, 69, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_H4", 429, 0, 71, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_I4", 500, 0, 48, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_J4", 548, 0, 72, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_K4", 620, 0, 71, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_L4", 691, 0, 57, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_M4", 748, 0, 35, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_A5", 0, 0, 170, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_D5", 170, 0, 63, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_E5", 233, 0, 68, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_F5", 301, 0, 59, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_G5", 360, 0, 69, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_H5", 429, 0, 71, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_I5", 500, 0, 48, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_J5", 548, 0, 72, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_K5", 620, 0, 71, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_L5", 691, 0, 57, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet30_M5", 748, 0, 35, 20, "cell_style_12");
	}
}
%>
