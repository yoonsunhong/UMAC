...
public void jspInit() {
	...
	sql_ven_day_state.append("                ,       ROUND(SUM(PUR_WPRC2),0) AS PUR_WPRC2 ");
	sql_ven_day_state.append("                ,       ROUND(SUM(PUR_WVAT2),0) AS PUR_WVAT2 ");
	...
	sql_ven_day_state.append("                                                                  - ROUND(PPD.DEC_QTY * (PPD.PUR_WPRC + PPD.PUR_WVAT)/11, 4) ");
	...
	sql_ven_day_state.append("                                                                   - ROUND(PPD.DEC_QTY * -1 * (PPD.PUR_WPRC + PPD.PUR_WVAT)/11, 1) ");
	sql_ven_day_state.append("                                                                   , TRUNC(PPD.DEC_QTY * -1 * PPD.PUR_WPRC) ) ");
	sql_ven_day_state.append("                                        END  AS PUR_WPRC2 ");
	sql_ven_day_state.append("                                , CASE WHEN PPH.PUR_GB = '1' THEN ");
	sql_ven_day_state.append("                                            DECODE(PPD.TAX_GB, '1', ROUND(PPD.DEC_QTY * (PPD.PUR_WPRC + PPD.PUR_WVAT)/11, 5) ");
	sql_ven_day_state.append("                                                                  , ROUND(PPD.DEC_QTY * PPD.PUR_WVAT, 1) ) ");
	sql_ven_day_state.append("                                        ELSE DECODE(PPD.TAX_GB, '1', ROUND(PPD.DEC_QTY * -1 * (PPD.PUR_WPRC + PPD.PUR_WVAT)/11, 1) ");
	...
	sql_ven_day_state.append("		    AND	 PPH.PUR_CFM_DT BETWEEN  '^P_SALE_DT^' AND '^P_SALE_DT_E^' ");
...
class ReportHandler{
	...
	private void getScriptFromsh3_fv1_sub2(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			...
			sheet30_K5=(long)SUM(sheet30_K3, sheet30_K5);
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|54|영업정보_매입관리_협력업체_일자별_직매입.style|회원매출상세내역현황", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_A2", 0, 7, 185, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_C2", 225, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_E2", 332, 7, 75, 20, "cell_style_1");
		setCellInfoMap_Internal("sheet20_G2", 438, 7, 75, 20, "cell_style_1");
		...
		setCellInfoMap_Internal("sheet30_D3", 178, 0, 63, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet30_E3", 241, 0, 62, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_F3", 303, 0, 61, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_G3", 364, 0, 47, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_H3", 411, 0, 61, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_I3", 472, 0, 65, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_J3", 537, 0, 39, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_K3", 576, 0, 65, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_L3", 641, 0, 65, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_M3", 706, 0, 47, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_N3", 753, 0, 34, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet30_A4", 0, 0, 241, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet30_E4", 241, 0, 62, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_F4", 303, 0, 61, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_G4", 364, 0, 47, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_H4", 411, 0, 61, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_I4", 472, 0, 65, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_J4", 537, 0, 39, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_K4", 576, 0, 65, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_L4", 641, 0, 65, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet30_M4", 706, 0, 47, 20, "cell_style_9");
