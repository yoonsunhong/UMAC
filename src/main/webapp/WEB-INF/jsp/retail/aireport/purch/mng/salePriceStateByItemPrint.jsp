...
public void jspInit() {
	...
	sql_SALE_LIST.append("      , STR_NAME ");
	sql_SALE_LIST.append("     , VEN_CODE ");
	sql_SALE_LIST.append("     , VEN_NAME ");
	sql_SALE_LIST.append("     , SCAN_CODE ");
	sql_SALE_LIST.append("     , ITM_CODE ");
	sql_SALE_LIST.append("     , ITM_NAME ");
	sql_SALE_LIST.append("     , SUBSTR(PUR_DT,0,4) ||'-'|| SUBSTR(PUR_DT,5,2)||'-'|| SUBSTR(PUR_DT,7,2) AS PUR_DT ");
	sql_SALE_LIST.append("     , SUBSTR(PUR_CFM_DT,0,4) ||'-'|| SUBSTR(PUR_CFM_DT,5,2) ||'-'|| SUBSTR(PUR_CFM_DT,7,2) AS PUR_CFM_DT ");
	sql_SALE_LIST.append("     , UNIT ");
	sql_SALE_LIST.append("     , PUR_GB ");
	sql_SALE_LIST.append("     , DECODE(PUR_GB,'1','매입','2','반품') AS PUR_GB_NM ");
	sql_SALE_LIST.append("     , ORD_FLAG ");
	sql_SALE_LIST.append("     , DECODE(ORD_FLAG,'1','정상','2','행사','3','지원(덤)') AS ORD_FLAG_NM ");
	sql_SALE_LIST.append("     , TAX_GB ");
	sql_SALE_LIST.append("     , DECODE(TAX_GB,'1','과세','2','면세') AS TAX_GB_NM ");
	sql_SALE_LIST.append("     , PUR_WAMT ");
	sql_SALE_LIST.append("     , PUR_SPRC ");
	sql_SALE_LIST.append("     , DEC_QTY * DECODE(PUR_GB,'2',-1,1) AS DEC_QTY ");
	sql_SALE_LIST.append("     , PUR_TWAMT * DECODE(PUR_GB,'2',-1,1) AS PUR_TWAMT ");
	sql_SALE_LIST.append("     , PUR_TSAMT * DECODE(PUR_GB,'2',-1,1) AS PUR_TSAMT ");
	sql_SALE_LIST.append("     , EXPECTED_PROFIT * DECODE(PUR_GB,'2',-1,1) AS EXPECTED_PROFIT ");
	sql_SALE_LIST.append("     , CASE WHEN PUR_TSAMT = 0 THEN '0.00' ");
	sql_SALE_LIST.append("            ELSE TO_CHAR(EXPECTED_PROFIT / PUR_TSAMT * 100 * DECODE(PUR_GB,'2',-1,1), '999.99') ");
	sql_SALE_LIST.append("        END AS PROFIT_RATE ");
	sql_SALE_LIST.append("  FROM ( ");
	sql_SALE_LIST.append("        SELECT PUH.CORP_CODE            AS CORP_CODE ");
	sql_SALE_LIST.append("             , STR.STR_CODE ");
	sql_SALE_LIST.append("             , STR.STR_NAME ");
	...
	sql_SALE_LIST.append("             , CPC.ITM_NAME             AS ITM_NAME ");
	sql_SALE_LIST.append("             , CS.VEN_NAME              AS VEN_NAME ");
	sql_SALE_LIST.append("             , MAX(NVL(PUD.UNIT,'-'))   AS UNIT ");
	sql_SALE_LIST.append("             , PUH.PUR_GB ");
	sql_SALE_LIST.append("             , MAX(PUD.ORD_FLAG)        AS ORD_FLAG ");
	sql_SALE_LIST.append("             , MAX(PUD.TAX_GB)          AS TAX_GB ");
	sql_SALE_LIST.append("             , SUM(PUD.PUR_WAMT)        AS PUR_WAMT ");
	sql_SALE_LIST.append("             , SUM(PUD.PUR_SPRC)        AS PUR_SPRC ");
	sql_SALE_LIST.append("             , SUM(PUD.DEC_QTY)         AS DEC_QTY ");
	sql_SALE_LIST.append("             , SUM((PUD.PUR_WPRC + PUD.PUR_WVAT) * PUD.DEC_QTY) AS PUR_TWAMT ");
	sql_SALE_LIST.append("             , SUM(PUR_SPRC * DEC_QTY)  AS PUR_TSAMT ");
	sql_SALE_LIST.append("             , SUM((PUR_SPRC * DEC_QTY) - (PUD.PUR_WAMT * PUD.DEC_QTY)) AS EXPECTED_PROFIT ");
	sql_SALE_LIST.append("          FROM PO_PURCH_HDR     PUH ");
	sql_SALE_LIST.append("             , PO_PURCH_DTL     PUD ");
	sql_SALE_LIST.append("             , CD_PRODUCT_STORE CPS ");
	sql_SALE_LIST.append("             , CD_PRODUCT_CMN   CPC ");
	sql_SALE_LIST.append("             , CD_SUPPLY        CS ");
	sql_SALE_LIST.append("             , CD_STORE         STR ");
	...
	sql_SALE_LIST.append("           AND CPS.CORP_CODE        = CPC.CORP_CODE ");
	sql_SALE_LIST.append("           AND CPS.ITM_CODE         = CPC.ITM_CODE ");
	sql_SALE_LIST.append("           AND CPS.SCAN_CODE        = CPC.SCAN_CODE ");
	sql_SALE_LIST.append("           AND PUH.CORP_CODE        = CS.CORP_CODE ");
	sql_SALE_LIST.append("           AND PUH.VEN_CODE         = CS.VEN_CODE ");
	sql_SALE_LIST.append("           AND PUH.STR_CODE         = STR.STR_CODE ");
	...
	sql_SALE_LIST.append("           AND PUH.STR_CODE         = NVL('^P_STR_CODE^', PUH.STR_CODE) ");
	sql_SALE_LIST.append("           AND PUH.PUR_GB           = NVL('^P_PUR_GB^',PUH.PUR_GB) ");
	sql_SALE_LIST.append("           AND PUD.ORD_FLAG        IN ('1','2') ");
	sql_SALE_LIST.append("           AND PUH.VEN_CODE         = NVL( '^P_VEN_CODE^',PUH.VEN_CODE) ");
	sql_SALE_LIST.append("           AND PUD.ITM_CODE         = NVL( '^P_ITM_CODE^',PUD.ITM_CODE) ");
	sql_SALE_LIST.append("         GROUP BY PUH.CORP_CODE, STR.STR_CODE, STR.STR_NAME, PUH.VEN_CODE, CPS.SCAN_CODE, PUD.ITM_CODE, PUH.PUR_DT, PUH.PUR_CFM_DT, CPC.ITM_NAME, CS.VEN_NAME, PUH.PUR_GB ");
	sql_SALE_LIST.append("     ) ");
	sql_SALE_LIST.append("ORDER BY CORP_CODE, STR_CODE, PUR_CFM_DT, SCAN_CODE ");
...
class ReportHandler{
	...
	private String SALE_LIST_STR_NAME;
	...
	private long SALE_LIST_PUR_WAMT;
	private long SALE_LIST_PUR_SPRC;
	private long SALE_LIST_DEC_QTY;
	private long SALE_LIST_PUR_TWAMT;
	private long SALE_LIST_PUR_TSAMT;
	private long SALE_LIST_EXPECTED_PROFIT;
	...
	private void getScriptFromfv_sub(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			//데이터 변수 할당
			sheet30_D3="소계";
			sheet30_N3=(long)SUM(sheet30_N2, sheet30_N3);
		}   //end if(!bIsLast)
	}
	...
	private void getScriptFromfv_1(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			//데이터 변수 할당
			sheet30_A4="합계";
			sheet30_N4=SUM(sheet30_N2, sheet30_N4);
		}   //end if(!bIsLast)
	}
	...
	private void getScriptFromfv1(boolean bIsPrint) throws Exception{
		...
		while(SALE_LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(!SALE_LIST_SCAN_CODE.equals(sheet30_D2)){    //fv_sub 밴드 조건문
				bIsTrue_fv_sub=true;
			}else{
			...
			//데이터 변수 할당
			if(!sheet30_A2.equals(SALE_LIST_STR_NAME)){
				if(!bIsFirst){
					sheet30_A2_Buf = sheet30_A2;
					sheet30_A2_Flag=true;
				}
				sheet30_A2=SALE_LIST_STR_NAME;
			}
			if(!sheet30_B2.equals(SALE_LIST_VEN_CODE)){
				if(!bIsFirst){
					sheet30_B2_Buf = sheet30_B2;
					sheet30_B2_Flag=true;
				}
				sheet30_B2=SALE_LIST_VEN_CODE;
			}
			if(!sheet30_C2.equals(SALE_LIST_VEN_NAME)){
				if(!bIsFirst){
					sheet30_C2_Buf = sheet30_C2;
					sheet30_C2_Flag=true;
				}
				sheet30_C2=SALE_LIST_VEN_NAME;
			}
			if(!sheet30_D2.equals(SALE_LIST_SCAN_CODE)){
				if(!bIsFirst){
					sheet30_D2_Buf = sheet30_D2;
					sheet30_D2_Flag=true;
				}
				sheet30_D2=SALE_LIST_SCAN_CODE;
			}
			if(!sheet30_E2.equals(SALE_LIST_ITM_NAME)){
				if(!bIsFirst){
					sheet30_E2_Buf = sheet30_E2;
					sheet30_E2_Flag=true;
				}
				sheet30_E2=SALE_LIST_ITM_NAME;
			}
			sheet30_F2 = SALE_LIST_PUR_DT;
			sheet30_G2 = SALE_LIST_PUR_CFM_DT;
			sheet30_H2 = SALE_LIST_UNIT;
			sheet30_I2 = SALE_LIST_PUR_GB_NM;
			sheet30_J2 = SALE_LIST_ORD_FLAG_NM;
			sheet30_K2 = SALE_LIST_TAX_GB_NM;
			sheet30_L2 = SALE_LIST_DEC_QTY;
			sheet30_M2 = SALE_LIST_PUR_WAMT;
			sheet30_N2 = SALE_LIST_PUR_TWAMT;
	...
	private void writeScriptfv1_h( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet30_N1"), nYCurPos+mapTop.get("sheet30_N1"), mapWidth.get("sheet30_N1"), mapHeight.get("sheet30_N1"), sheet30_N1, "sheet30_N1", mapStyle.get("sheet30_N1"));
	}
	...
	private void writeScriptfv_sub( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet30_N3"), nYCurPos+mapTop.get("sheet30_N3"), mapWidth.get("sheet30_N3"), mapHeight.get("sheet30_N3"), String.valueOf(sheet30_N3), "sheet30_N3", mapStyle.get("sheet30_N3"));
	}
	...
	private void writeScriptfv1(  ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet30_N2"), nYCurPos+mapTop.get("sheet30_N2"), mapWidth.get("sheet30_N2"), mapHeight.get("sheet30_N2"), String.valueOf(sheet30_N2), "sheet30_N2", mapStyle.get("sheet30_N2"));
	}
	...
	private void setFieldVariableFromSALE_LIST() throws Exception{
		...
		SALE_LIST_STR_NAME = GetB(SALE_LIST.getString(2));
		SALE_LIST_VEN_CODE = GetB(SALE_LIST.getString(3));
		SALE_LIST_VEN_NAME = GetB(SALE_LIST.getString(4));
		SALE_LIST_SCAN_CODE = GetB(SALE_LIST.getString(5));
		SALE_LIST_ITM_CODE = GetB(SALE_LIST.getString(6));
		SALE_LIST_ITM_NAME = GetB(SALE_LIST.getString(7));
		SALE_LIST_PUR_DT = GetB(SALE_LIST.getString(8));
		SALE_LIST_PUR_CFM_DT = GetB(SALE_LIST.getString(9));
		SALE_LIST_UNIT = GetB(SALE_LIST.getString(10));
		SALE_LIST_PUR_GB = GetB(SALE_LIST.getString(11));
		SALE_LIST_PUR_GB_NM = GetB(SALE_LIST.getString(12));
		SALE_LIST_ORD_FLAG = GetB(SALE_LIST.getString(13));
		SALE_LIST_ORD_FLAG_NM = GetB(SALE_LIST.getString(14));
		SALE_LIST_TAX_GB = GetB(SALE_LIST.getString(15));
		SALE_LIST_TAX_GB_NM = GetB(SALE_LIST.getString(16));
		SALE_LIST_PUR_WAMT = SALE_LIST.getLong(17);
		SALE_LIST_PUR_SPRC = SALE_LIST.getLong(18);
		SALE_LIST_DEC_QTY = SALE_LIST.getLong(19);
		SALE_LIST_PUR_TWAMT = SALE_LIST.getLong(20);
		SALE_LIST_PUR_TSAMT = SALE_LIST.getLong(21);
		SALE_LIST_EXPECTED_PROFIT = SALE_LIST.getLong(22);
		SALE_LIST_PROFIT_RATE = GetB(SALE_LIST.getString(23));
	}
	...
	private void setFieldInitFromSALE_LIST(){
		...
		SALE_LIST_TAX_GB = "";
		SALE_LIST_TAX_GB_NM = "";
		SALE_LIST_PUR_WAMT = 0L;
		SALE_LIST_PUR_SPRC = 0L;
		SALE_LIST_DEC_QTY = 0L;
		SALE_LIST_PUR_TWAMT = 0L;
		SALE_LIST_PUR_TSAMT = 0L;
		SALE_LIST_EXPECTED_PROFIT = 0L;
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|49|salePriceStateByItemPrint.style|회원매출상세내역현황", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet30_A1", 0, 0, 45, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_B1", 45, 0, 42, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_C1", 87, 0, 89, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_D1", 176, 0, 65, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet30_E1", 241, 0, 185, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_F1", 426, 0, 53, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_G1", 479, 0, 53, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_H1", 532, 0, 43, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_I1", 575, 0, 30, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_J1", 605, 0, 28, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_K1", 633, 0, 28, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_L1", 661, 0, 33, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_M1", 694, 0, 47, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_N1", 741, 0, 47, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet30_A2", 0, -1, 45, -1, "cell_style_6");
		setCellInfoMap_Internal("sheet30_B2", 45, -1, 42, -1, "cell_style_6");
		setCellInfoMap_Internal("sheet30_C2", 87, -1, 89, -1, "cell_style_7");
		setCellInfoMap_Internal("sheet30_D2", 176, -1, 65, -1, "cell_style_6");
		setCellInfoMap_Internal("sheet30_E2", 241, -1, 185, -1, "cell_style_7");
		setCellInfoMap_Internal("sheet30_F2", 426, 0, 53, 15, "cell_style_6");
		setCellInfoMap_Internal("sheet30_G2", 479, 0, 53, 15, "cell_style_6");
		setCellInfoMap_Internal("sheet30_H2", 532, 0, 43, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet30_I2", 575, 0, 30, 15, "cell_style_6");
		setCellInfoMap_Internal("sheet30_J2", 605, 0, 28, 15, "cell_style_6");
		setCellInfoMap_Internal("sheet30_K2", 633, 0, 28, 15, "cell_style_6");
		setCellInfoMap_Internal("sheet30_L2", 661, 0, 33, 15, "cell_style_9");
		setCellInfoMap_Internal("sheet30_M2", 694, 0, 47, 15, "cell_style_9");
		setCellInfoMap_Internal("sheet30_N2", 741, 0, 47, 15, "cell_style_9");
		setCellInfoMap_Internal("sheet30_A3", 0, 0, 45, 15, "cell_style_10");
		setCellInfoMap_Internal("sheet30_B3", 45, 0, 131, 15, "cell_style_11");
		setCellInfoMap_Internal("sheet30_D3", 176, 0, 565, 15, "cell_style_12");
		setCellInfoMap_Internal("sheet30_N3", 741, 0, 47, 15, "cell_style_13");
		setCellInfoMap_Internal("sheet30_A4", 0, 0, 741, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet30_N4", 741, 0, 47, 20, "cell_style_15");
	}
}
%>
