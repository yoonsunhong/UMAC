...
public void jspInit() {
	...
	sql_inout.append("            AND     IH.DOUT_DT BETWEEN '^P_DOUT_STR_DT^' AND '^P_DOUT_END_DT^' ");
	sql_inout.append("        ) TB ");
...
class ReportHandler{
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|67|영업정보_매입관리_대출입전표_총합계_점포별2_미확정.style|보고서 (2017/3/20 17:59:30)", false);
	}
