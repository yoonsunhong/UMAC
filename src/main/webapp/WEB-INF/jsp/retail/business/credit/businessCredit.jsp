...
<script type="text/javascript" src="/resources/js/page/business/credit/businessCredit.js?ver=20180409_009" charset="utf-8"></script>
	...
	jQuery.ajax({
	    ...
	    success : function(data) {
	    	...
	    	if(data[0].ORG_TYPE == "3") {
	    		...
	    		$("#ATK_STR_CODE").val(loadData.STR_CODE);
	    		$("#ATK_STR_CODE").prop("disabled", true);
	    	} else {
	    		//
	    	}
	    },
 ...
 <body id="in_frame">
	...
	<div id="iframeCnt">
		<div class="btn_area clear">
			...
			<div class="f_r">
				<button type="button" id="btn_alimtalk"  class="btn btn_style2"  onclick="btnAlimTalk()">알림톡전송</button>
				<!-- 권한에 따른 버튼 show/hide -->
		...
		<div class="search_area"    id="top_search">
			<table>
				<tr>
					...
					<th><label for="">입금구분</label></th>
					<td>
<!-- 						<input type="text" id="P_SALE_STR_DT" name="P_SALE_STR_DT" class="datepicker datepicker1 wid2"> ~  -->
<!-- 						<input type="text" id="P_SALE_END_DT" name="P_SALE_END_DT" class="datepicker datepicker2 wid2">  기존은 날짜로 검색 지금은 입금구분으로  -->
			
						<select id="P_DPOT_FISH_YN" name="P_DPOT_FISH_YN" class="" >
							<option value=""   >전체</option>
							<option value="Y" >입금</option>
							<option value="N" selected="selected" >미입금</option>
						</select>
					</td>
					...
					<div class="lft_box f_l">
						<div class="clear">
							...
							<div class="f_r">
								...
								<button type="button" id="editSlip" class="btn btn_style4" onclick="editSlip()">매출전표 수정</button>
								<button type="button" id="addAccount" class="btn btn_style4" onclick="addAccount()"><spring:message code="insertCredit"/></button>
