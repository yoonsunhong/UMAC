...
<script type="text/javascript" src="/resources/js/page/wms/in/wmsInReport/wmsInReport.js?ver=23" charset="utf-8"></script>
<!-- 공통 팝업 -->
		...
		<div id="iframeCnt">
			...
			<div class="search_area"    id="top_search">
				...
				<div>
					...
					<label for=""><spring:message code="goodsReceiptType"/></label>	
					<select  id="P_PUR_GB" name="P_PUR_GB" ></select>
				</div>
				<div class="last">
					...
					<label for=""><spring:message code="goodsReceiptNumber"/></label>
					<input type="text" id="P_SLIP_NO" name="P_SLIP_NO" class="search_txt" onkeyup="CommonJs.engNumCheck(this)" maxlength="15" style="margin-right:22px;">
