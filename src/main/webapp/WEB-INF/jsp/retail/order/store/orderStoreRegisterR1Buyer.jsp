...
<script type="text/javascript" src="/resources/js/page/order/store/orderStoreRegisterR1Buyer.js?ver=20170414"  charset="utf-8"></script>
		...
		<table class="tbl_st2">
			...
			<tbody>
				<tr>
					...
					<td>
						<select id="STR_CODE" name="STR_CODE" class="wid2" onChange="setOrderDay();">
<!-- 							<option value="">선택</option>  -->
						</select>	
						 
<!-- 						<input type="hidden" id="STR_CODE" name="STR_CODE"  > -->
<!-- 						<input type="text"   id="STR_NAME" name="STR_NAME" class="wid2 search_txt"> -->
<!-- 						<button type="button" class="search_btn" style="margin-right:4px;" onclick="btn_comm_store_search()">검색 아이콘</button> -->
<!-- 						<input type="text"   id="" name="" class="wid2" readonly> -->
					</td>
