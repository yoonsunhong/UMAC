...
<script type="text/javascript" src="/resources/js/page/order/store/orderStoreRegisterBonus.js?ver=20180405_000" charset="utf-8"></script>
 ...
 <body id="in_frame">
	<div id="iframeCnt">
		...
		<div class="btn_area clear">
			...
			<div class="f_r">
				<button type="button" id="btn_confirm"	name="btn_confirm"  class="btn btn_style2" onclick="btn_confirm();">매입마감</button>
		...
		<form id="frmSearch" name="frmSearch">
			<div class="search_area" id="top_search" name="top_search">
				<div class="last">
					...
					<label for=""><em>필수입력사항</em>입고부서</label>
			...
			<table class="tbl_st2">
				...
				<tbody>
					<tr>
						...
						<th scope="row"><em>필수입력항목</em>입고부서</th>
						<td>
						...
						<td>
							<input type="text" id="PUR_DT" name="PUR_DT" class="datepicker wid2" style="float:left;" readonly />
						</td>
						<th scope="row"><em>필수입력항목</em>매입형태</th>
						<td>
							<select id="ORD_FLAG" name="ORD_FLAG" class="wid2"></select>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<input type="hidden" 	id="VEN_CODE" 		name="VEN_CODE" class="wid2" readonly />
							<input type="text" 		id="VEN_NAME" 		name="VEN_NAME" class="wid2" />
						...
						<td colspan="4">
							<select id="CFM_YN" name="CFM_YN" class="wid2"></select>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="clear">
			<div class="f_l tit_top">
				<div class="clear">
					<h3 class="bul_arr f_l">지원상품 발주목록 - 발주된 지원상품은 "매입전표(검품,확정)"화면에서 검색 되지 않습니다.</h3>
					<dlv class="f_r">
						<button type="button" id="orderDel" class="btn btn_style4" onclick="orderConfermCancel();">확정취소</button>
		...
		<div>
			<div class="tit_top clear">
				<h3 class="bul_arr f_l">발주 지원상품</h3>
				<div class="f_r">
					 * 원가단가: 세액포함
