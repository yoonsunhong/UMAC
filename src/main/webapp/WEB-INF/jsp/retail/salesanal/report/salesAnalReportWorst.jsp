...
<script type="text/javascript" src="/resources/js/page/salesanal/report/salesAnalReportWorst.js?ver=20180315_001" charset="utf-8"></script>
</head>
		...
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				<div>					
					...
					<%-- <label for=""><spring:message code="inqireStdr"/></label> --%>
					&nbsp;&nbsp;&nbsp;
					<label class="radio">
						<input type="radio" name="P_ORDER_BY" value="1" checked>
						<span>Best</span>
					</label>
					<label class="radio">
						<input type="radio" name="P_ORDER_BY" value="2">
						<span>Worst</span>
					</label>								

					<label for="">/</label>
					<label class="radio">
						<input type="radio" name="P_SALE_QTY_AMT" value="1" checked>
						<span><spring:message code="qY"/></span>
					</label>
					<label class="radio">
						<input type="radio" name="P_SALE_QTY_AMT" value="2">
						<span><spring:message code="amount"/></span>
					</label>									
				</div>
				<div class="last">
			...
			<div class="col2 sub_cnt">
				<div class="clear">
					<%-- <h3 class="bul_arr f_l"><spring:message code="bestWorst20Sttus"/></h3> --%>
					<h3 class="bul_arr f_l">best/worst 100</h3>
				</div>	 		
				<div class="sec_grid">
					<div class="content">
