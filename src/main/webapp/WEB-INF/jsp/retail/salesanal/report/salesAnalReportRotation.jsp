...
<title><spring:message code="inventoryTurnoverAnalysis"/></title>
...
<script type="text/javascript" src="/resources/js/page/salesanal/report/salesAnalReportRotation.js?ver=20180316_001" charset="utf-8"></script>
 	...
 	<form name="frm" id="frm">
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				<div class="last">				
					<label for="">조회년월</label>									
					<input type="text" id="P_OPEN_DT" name="P_OPEN_DT" class="datepicker1 datepickerYm3" value="<%=beforeMonth%>" readonly="readonly"> ~ 
					<input type="text" id="P_END_DT" name="P_END_DT" class="datepicker2 datepickerYm4" value="<%=nowMonth%>" readonly="readonly">
