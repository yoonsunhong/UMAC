...
<title><spring:message code="goodsStoreSales"/></title>
...
<script type="text/javascript" src="/resources/js/page/salesanal/report/salesAnalReportClStore.js?ver=20180314_001" charset="utf-8"></script>
		...
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				<div>
					...
					<select id="P_CATEGORY" name="P_CATEGORY" class="wid2">
						<option value="1"><spring:message code="majorCategoryName"/></option>   
						<option value="2"><spring:message code="middleCategoryName"/></option>   
						<option value="3"><spring:message code="subCategoryName"/></option>
					</select>																											
				</div>				
			</div>
			<!-- //조회폼 영역 -->
			...
			<div class="col2 sub_cnt">
				<div class="clear">
					<h3 class="bul_arr f_l"><spring:message code="goodsStoreSales"/></h3>
				</div>	 		
				<div class="sec_grid">
					<div class="content">
