...
<title><spring:message code="goodsAbcAnalysis"/></title>
...
<script type="text/javascript" src="/resources/js/page/salesanal/report/salesAnalReportAbc.js?ver=20180315_001" charset="utf-8"></script>
		...
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				<div>
					...
					<label for="">식자재상품</label>
					<select id="P_INGR_YN" name="P_INGR_YN" class="wid2" >
						<option value=""><spring:message code="all"/></option>
						<option value="Y">식자재상품</option>
						<option value="N">비식자재상품</option>
					</select>				
					
					<label for="" style="padding-left:24px;"><spring:message code="selngDate"/></label>					
					<input type="text" id="P_OPEN_DT" name="P_OPEN_DT" class="datepicker1" value="<c:out value="${today}"/>" readonly="readonly"> ~ <input type="text" id="P_END_DT" name="P_END_DT" class="datepicker2" value="<c:out value="${today}"/>" readonly="readonly">	
					&nbsp;&nbsp;
					<label for="" style="padding-left: 20px;"><spring:message code="supply"/></label>		
				...
				<div class="last">
					...
					<input type="radio" id="P_TAX_YN" name="P_TAX_YN" value="Y" checked="checked"><spring:message code="taxInclusion"/> 
					<input type="radio" id="P_TAX_YN" name="P_TAX_YN" value="N"><spring:message code="taxExclusion"/>
					
					<label for="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
					<input type="radio" id="P_GROUP_TP" name="P_GROUP_TP" value="A" checked="checked">매출금액 
					<input type="radio" id="P_GROUP_TP" name="P_GROUP_TP" value="Q">매출수량
					<label for="" style="padding-left: 48px;" >A</label>
					<input type="text" id="P_GROUP_A" name="P_GROUP_A" class="search_txt" style="width:40px;text-align:center" maxlength="3" value="70" onblur="fncValichk()" />
					<label for="">B</label>
					<input type="text" id="P_GROUP_B" name="P_GROUP_B" class="search_txt" style="width:40px;text-align:center" maxlength="3" value="90" onblur="fncValichk()" />
					<label for="">C</label>
					<input type="text" id="P_GROUP_C" name="P_GROUP_C" class="search_txt" style="width:40px;text-align:center" maxlength="3" value="100" readonly/>
			...
			<div class="col2 sub_cnt">
				<div class="clear">
					<h3 class="bul_arr f_l"><spring:message code="goodsAbcAnalysis"/></h3>
				</div>	 		
				<div class="sec_grid">
					<div class="content">
