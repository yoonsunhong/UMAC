...
<script type="text/javascript" src="/resources/js/page/salesanal/report/salesAnalReportOrder.js?ver=20180406_000" charset="utf-8"></script>
 	...
 	<form name="frm" id="frm">
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				<div class="last">
					...
					<label for=""><spring:message code="btnSearchDate"/></label>
						<input type="text" id="P_ORD_DT" name="P_ORD_DT" class="datepicker2 datepicker" value="<c:out value="${today}"/>" readonly="readonly">								
					<label for=""><spring:message code="busiFlag"/></label>
						<select id="P_BUSI_FLAG" name="P_BUSI_FLAG" class="wid2" onchange="busiFunction()">
							<option value=""><spring:message code="all"/></option>
						</select>
					<label for=""><spring:message code="mbrGrade"/></label>
						<select id="P_MBR_GRADE" name="P_MBR_GRADE" class="wid2" style="width:140px">
							<option value=""><spring:message code="all"/></option>
						</select>
					<%-- <label for=""><spring:message code="orderMth"/></label>					
						<select id="P_ORD_MTHD" name="P_ORD_MTHD" class="wid2">
							<option value=""><spring:message code="all"/></option>
						</select> --%>
					<label for=""><spring:message code="ordStat"/></label>					
			...
			<!-- 매출속보 -->
				...
				<h3 class="bul_arr"><spring:message code="orderRceptSm"/></h3> 
				<div id="tab1" class="tab">
					<ul>
						<li class="tab1 on">							
							<button class="tab_btn" id="bt_tab1"><spring:message code="storeTy"/></button>
							<ul>
								<div id="gridHolder1"></div>
							</ul>						
						</li>
						<li class="tab2">						
							<button class="tab_btn" id="bt_tab2"><spring:message code="bsnEmpl"/></button>
							<ul>
								<div id="gridHolder2"></div>				
							</ul>
						</li>
						<li class="tab3">						
							<button class="tab_btn" id="bt_tab3"><spring:message code="memberGroup"/></button>
							<ul>
