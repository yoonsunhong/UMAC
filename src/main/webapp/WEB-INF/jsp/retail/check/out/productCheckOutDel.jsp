...
<script type="text/javascript" src="/resources/js/page/check/out/productCheckOutDel.js?ver=20180405_000" charset="utf-8"></script>
 ...
 <body id="in_frame">
	...
	<div id="iframeCnt">
		<div class="btn_area clear">
			...
			<div class="f_r">
				<!-- 권한에 따른 버튼 show/hide -->
<!-- 			<button type="button" id="btn_create" class="btn btn_style2" onclick="btn_print()">출력</button> -->
<!-- 			<button type="button" id="btn_determine" class="btn btn_style2" onclick="btnDetermine()">확정</button> -->
<!--			<button type="button" id="btn_create"  class="btn btn_style2" onclick="btnNew()" >신규</button> -->
<!--		    <button type="button" id="btn_update"  class="btn btn_style2"  onclick="btnSaveCheck()">저장</button> -->
<!-- 			<button type="button" id="btn_read" class="btn btn_style3"  onclick="btnSearch()"><i class="fa fa-search"></i>조회</button> -->
				...
				<button type="button" id="btn_del" class="btn btn_style2"  onclick="btnDel();">전표삭제</button>
				<button type="button" id="btn_read" class="btn btn_style3"  onclick="btnSearch();"><i class="fa fa-search"></i>조회</button>
			</div>
		</div>
		...
		<div id="top_search" class="search_area">
			<div class="last">
				...
				<label for=""><em>필수입력항목</em>점포명</label>
				<select id="P_STR_CODE" name="P_STR_CODE"></select>
				<label for="">대입점포</label>
				<select id="P_DIN_STR_CODE" name="P_DIN_STR_CODE"></select>
				<label fol="">대출일자</label>
		...
		<div class="col2 sub_cnt" id="dataForm" name="dataForm">
			...
			<div class="mar_T10">
				<div class="clear">
					<h3 class="bul_arr f_l">상품대출상세</h3>
					<div class="pro_price f_r">
<!-- 						<label for=""><em>필수입력항목</em>대입점</label> -->
<!-- 						<select id="DIN_STR_CODE" name="DIN_STR_CODE" class="wid2"></select> -->
<!-- 						<label for="">비고</label> -->
<!-- 						<input type="text" id="REMARK" name="REMARK" class="wid4 mar_R22"> -->
<!-- 						<button type="button" class="btn btn_style4" onclick="addRow()">행추가</button> -->
<!-- 						<button type="button" class="btn btn_style4" onclick="deleteRow()">행삭제</button> -->
					</div>				
				</div>
