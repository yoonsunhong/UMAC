...
<script type="text/javascript" src="/resources/js/page/check/out/productCheckOut.js?ver=20180405_000" charset="utf-8"></script>
	...
	<div id="iframeCnt">
		<div class="btn_area clear">
			...
			<div class="f_r">
				...
				<button type="button" id="btn_determine" class="btn btn_style2" onclick="btnDetermine();"><spring:message code="btnSubmit"/></button>
		...
		<div id="top_search" class="search_area">
			<div class="last">
				...
				<select id="P_DIN_STR_CODE" name="P_DIN_STR_CODE" class=""></select>
			...
			<div class="mar_T10">
				<div class="clear">
					...
					<div class="pro_price f_r">
						...
						<button type="button" id="addRow" class="btn btn_style4" onclick="addRow()">행추가</button>
						<button type="button" id="delRow" class="btn btn_style4" onclick="deleteRow()">행삭제</button>
					</div>				
				</div>
