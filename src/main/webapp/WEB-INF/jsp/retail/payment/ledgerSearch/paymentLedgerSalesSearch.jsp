...
<script type="text/javascript" src="/resources/js/page/payment/ledgerSearch/paymentLedgerSalesSearch.js?ver=20180410_001" charset="utf-8"></script>	
 ...
 <body id="in_frame">
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				...
				<select id="P_GRE_GB" name="P_GRE_GB" class="wid2" style="width:60px">
					<option value=""><spring:message code="all"/></option>
				</select>
				
				<label for=""><spring:message code="payCon"/></label>
				<select id="P_PAY_CON" name="P_PAY_CON" class="wid2" style="width:110px" onchange="chgPay('PAY_CON');">
					<option value=""><spring:message code="all"/></option>
				</select>
			...
			<div class="sec_grid">
				<div class="content">
					<h3 class="bul_arr"><spring:message code="saleseLedgerSummary"/></h3>
