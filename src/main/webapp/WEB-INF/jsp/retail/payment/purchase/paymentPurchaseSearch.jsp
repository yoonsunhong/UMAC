...
<script type="text/javascript" src="/resources/js/page/payment/purchase/paymentPurchaseSearch.js?ver=20180410_009" charset="utf-8"></script>	
 ...
 <body id="in_frame">
		<div id="iframeCnt">
			...
			<div class="search_area" id="top_search">
				...
				<label for=""><em>필수입력사항</em>입고일자</label>
				...
				<input type="text" id="P_VEN_NAME" name="P_VEN_NAME" class="search_txt" style="width:200px" onBlur="clearVenCode()" /><!-- class="search_txt wid2" -->
				...
				<select id="P_PUR_GB" name="P_PUR_GB" class="mar_R0" >
					<option value=""><spring:message code="all"/></option>
				</select>
				
				<label for=""  style="margin-left: 20px;"><spring:message code="greGb"/></label>
				<select id="P_GRE_GB" name="P_GRE_GB" class="mar_R0" disabled>
					<%-- <option value=""><spring:message code="all"/></option> --%>
				...
				<!-- 매출집계/거래건별
				<label for=""> &nbsp; &nbsp;</label>
				<input type="radio" id="P_LIMIT_LEVEL_1" name="P_LIMIT_LEVEL" value="2" class="wid_marL"  ><label for="P_LIMIT_LEVEL_1" class="wid_marL"><spring:message code="purClose"/></label>
