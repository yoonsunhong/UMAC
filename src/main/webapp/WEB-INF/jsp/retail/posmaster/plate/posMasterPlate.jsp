...
<script type="text/javascript" src="/resources/js/page/posmaster/plate/posMasterPlate.js" charset="utf-8"></script>
</head>
...
<body id="in_frame">
	...
	<div id="iframeCnt">
		...
		<div class="col2 sub_cnt">
			<h3 class="bul_arr">POS관리 > POS 점별 명판 등록</h3>
			<div class="sec_grid">
				<div class="content">
					<div id="gridHolder1">
					</div>
...
<div id="pop_wrap">
	<header id="pop_head" class="clear">
		<h1 class="bul_arr f_l">POS 점별 명판 등록</h1>
		<div class="f_r">
			...
			<table class="tbl_st2">
				<tbody>
					...
					<tr>
						...
						<td colspan="3"><input type="text" id="D_SEQ" name="D_SEQ" maxlength="2" /></td>
					</tr>
					<tr>
						<th scope="row"><em>필수항목</em><label><spring:message code="plateContents"/></label></th>
						<td colspan="3">
							<input type="text" id="D_LOGO_HEAD" name="D_LOGO_HEAD" onkeyUp="CommonJs.displayBytes(this, 'txtbyte', 40);" style="width:330px;" />
							<input type="text" id="txtbyte" style="width:30px;" readonly="readonly" tabindex="-1" onfocus="this.blur()" />/40byte
						</td>
					</tr>
				</tbody>
			</table>
