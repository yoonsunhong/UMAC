...
<script type="text/javascript" src="/resources/js/page/stock/stockRealExcel/stockRealExcelUp.js?ver=20180303_002" charset="utf-8"></script>
<!-- 공통 팝업 -->
...
<%-- 						</c:if> --%>
						...
						<button type="button" class="btn btn_style2"  id="btn_excel_down" name="btn_excel_down" onclick="btnExcell()"><i class="fa"></i><spring:message code="btnExcelDown"/></button>
					...
					<table>
						...
						<tr class="last">
							...
							<td><input type="text" id="P_DIFF_CNT" name="P_DIFF_CNT" class="wid2" style="text-align: center;"/>
									<input type="hidden" id="P_GUBUN" name="P_GUBUN" class="wid2" value="2"/>
							...
							<li class="tab1 on">
								...
								<ul>
									<div class="f_r" style="margin-top:-21px">
										...
										<button type="button" id="ExcelDownload1" class="btn btn_style4" onclick="ExcelDownload1()">엑셀다운</button>
			...
			<table class="tbl_st2">
				<tbody>
					...
					<tr>
						...
						<td><input type="text" id="P_POP_SPRC" name="P_POP_SPRC" class="wid2" disabled numberonly style="text-align:right;"></td>
