	...
	'<rMateGrid>\
		...
		<DataGrid id="dg2"  showDeletedRows="true"  editable="true" doubleClickEnabled="true"  sortableColumns="true" selectionMode="multipleRows" itemRenderer="EditableIconItem"    verticalAlign="middle" showDataTips="true" >\
			<columns>\
				...
				<DataGridColumn id="SPRC" dataField="SPRC"  headerText="'+wprc+'"   textAlign="right" sortable="false" formatter="{numfmt}"  width="100" editable="false" visible="false" />\
				<DataGridColumn id="STOCK_PRICE" dataField="STOCK_PRICE"  headerText="'+stockAmount+'"   textAlign="right" sortable="false" formatter="{numfmt}"  width="140" editable="false"  visible="false" />\
...
//그리드 너비 제어
$(document).ready(function (){
	$("#gridHolder1, #gridHolder2").height( $(window).height()-130);
