...
'<rMateGrid>\
	...
	<DataGrid id="dg1"  sortableColumns="false"  editable="true" horizontalScrollPolicy="auto" showDeletedRows="true"  selectionMode="multipleRows"   doubleClickEnabled="false" >\
		<columns>\
			...
			<DataGridColumn  id="SLIP_NO"		 dataField="SLIP_NO"    	headerText="발주번호"		editable="false"		textAlign="center"	 width="125"    		/>\
			<DataGridColumn  id="STR_CODE"		 dataField="STR_CODE"     	headerText="STR_CODE"	editable="false" 		visible="false" />\
			<DataGridColumn  id="ITM_CODE"		 dataField="ITM_CODE"     	headerText="상품코드"		editable="false" 		visible="true" />\
	...
	<DataGridColumn  id="UNIT_NM"	 	 dataField="UNIT_NM" 		headerText="규격"    		editable="false"		textAlign="right"   width="75"   		/>\
			...
			<DataGridColumn  id="VEN_NAME"		 dataField="VEN_NAME"    	headerText="매입처"		editable="false"		textAlign="left"	 width="160"    		/>\
	...
	'<rMateGrid>\
		...
		<DataGrid id="dg1" sortableColumns="true"   editable="true" horizontalScrollPolicy="auto" showDeletedRows="true"     doubleClickEnabled="false" selectionMode="multipleRows" >\
			<columns>\
				...
				<DataGridColumn  id="PUR_GB_NM"	 	  dataField="PUR_GB_NM"    		headerText="매입구분 "  	visible="true"  		editable="false"		textAlign="center"   width="75"      	/>\
...
//	var ITM_GB		= xmlDoc.createElement('ITM_GB');        // 상품구분
    ...
    VEN_CODE.appendChild( xmlDoc.createTextNode(    "99999"        	    	)	);   // R1 일때만  박아준다. 하지만 프로시져 쿼리를 보면  유맥의 VEN_CODE 를 가져온다.  
...
//    xmlDoc.getElementsByTagName("GRIDROW")[0].appendChild(	   ITM_GB	     );           
	...
	//   발주 저장      
	jQuery.ajax({ 
	    url:"/orderStoreProductRegister.do",          //  productStoreUpdate.do   productBoxUpdate
	    type:"POST",
		datatype:"xml",
		async:true,
...
function btn_search(){
	...
	jQuery.ajax({ 
	    url:"/orderHeadSearch.do",         //  productStoreSearchList   productBoxSearchList 
	    type:"POST",
		datatype:"json",
		async:false,
...
//	 		$('#ITM_GB').val(	data[0].ITM_GB		); 
	...
	jQuery.ajax({ 
	    url:"/orderDetailInfo.do",            // productCustomerPyPayNumList.do
	    type:"POST",
		datatype:"xml",
		async:false,
