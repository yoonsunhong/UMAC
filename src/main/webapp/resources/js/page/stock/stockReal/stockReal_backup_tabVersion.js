...
'<rMateGrid>\
	...
	<DataGrid id="dg1" sortableColumns="true" selectionMode="multipleRows"   verticalAlign="middle"  showDataTips="true" >\
			<groupedColumns>\
				...
				<DataGridColumn id="SPRC" dataField="SPRC"  headerText="'+wprc+'"   textAlign="right" sortable="false" formatter="{numfmt}"  width="100" />\
				<DataGridColumn id="STOCK_PRICE" dataField="STOCK_PRICE"  headerText="'+stockAmount+'"   textAlign="right" sortable="false" formatter="{numfmt}"  width="120" />\
...
//그리드 너비 제어
$(document).ready(function (){
	$("#gridHolder1, #gridHolder2").height( $(window).height() - 126 );
...
function downSmapleExcel(){
	location.href="/resources/js/page/stock/stockReal/실사재고등록_SAMPLE.xlsx";
}
