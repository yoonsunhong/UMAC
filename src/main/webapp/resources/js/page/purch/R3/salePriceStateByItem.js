...
var layoutStr1 =
	'<rMateGrid>\
		...
		<NumberFormatter id="numfmt1" useThousandsSeparator="true" precision="2" />\
			<DataGrid id="dg1" sortableColumns="false" showDataTips="true"  horizontalScrollPolicy="auto" lockedColumnCount="4" lastColumnWidthPolicy="balance" >\
				<groupedColumns>\
					<DataGridColumn dataField="STR_CODE"		headerText="점포코드"        		width="70"  textAlign="center"	styleJsFunction="styleFunction1" />\
					<DataGridColumn dataField="STR_NAME"  		headerText="점포명"        			width="80"  textAlign="center" 	styleJsFunction="styleFunction1" />\
					...
					<DataGridColumn dataField="PUR_DT"    		headerText="전표일자"          		width="100" textAlign="center" 	resizable="false" />\
					<DataGridColumn dataField="PUR_CFM_DT"  	headerText="'+ dateOfReceipt +'"    width="100" textAlign="center" 	resizable="false" />\
					<DataGridColumn dataField="PUR_GB_NM" 		headerText="'+purchGubun+'"     	width="80"  textAlign="center" 	resizable="false" />\
					<DataGridColumn dataField="ORD_FLAG_NM" 	headerText="'+ordFlag+'"      		width="80"  textAlign="center" 	resizable="false" />\
					<DataGridColumn dataField="TAX_GB_NM" 		headerText="'+taxGb+'"          	width="80"  textAlign="center" 	resizable="false" />\
					<DataGridColumn dataField="PUR_WAMT"  		headerText="'+purchasePrice+'"  	width="100" textAlign="right" 	resizable="false"	id="dg1col1"	formatter="{numfmt}" styleJsFunction="styleFunction1" />\
					<DataGridColumn dataField="PUR_SPRC"  		headerText="'+sprc+'"           	width="100" textAlign="right" 	resizable="false" 	id="dg1col2" 	formatter="{numfmt}" styleJsFunction="styleFunction1" />\
					<DataGridColumn dataField="DEC_QTY"   		headerText="'+qY+'"             	width="80"  textAlign="right" 	resizable="false" 	id="dg1col3" 	formatter="{numfmt}" styleJsFunction="styleFunction1" />\
					<DataGridColumn dataField="PUR_TWAMT" 		headerText="'+puchasAmount+'"   	width="100" textAlign="right" 	resizable="false" 	id="dg1col4" 	formatter="{numfmt}" styleJsFunction="styleFunction1" />\
					<DataGridColumn dataField="PUR_TSAMT" 		headerText="'+r3ExpectedSAMT+'" 	width="100" textAlign="right" 	resizable="false" 	id="dg1col5" 	formatter="{numfmt}" styleJsFunction="styleFunction1" />\
					<DataGridColumn dataField="EXPECTED_PROFIT" headerText="'+r3ExpectedProfic+'" 	width="100" textAlign="right" 	resizable="false" 	id="dg1col6" 	formatter="{numfmt}" styleJsFunction="styleFunction1" />\
					<DataGridColumn dataField="PROFIT_RATE" 	headerText="'+ProfitRt+'"     		width="80" 	textAlign="center" 	resizable="true" 	styleJsFunction="styleFunction1" />\
				</groupedColumns>\
				<footers>\
				<DataGridFooter height="26" color="#000" backgroundColor="#c5c5c5" borderTopColor="#858585" borderTopWidth="1" borderTopStyle="solid" fontWeight="normal">\
					...
					<DataGridFooterColumn/>\
					<DataGridFooterColumn/>\
					<DataGridFooterColumn summaryOperation="SUM" dataColumn="{dg1col3}" formatter="{numfmt1}" textAlign="right" />\
					<DataGridFooterColumn summaryOperation="SUM" dataColumn="{dg1col4}" formatter="{numfmt1}" textAlign="right" />\
					<DataGridFooterColumn summaryOperation="SUM" dataColumn="{dg1col5}" formatter="{numfmt1}" textAlign="right" />\
					<DataGridFooterColumn summaryOperation="SUM" dataColumn="{dg1col6}" formatter="{numfmt1}" textAlign="right" />\
...
var layoutStr2 =
	...
	<DataGrid id="dg1" sortableColumns="false" showDataTips="true"  horizontalScrollPolicy="auto" lockedColumnCount="4" lastColumnWidthPolicy="balance" >\
	<groupedColumns>\
	<DataGridColumn dataField="STR_CODE"  		headerText="점포코드"        		width="80"  textAlign="center" styleJsFunction="styleFunction1" />\
	<DataGridColumn dataField="STR_NAME"  		headerText="점포명"        			width="80"  textAlign="center" styleJsFunction="styleFunction1" />\
	<DataGridColumn dataField="VEN_CODE"  		headerText="'+venCode+'"        	width="80"  textAlign="center" styleJsFunction="styleFunction1" />\
	<DataGridColumn dataField="VEN_NAME"  		headerText="'+venName+'"        	width="140" textAlign="left"   styleJsFunction="styleFunction1" />\
	<DataGridColumn dataField="SCAN_CODE" 		headerText="'+scanCode+'"       	width="110" textAlign="center" styleJsFunction="styleFunction1" />\
	...
	<DataGridColumn dataField="PUR_DT"    		headerText="전표일자"          		width="100" textAlign="center" resizable="false" />\
	<DataGridColumn dataField="PUR_CFM_DT"  	headerText="'+ dateOfReceipt +'"    width="100" textAlign="center" resizable="false" />\
	<DataGridColumn dataField="PUR_GB_NM" 		headerText="'+purchGubun+'"     	width="80"  resizable="false" textAlign="center" />\
	<DataGridColumn dataField="ORD_FLAG_NM" 	headerText="'+ordFlag+'"      		width="80"  resizable="false" textAlign="center" />\
	<DataGridColumn dataField="TAX_GB_NM" 		headerText="'+taxGb+'"          	width="80"  resizable="false" textAlign="center" />\
	<DataGridColumn dataField="PUR_WAMT"  		headerText="'+purchasePrice+'"  	width="100" id="dg1col1" resizable="false" textAlign="right" formatter="{numfmt}" styleJsFunction="styleFunction1" />\
	<DataGridColumn dataField="PUR_SPRC"  		headerText="'+sprc+'"           	width="100" id="dg1col2" resizable="false" textAlign="right" formatter="{numfmt}" styleJsFunction="styleFunction1" />\
	<DataGridColumn dataField="DEC_QTY"   		headerText="'+qY+'"             	width="80" 	id="dg1col3" resizable="false" textAlign="right" formatter="{numfmt}" styleJsFunction="styleFunction1" />\
	<DataGridColumn dataField="PUR_TWAMT" 		headerText="'+puchasAmount+'"   	width="100" id="dg1col4" resizable="false" textAlign="right" formatter="{numfmt}" styleJsFunction="styleFunction1" />\
	<DataGridColumn dataField="PUR_TSAMT" 		headerText="'+r3ExpectedSAMT+'" 	width="100" id="dg1col5" resizable="false" textAlign="right" formatter="{numfmt}" styleJsFunction="styleFunction1" />\
	<DataGridColumn dataField="EXPECTED_PROFIT"	headerText="'+r3ExpectedProfic+'" 	width="100" id="dg1col6" resizable="false" textAlign="right" formatter="{numfmt}" styleJsFunction="styleFunction1" />\
...
function getGridData() {
	...
	if(($.trim($("#S_VEN_NAME").val())  == null || 
		$.trim($("#S_VEN_NAME").val())  == "")	  &&	
	    ($.trim($("#S_ITM_NAME").val() ) == null || 
	     $.trim($("#S_ITM_NAME").val() ) == ""))
	{
		alert("협력업체 또는 상품명을 입력 해 주세요.");
...
function excelExport(){
	...
	dataGrid2.exportFileName = "단품별매입판매가현황"+nowDate+"_"+str_name+"_"+".xlsx";
...
function btn_comm_product_search(){
	$("#pop_wrap input[id='P_TEXT2']").val($("#S_ITM_NAME").val());
