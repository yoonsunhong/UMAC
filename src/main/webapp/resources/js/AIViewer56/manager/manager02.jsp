...
class ReportHandler{
	...
	private void writeScriptvoid01( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_F13"), nYCurPos+mapTop.get("sheet20_F13"), mapWidth.get("sheet20_F13"), mapHeight.get("sheet20_F13"), sheet20_F13, "sheet20_F13", mapStyle.get("sheet20_F13"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet20_G13"), nYCurPos+mapTop.get("sheet20_G13"), mapWidth.get("sheet20_G13"), mapHeight.get("sheet20_G13"), sheet20_G13, "sheet20_G13", mapStyle.get("sheet20_G13"));
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|5|manager02.style|보고서 (2016/3/16 10:18:25)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_A10", 0, 274, 53, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_C10", 106, 274, 40, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_D10", 146, 274, 70, 18, "cell_style_5");
		setCellInfoMap_Internal("sheet20_E10", 216, 274, 70, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_F10", 286, 274, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_G10", 401, 274, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_A11", 0, 292, 53, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_C11", 106, 292, 40, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_D11", 146, 292, 70, 18, "cell_style_5");
		setCellInfoMap_Internal("sheet20_E11", 216, 292, 70, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_F11", 286, 292, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_G11", 401, 292, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_A12", 0, 310, 53, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_C12", 106, 310, 40, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_D12", 146, 310, 70, 18, "cell_style_5");
		setCellInfoMap_Internal("sheet20_E12", 216, 310, 70, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_F12", 286, 310, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_G12", 401, 310, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_A13", 0, 328, 216, 18, "cell_style_7");
		setCellInfoMap_Internal("sheet20_E13", 216, 328, 70, 18, "cell_style_8");
		setCellInfoMap_Internal("sheet20_F13", 286, 328, 115, 18, "cell_style_8");
		setCellInfoMap_Internal("sheet20_G13", 401, 328, 115, 18, "cell_style_8");
		...
		setCellInfoMap_Internal("sheet20_G20", 401, 574, 115, 18, "cell_style_3");
		setCellInfoMap_Internal("sheet20_A21", 0, 592, 53, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_B21", 53, 592, 53, 72, "cell_style_4");
		setCellInfoMap_Internal("sheet20_C21", 106, 592, 40, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_D21", 146, 592, 70, 18, "cell_style_5");
		setCellInfoMap_Internal("sheet20_E21", 216, 592, 70, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_F21", 286, 592, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_G21", 401, 592, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_A22", 0, 610, 53, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_C22", 106, 610, 40, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_D22", 146, 610, 70, 18, "cell_style_5");
		setCellInfoMap_Internal("sheet20_E22", 216, 610, 70, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_F22", 286, 610, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_G22", 401, 610, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_A23", 0, 628, 53, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_C23", 106, 628, 40, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_D23", 146, 628, 70, 18, "cell_style_5");
		setCellInfoMap_Internal("sheet20_E23", 216, 628, 70, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_F23", 286, 628, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_G23", 401, 628, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_A24", 0, 646, 53, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_C24", 106, 646, 40, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_D24", 146, 646, 70, 18, "cell_style_5");
		setCellInfoMap_Internal("sheet20_E24", 216, 646, 70, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_F24", 286, 646, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_G24", 401, 646, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_A25", 0, 664, 216, 18, "cell_style_7");
		setCellInfoMap_Internal("sheet20_E25", 216, 664, 70, 18, "cell_style_8");
		setCellInfoMap_Internal("sheet20_F25", 286, 664, 115, 18, "cell_style_8");
		setCellInfoMap_Internal("sheet20_G25", 401, 664, 115, 18, "cell_style_8");
		setCellInfoMap_Internal("sheet20_A27", 0, 692, 286, 29, "cell_style_9");
		setCellInfoMap_Internal("sheet20_F27", 286, 692, 230, 29, "cell_style_10");
		...
		setCellInfoMap_Internal("sheet20_G8", 401, 238, 115, 18, "cell_style_3");
		setCellInfoMap_Internal("sheet20_A9", 0, 256, 53, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_B9", 53, 256, 53, 72, "cell_style_4");
		setCellInfoMap_Internal("sheet20_C9", 106, 256, 40, 18, "cell_style_4");
		setCellInfoMap_Internal("sheet20_D9", 146, 256, 70, 18, "cell_style_5");
		setCellInfoMap_Internal("sheet20_E9", 216, 256, 70, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_F9", 286, 256, 115, 18, "cell_style_6");
		setCellInfoMap_Internal("sheet20_G9", 401, 256, 115, 18, "cell_style_6");
	}
